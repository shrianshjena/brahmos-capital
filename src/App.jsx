...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4900.0, day:-0.12,pe:35.8,pb:8.1, roe:24.0,mc:3344,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:413.25, day:1.04,pe:49.3,pb:12.6, roe:27.6,mc:3026,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2610.0, day:2.76,pe:38.5,pb:10.6, roe:28.8,mc:1029,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1518.5, day:0.3,pe:57.1,pb:6.6, roe:12.5,mc:389,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2607.5, day:0.44,pe:37.2,pb:11.3, roe:31.8,mc:298,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1359.9, day:-0.59,pe:95.2,pb:11.7, roe:9.9,mc:498,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4542.3, day:-4.09,pe:101.0,pb:15.6, roe:16.7,mc:270,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1445.2, day:-4.92,pe:128.2,pb:16.6, roe:13.1,mc:121,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1877.7, day:-1.35,pe:96.2,pb:9.6, roe:11.8,mc:173,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:19800.0, day:-0.63,pe:90.1,pb:28.7, roe:31.3,mc:1801,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:6928.5, day:1.71,pe:161.3,pb:26.3, roe:12.6,mc:216,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2052.5, day:0.56,pe:138.9,pb:10.3, roe:11.6,mc:986,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1708.0, day:2.59,pe:84.0,pb:12.0, roe:16.5,mc:158,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1923.0, day:0.42,pe:90.1,pb:5.5, roe:5.1,mc:161,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:389.65, day:1.17,pe:114.8,pb:10.1, roe:11.2,mc:143,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:414.4, day:-0.88,pe:58.8,pb:5.2, roe:8.9,mc:79,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:788.8, day:-0.96,pe:912.9,pb:5.9, roe:-2.8,mc:40,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:665.55, day:-0.27,pe:106.4,pb:12.4, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1473.5, day:-1.73,pe:105.3,pb:10.3, roe:9.0,mc:76,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:21116.0, day:-2.57,pe:243.9,pb:20.5, roe:7.2,mc:309,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:173.76, day:-1.12,pe:null,pb:1.2, roe:-0.5,mc:20,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:11514.0, day:-1.13,pe:185.2,pb:9.9, roe:4.3,mc:79,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:157.78, day:-0.55,pe:381.5,pb:12.6, roe:5.2,mc:43,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1604.1, day:3.03,pe:107.5,pb:9.4, roe:10.4,mc:68,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:769.35, day:4.55,pe:69.9,pb:5.7, roe:7.5,mc:57,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 21 Aug 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — POSSIBLE INFLECTION, Iran's president signals war-end, Brent ~$94 (as of 21 Aug): the most conciliatory signal from Tehran in weeks landed Friday — President Pezeshkian indicated Iran wants the war to end sooner rather than later ('it is better to end the war today' while 'in a position of power and dignity'), describing the June 17 MoU as a victory for Iran; markets read a potential inflection toward resolution, though signals conflict as Treasury Secretary Bessent countered that the US would impose its 'toughest-ever sanctions'; Brent closed ~$94 Friday (+5-6% for a second straight week, its highest since July); the US military says it has helped move 660M+ barrels through the Strait of Hormuz since early May, though the global diesel market is exceptionally tight; an eventual de-escalation would drain the war premium from defence sentiment, but the sector's durable domestic drivers (Budget-capex expectations, the order pipeline, indigenisation policy) would remain intact; Brent ~$94 (+~39% YoY) stays a headwind for India's import bill/rupee, so a genuine move to end the conflict would be a macro positive for India; the MoD notified its sixth Positive Indigenisation List (18 Aug) via SRIJAN (33,000+ items offered, 15,700+ indigenised, ~₹9,000 Cr import substitution) reinforcing the Atmanirbhar theme for BEL/HAL/BDL; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"📊",color:A.blue,   title:"Defence Ministry Notifies Sixth Positive Indigenisation List",stat:"Policy · 18 Aug 2026",body:"The Ministry of Defence notified its sixth Positive Indigenisation List, extending the multi-year push to localise the defence supply chain. Since the SRIJAN portal launched, more than 33,000 defence items have been offered for indigenisation and over 15,700 successfully indigenised, generating an estimated import-substitution value of around ₹9,000 crore over five years; DPSUs have placed roughly ₹10,000 crore of orders with domestic vendors. The lists progressively bar imports of specified items beyond set timelines, channelling that demand to Indian manufacturers and reinforcing the structural Atmanirbhar Bharat thesis. The prime beneficiaries are the large PSUs whose product lines map directly onto the indigenisation categories: BEL in electronics, radars and fire-control systems, HAL in aerospace, and BDL in missiles and guided weapons, with private participants across the radar, EW and precision-components supply chain also positioned to gain. Coming alongside the record FY26 defence production of ₹1.78 lakh crore, it underscores that policy continues to actively widen the domestic order pool that anchors the sector's long-run revenue visibility."},
    ...
    {icon:"🕊️",color:A.teal, title:"Iran's President Signals Willingness to End War; Brent at 2-Month High ~$94",stat:"Possible inflection · 21 Aug 2026",body:"The most conciliatory signal from Tehran in weeks landed on Friday: Iranian President Masoud Pezeshkian indicated Iran wants the war with the US to end sooner rather than later, saying 'it is better to end the war today' while the country is 'in a position of power and dignity,' and describing the June 17 memorandum of understanding with Washington as a victory for Iran. Markets read it as a potential inflection toward resolution, though conflicting signals persist: Treasury Secretary Scott Bessent countered that the US would impose its 'toughest-ever sanctions' on Tehran and intensify economic pressure on the regime. Brent crude closed around $94 a barrel on Friday, little changed on the day but up roughly 5-6% for a second straight week and its highest level since July, as traders continued to price a firm risk premium. Physical flows remain resilient beneath the headlines: the US military says it has helped tankers move more than 660 million barrels through the Strait of Hormuz since early May, though the global diesel market is exceptionally tight (prices at historic highs) given the disruption plus Ukraine's strikes on Russian refineries. For Indian defence, an eventual de-escalation would drain the war premium from sentiment, but the sector's durable domestic drivers (Budget-capex expectations, the order pipeline, indigenisation policy) would remain intact. Brent near $94, up ~39% year-on-year, stays a meaningful headwind for India's import bill, rupee and inflation, so any genuine move to end the conflict would be a clear macro positive for India."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"POSSIBLE INFLECTION",score:7,region:"Middle East",color:A.orange,date:"21 Aug 2026",hot:true,
     title:"Iran's President Signals Willingness to End War; Brent at 2-Month High ~$94",
     detail:"The most conciliatory signal from Tehran in weeks: Iranian President Pezeshkian indicated Iran wants the war with the US to end sooner rather than later, saying 'it is better to end the war today' while the country is 'in a position of power and dignity,' and calling the June 17 MoU a victory for Iran. Markets read it as a potential inflection toward resolution, though signals conflict: Treasury Sec Bessent countered that the US would impose its 'toughest-ever sanctions' and intensify economic pressure. Brent closed ~$94 Friday (little changed on the day but +5-6% for a second straight week, highest since July). Physical flows resilient: the US military says it has helped move 660M+ barrels through Hormuz since early May, though global diesel is exceptionally tight. An eventual de-escalation would drain the war premium from sentiment, but the sector's durable domestic drivers (Budget capex, order pipeline, indigenisation) would remain intact. Brent ~$94 (+~39% YoY) stays a headwind for India, so a genuine move to end the war would be a macro positive for India.",
