...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4910.0, day:-0.2,pe:36.0,pb:8.0, roe:24.0,mc:3290,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:401.0, day:0.45,pe:47.6,pb:12.2, roe:27.6,mc:2918,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2514.9, day:-0.6,pe:38.1,pb:10.5, roe:28.8,mc:1021,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1519.7, day:1.99,pe:54.7,pb:6.7, roe:12.5,mc:392,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2599.0, day:-0.02,pe:37.2,pb:11.3, roe:31.8,mc:298,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1294.0, day:-0.38,pe:112.9,pb:11.2, roe:9.9,mc:476,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4380.7, day:-0.27,pe:91.5,pb:14.2, roe:16.7,mc:246,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1277.1, day:-3.01,pe:121.0,pb:14.6, roe:13.1,mc:106,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1721.1, day:-0.78,pe:86.6,pb:8.7, roe:11.8,mc:156,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18650.0, day:0.83,pe:99.5,pb:26.7, roe:31.3,mc:1674,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:7085.5, day:1.82,pe:161.5,pb:26.0, roe:12.6,mc:214,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2265.2, day:2.5,pe:97.7,pb:11.0, roe:11.6,mc:1057,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1840.0, day:2.1,pe:88.6,pb:13.0, roe:16.5,mc:171,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1787.8, day:3.63,pe:101.2,pb:4.9, roe:5.1,mc:144,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:403.85, day:-0.02,pe:128.6,pb:10.6, roe:11.2,mc:150,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:435.15, day:0.21,pe:61.8,pb:5.3, roe:8.9,mc:81,  ob:6, seed:2007,sector:"Materials"},
  ...
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:641.2, day:-3.53,pe:77.8,pb:12.4, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1446.7, day:8.25,pe:108.0,pb:9.2, roe:9.0,mc:68,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:19076.0, day:4.69,pe:266.7,pb:18.1, roe:7.2,mc:273,  ob:3, seed:2011,sector:"Aerospace"},
  ...
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:11401.0, day:-0.02,pe:241.2,pb:9.8, roe:4.3,mc:77,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:163.43, day:-0.61,pe:391.5,pb:12.9, roe:5.2,mc:44,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1598.5, day:-2.02,pe:96.8,pb:9.6, roe:10.4,mc:69,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:685.55, day:3.48,pe:64.1,pb:5.2, roe:7.5,mc:53,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 6 Aug 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — DE-ESCALATING SHARPLY as of 6 Aug: Trump called off a planned strike early this week ('perimeters of a deal' agreed), Iran and Oman reached a temporary Hormuz shipping-route agreement (2-4 months, not a full reopening), and the US/Iran/Oman are reported close to a 60-day interim deal to reopen the strait without tolls (Trump: talks 'moving along very nicely'); Brent fell three straight sessions to ~$77, well off late-July highs near $92 (Saudi Aramco cut its Asian price, US inventories rebounded), so lower crude now helps India's import bill/rupee; KEY READ-THROUGH: Indian defence rallied hard this week (HAL/Mazagon/GRSE up to 7% in a session) EVEN AS the war premium drained, confirming the domestic order pipeline and Budget-capex hopes (a 20-25% outlay hike) are now the driver; Apollo Micro won ₹213 Cr of new orders (5 Aug) + IPREK Prime Development Agency empanelment; execution risk: HAL is reportedly fining GE over a ~$716m engine crisis constraining Tejas Mk-1A production; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"Iran-Oman Reach Hormuz Shipping Deal; Oil Slides to ~$77 as Truce Nears",stat:"De-escalating · 6 Aug 2026",body:"The conflict has turned sharply toward de-escalation. Trump called off a planned strike on Iran early in the week after Tehran and regional states requested a hold, saying the 'perimeters of a deal' had been agreed, and by mid-week Iran and Oman had reached an agreement on a temporary shipping route through the Strait of Hormuz — a joint statement is in final drafting, with the route to stay open for two to four months (though Tehran stresses this is not a full reopening). Washington, Tehran and Muscat are reported to be close to a 60-day interim agreement to reopen the waterway without tolls, and Trump says negotiations are 'moving along very nicely.' Crude has fallen for three straight sessions to around $77 (Brent), well off its late-July highs near $92, helped by Saudi Aramco cutting its Asian crude price and US inventories rebounding from multi-year lows. Residual risks remain: Houthi attacks on Red Sea shipping continue, and any deal's durability is unproven. The read-through for Indian defence is telling — the sector rallied hard this week even as the war premium drained, confirming that the domestic order pipeline and Budget-capex expectations, not the Gulf, are now the primary driver. Lower crude is also a clear positive for India's import bill, rupee and inflation."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"DE-ESCALATING",score:7,region:"Middle East",color:A.teal,date:"6 Aug 2026",hot:true,
     title:"Iran-Oman Reach Hormuz Shipping Deal; Oil Slides to ~$77 as Truce Nears",
     detail:"The conflict has turned sharply toward de-escalation. Trump called off a planned strike early this week after Tehran and regional states requested a hold ('perimeters of a deal' agreed), and by mid-week Iran and Oman reached an agreement on a temporary Hormuz shipping route — joint statement in final drafting, route open 2-4 months (Tehran stresses it's not a full reopening). The US, Iran and Oman are reported close to a 60-day interim deal to reopen the waterway without tolls; Trump says talks are 'moving along very nicely.' Crude fell three straight sessions to ~$77 (Brent), well off late-July highs near $92, helped by Saudi Aramco cutting its Asian price and US inventories rebounding. Residual risk: Houthi Red Sea attacks continue, and durability is unproven. Read-through: Indian defence rallied hard this week even as the war premium drained — the domestic order pipeline and Budget capex, not the Gulf, are now the driver. Lower crude also helps India's import bill/rupee.",
