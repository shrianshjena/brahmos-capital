...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4646.5, day:1.42,pe:33.6,pb:7.5, roe:24.0,mc:3064,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:387.85, day:0.77,pe:45.8,pb:11.7, roe:27.6,mc:2814,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2381.8, day:2.7,pe:36.3,pb:9.6, roe:28.8,mc:935,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1423.0, day:1.49,pe:51.5,pb:6.3, roe:12.5,mc:369,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2601.2, day:0.58,pe:43.0,pb:11.3, roe:31.8,mc:296,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1253.1, day:0.58,pe:108.5,pb:10.8, roe:9.9,mc:457,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4281.0, day:-4.06,pe:92.3,pb:14.4, roe:16.7,mc:250,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1256.5, day:3.64,pe:111.1,pb:13.5, roe:13.1,mc:98,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1624.2, day:0.54,pe:80.4,pb:8.1, roe:11.8,mc:145,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18391.0, day:1.87,pe:96.9,pb:26.0, roe:31.3,mc:1634,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:5726.0, day:5.0,pe:178.0,pb:20.4, roe:12.6,mc:168,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2199.8, day:1.62,pe:95.9,pb:10.8, roe:11.6,mc:1035,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1861.6, day:7.86,pe:85.4,pb:12.5, roe:16.5,mc:164,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1750.4, day:-0.34,pe:103.8,pb:5.0, roe:5.1,mc:146,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:389.9, day:3.12,pe:120.4,pb:9.9, roe:11.2,mc:141,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:396.0, day:1.77,pe:55.3,pb:4.8, roe:8.9,mc:73,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:875.1, day:2.82,pe:null,pb:6.2, roe:-2.8,mc:42,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:664.15, day:1.36,pe:76.7,pb:12.2, roe:16.5,mc:35,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1235.9, day:5.33,pe:94.7,pb:8.1, roe:9.0,mc:60,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:17737.0, day:-0.33,pe:260.6,pb:17.7, roe:7.2,mc:267,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:180.37, day:1.73,pe:null,pb:1.2, roe:-0.5,mc:20,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10339.0, day:0.65,pe:216.2,pb:8.8, roe:4.3,mc:70,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:161.89, day:1.32,pe:380.4,pb:12.6, roe:5.2,mc:42,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1553.5, day:1.97,pe:91.0,pb:8.9, roe:10.4,mc:65,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:670.05, day:-1.19,pe:65.5,pb:5.3, roe:7.5,mc:54,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 30 Jul 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — RE-ESCALATED as of 30 Jul: this week's diplomatic thaw reversed — after Iran's mid-week attack on US forces, US CENTCOM launched a fresh major wave of strikes on dozens of IRGC sites (30 Jul) and Trump pledged a strong response; the two sides failed to reach a deal (Tehran insists on keeping control of the Strait of Hormuz, sinking the Oman mechanism floated days earlier); Saudi Arabia joined US strikes on Tehran-linked militants in Iraq; Brent surged from ~$81 Tue back above $92 (+21% MTD), so Brent in the low-$90s is a growing negative for India's import bill/rupee; the SPR is at its lowest since 1983; BEL reported Q1 FY27 (27 Jul) net profit ₹1,054 Cr (+8.7% YoY), revenue +25%, FY27 margin guide 27%+; ICICI Securities sees a muted sector Q1 with HAL/Solar the likely outperformers; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"📊",color:A.blue,   title:"Q1 FY27 Results: BEL Profit +9%, Revenue +25%; Zen Falls 9% on Earnings Miss",stat:"Results day · 27 Jul 2026",body:"The June-quarter results have begun to land, and dispersion is already visible. BEL delivered a solid print — consolidated net profit up ~8.7% YoY to ₹1,054 crore on revenue of ₹5,547 crore (+25% YoY) — with management reiterating a FY27 EBITDA-margin guidance of 27%+ and revenue growth of 15-18%; the stock held firm (+0.5%) into the result. Zen Technologies, by contrast, fell ~9% intraday after Q1 earnings declined, a reminder that stretched valuations leave no room for disappointment (Zen already trades above analyst targets). BEL enters FY27 with a ₹73,882 crore order book plus ₹1,653 crore of fresh Q1 wins, and the ₹30,000 crore QRSAM award expected in Q2. The season reinforces the emerging theme: with the Gulf war premium fading, execution and margins — not sector beta — are now what separate the winners."},
    ...
    {icon:"🕊️",color:A.teal, title:"Talks Collapse, US Strikes Dozens of IRGC Sites — Brent Back Above $92",stat:"Re-escalated · 30 Jul 2026",body:"This week's diplomatic thaw has reversed. After Iran's mid-week attack on US forces, US Central Command launched a fresh major wave of air strikes on 30 July targeting dozens of Islamic Revolutionary Guard Corps sites, and Trump pledged a strong response. Crucially, the two sides failed to reach an agreement: Tehran is insisting on retaining control of the Strait of Hormuz, sinking the Oman-brokered mechanism floated days earlier. The conflict has widened — Saudi Arabia joined US operations against Tehran-linked militants in Iraq, and Yemen's Houthis continue to threaten Red Sea shipping. Brent crude, which had dipped toward ~$81 on Tuesday's optimism, has surged back above $92 (up ~21% on the month). The physical market is tightening: US commercial crude posted its largest draw since mid-June, and the Strategic Petroleum Reserve fell for an 18th straight week to its lowest since 1983. For Indian defence, the renewed war premium supports sentiment near-term, but Brent in the low-$90s is a growing negative for India's import bill, rupee and inflation. The durable driver remains the domestic order pipeline and Q1 FY27 execution."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ESCALATING",score:9,region:"Middle East",color:A.red,date:"30 Jul 2026",hot:true,
     title:"Talks Collapse, US Strikes Dozens of IRGC Sites — Brent Back Above $92",
     detail:"This week's diplomatic thaw has reversed. After Iran's mid-week attack on US forces, US Central Command launched a fresh major wave of air strikes on 30 July targeting dozens of IRGC sites; Trump pledged a strong response. The two sides failed to reach a deal — Tehran insists on retaining control of the Strait of Hormuz, sinking the Oman-brokered mechanism floated days earlier. The conflict widened: Saudi Arabia joined US operations against Tehran-linked militants in Iraq, and Yemen's Houthis keep threatening Red Sea shipping. Brent, which dipped toward ~$81 Tuesday, surged back above $92 (up ~21% on the month). Physical market tightening: US crude posted its largest draw since mid-June, and the SPR fell an 18th straight week to its lowest since 1983. Renewed war premium supports defence sentiment near-term; Brent in the low-$90s is a growing negative for India's import bill and rupee.",
