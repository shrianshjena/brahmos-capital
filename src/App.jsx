...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4928.0, day:0.37,pe:36.0,pb:8.0, roe:24.0,mc:3284,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:404.35, day:0.84,pe:47.9,pb:12.2, roe:27.6,mc:2931,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2575.0, day:2.39,pe:37.9,pb:10.4, roe:28.8,mc:1014,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1502.0, day:-1.16,pe:55.9,pb:6.8, roe:12.5,mc:400,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2586.9, day:-0.47,pe:37.1,pb:11.3, roe:31.8,mc:297,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1310.0, day:1.24,pe:112.3,pb:11.2, roe:9.9,mc:474,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4429.7, day:1.12,pe:91.6,pb:14.1, roe:16.7,mc:245,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1267.5, day:-0.75,pe:116.1,pb:14.1, roe:13.1,mc:103,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1720.0, day:-0.06,pe:85.9,pb:8.6, roe:11.8,mc:154,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18820.0, day:0.91,pe:101.0,pb:26.9, roe:31.3,mc:1688,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:6940.0, day:-2.05,pe:162.0,pb:26.2, roe:12.6,mc:215,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2093.1, day:-7.6,pe:100.0,pb:11.3, roe:11.6,mc:1083,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1734.7, day:-5.72,pe:90.9,pb:13.3, roe:16.5,mc:175,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1884.4, day:5.4,pe:83.7,pb:5.1, roe:5.1,mc:150,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:388.25, day:-3.86,pe:127.9,pb:10.6, roe:11.2,mc:150,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:434.15, day:-0.23,pe:62.0,pb:5.3, roe:8.9,mc:81,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:897.75, day:-1.52,pe:null,pb:6.7, roe:-2.8,mc:46,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:649.15, day:1.24,pe:75.8,pb:12.1, roe:16.5,mc:35,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1452.3, day:0.39,pe:116.2,pb:10.0, roe:9.0,mc:74,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:19370.0, day:1.54,pe:278.1,pb:19.0, roe:7.2,mc:286,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:179.06, day:0.35,pe:null,pb:1.2, roe:-0.5,mc:20,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:11148.0, day:-2.22,pe:233.9,pb:9.6, roe:4.3,mc:76,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:162.29, day:-0.7,pe:388.8,pb:12.8, roe:5.2,mc:43,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1554.8, day:-2.73,pe:95.1,pb:9.3, roe:10.4,mc:68,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:691.5, day:0.87,pe:66.1,pb:5.4, roe:7.5,mc:54,  ob:1, seed:2016,sector:"Electronics"},
...
const CONSENSUS_STATIC={
  ...
  ASTRAMICRO: {buy:6, hold:3, sell:1, target:2000, brokers:["post ₹2,205 Cr HAL order","MOFSL Buy","Uttam Radar cascade","cons."]},
...
Macro context (as of 10 Aug 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — TALKS STALL on Iranian conditions, oil rebounds (as of 10 Aug): last week's optimism cooled — Tehran said its Oman talks on a Hormuz route were 'nearing agreement' but warned it would NOT mean an immediate reopening, and Iran rejected direct US negotiations for now (citing breaches of the June interim deal) while demanding an end to the naval blockade, sanctions relief and war-damage compensation; FM Araghchi said Tehran is not in direct talks with Washington, contradicting US claims a deal is near; Houthis claimed an attack on Saudi's Jazan refinery and an ADNOC tanker was attacked in Hormuz; Brent climbed back above $84 (a third straight up session), recovering part of last week's ~7% slide, so crude ~$84 is a mild negative for India vs the sub-$77 seen days earlier; the sector's own drivers (Budget-capex hopes, the domestic order pipeline) remain in control; Astra Microwave reports Q1 FY27 today (10 Aug board meeting, 11 Aug call); Apollo Micro won ₹213 Cr of new orders (5 Aug) + IPREK Prime Development Agency empanelment; HAL is reportedly fining GE over a ~$716m engine crisis constraining Tejas Mk-1A production; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"📊",color:A.blue,   title:"Defence Stocks Rally up to 7% on Budget-Capex Hopes; Apollo Micro Wins ₹213 Cr",stat:"Sector rally · 6 Aug 2026",body:"Defence names surged this week, with HAL, Mazagon Dock and GRSE rising up to 7% in a single session, on expectations of a 20-25% hike in defence capital outlay in the upcoming Union Budget, a strong order pipeline and the continued indigenisation push. Tellingly, the rally came even as the Gulf war premium drained away — underscoring that domestic orders, not geopolitics, are now the sector's engine. Fresh order flow reinforced it: Apollo Micro Systems announced ₹213 crore of new orders (5 Aug) from DRDO, PSUs and private industry, plus empanelment as a Prime Development Agency for the indigenous IPREK precision-range-extension programme. One execution risk to watch: HAL is reportedly levying fines on GE over a ~$716m engine supply crisis that has been constraining Tejas Mk-1A production — a reminder that supply-chain and delivery timelines remain the key swing factor for the PSU order book's conversion to revenue. Net, the setup pairs strong order momentum and Budget optimism against still-stretched valuations and delivery risk."},
    ...
    {icon:"🕊️",color:A.teal, title:"Hormuz Deal Stalls on Iranian Conditions; Brent Rebounds to ~$84",stat:"Mixed signals · 10 Aug 2026",body:"Last week's optimism has cooled as the diplomacy hits Iranian preconditions. Over the weekend Tehran said its talks with Oman on a Hormuz shipping route were 'nearing agreement' but warned any arrangement would not lead to an immediate reopening of the strait — and, notably, Iran rejected direct negotiations with the US for now, citing breaches of the June interim deal, while maintaining demands for an end to the US naval blockade, the lifting of sanctions and compensation for war damages. Foreign Minister Araghchi stated Tehran is not currently in direct talks with Washington, contradicting US assertions that a deal is near; President Trump has signaled patience. Fresh incidents underscored the fragility: Houthi militants claimed an attack on Saudi Arabia's Jazan refinery, and a tanker operated by Abu Dhabi National Oil Co. was attacked in Hormuz over the weekend. Brent has climbed back above $84 (a third straight session of gains), recovering part of last week's ~7% slide as the market prices out the best-case quick reopening. For Indian defence, the choppy path keeps a modest war premium in play, though the sector's own drivers (Budget-capex hopes, the domestic order pipeline) remain firmly in control; crude near $84 is a mild negative for India's import bill versus the sub-$77 levels seen days earlier."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"VOLATILE",score:7,region:"Middle East",color:A.orange,date:"10 Aug 2026",hot:true,
     title:"Hormuz Deal Stalls on Iranian Conditions; Brent Rebounds to ~$84",
     detail:"Last week's optimism has cooled as diplomacy hits Iranian preconditions. Over the weekend Tehran said its Oman talks on a Hormuz shipping route were 'nearing agreement' but warned it would not mean an immediate reopening — and Iran rejected direct negotiations with the US for now, citing breaches of the June interim deal, while demanding an end to the US naval blockade, sanctions relief and war-damage compensation. FM Araghchi said Tehran is not currently in direct talks with Washington, contradicting US claims a deal is near; Trump signaled patience. Fresh incidents: Houthis claimed an attack on Saudi Arabia's Jazan refinery, and an ADNOC tanker was attacked in Hormuz over the weekend. Brent climbed back above $84 (a third straight session of gains), recovering part of last week's ~7% slide as the market prices out a quick reopening. Choppy path keeps a modest war premium; the sector's own drivers (Budget capex, order pipeline) remain in control. Crude ~$84 is a mild negative for India vs the sub-$77 seen days earlier.",
