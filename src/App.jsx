...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4592.0, day:-0.18,pe:33.7,pb:7.5, roe:24.0,mc:3071,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:387.55, day:-0.37,pe:46.1,pb:11.8, roe:27.6,mc:2833,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2307.8, day:0.52,pe:36.0,pb:9.5, roe:28.8,mc:931,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1403.6, day:1.52,pe:52.3,pb:6.3, roe:12.5,mc:369,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2626.1, day:0.59,pe:43.7,pb:11.5, roe:31.8,mc:301,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1261.8, day:-0.72,pe:110.3,pb:10.9, roe:9.9,mc:463,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4436.6, day:1.25,pe:91.2,pb:14.3, roe:16.7,mc:248,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1212.4, day:2.22,pe:111.1,pb:13.5, roe:13.1,mc:98,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1646.1, day:0.34,pe:82.2,pb:8.2, roe:11.8,mc:148,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18080.0, day:-0.9,pe:97.2,pb:26.1, roe:31.3,mc:1636,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:5194.0, day:-4.99,pe:169.6,pb:19.4, roe:12.6,mc:160,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2171.5, day:0.41,pe:96.6,pb:10.8, roe:11.6,mc:1038,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1773.8, day:4.09,pe:87.5,pb:12.8, roe:16.5,mc:168,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1781.4, day:1.26,pe:105.5,pb:5.1, roe:5.1,mc:148,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:383.1, day:1.15,pe:122.0,pb:10.1, roe:11.2,mc:142,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:397.25, day:1.4,pe:56.5,pb:4.9, roe:8.9,mc:74,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:848.5, day:0.06,pe:null,pb:6.2, roe:-2.8,mc:42,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:662.15, day:-0.15,pe:78.0,pb:12.4, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1191.2, day:0.88,pe:96.1,pb:8.2, roe:9.0,mc:61,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:17971.0, day:0.54,pe:264.6,pb:17.9, roe:7.2,mc:269,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:179.89, day:0.66,pe:null,pb:1.2, roe:-0.5,mc:20,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10331.0, day:-0.12,pe:217.1,pb:8.8, roe:4.3,mc:70,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:161.43, day:0.94,pe:375.4,pb:12.7, roe:5.2,mc:43,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1565.7, day:5.0,pe:92.9,pb:9.2, roe:10.4,mc:67,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:681.75, day:-0.03,pe:65.7,pb:5.3, roe:7.5,mc:54,  ob:1, seed:2016,sector:"Electronics"},
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"US–Iran Talks Gain Steam — Oman Floats Hormuz Deal, Brent Whipsaws to ~$88",stat:"Diplomacy advancing · 29 Jul 2026",body:"Diplomacy is now leading, though the path is volatile. The US paused strikes late Friday and Iran ceased retaliation; President Trump says Washington is holding 'good talks' with Tehran and sees a 'good chance' of a resolution, while cautioning strikes could resume if diplomacy fails. Iran's Foreign Minister Araghchi held talks with his Saudi and Omani counterparts, and Oman has proposed a joint regional mechanism to manage the Strait of Hormuz — allowing Iran to collect voluntary transit fees — which has reportedly gained Gulf support (Iran rejected a 50-50 shared-control version). Oil has swung wildly: Brent erased its war premium to ~$81 on Tuesday, its lowest in a week, then snapped back ~4% to ~$88 on Wednesday after a fresh Iranian attack on US troops and Iraqi-militia drone strikes on Saudi facilities — a ~$32 intra-month range. The Caspian Pipeline (Kazakh oil) resumed. Net for Indian defence: a durable de-escalation would cool the war premium, but the sector's driver is now firmly the domestic order pipeline and Q1 FY27 execution; crude's swings remain the key macro wildcard for India's import bill."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"DE-ESCALATING",score:8,region:"Middle East",color:A.teal,date:"29 Jul 2026",hot:true,
     title:"US–Iran Talks Gain Steam — Oman Floats Hormuz Deal, Brent Whipsaws to ~$88",
     detail:"Diplomacy is now leading, though volatile. The US paused strikes late Friday and Iran ceased retaliation; Trump says Washington is holding 'good talks' with Tehran and sees a 'good chance' of resolution (while warning strikes could resume if talks fail). Iran's FM Araghchi held talks with his Saudi and Omani counterparts, and Oman proposed a joint mechanism to manage the Strait of Hormuz — Iran collecting voluntary transit fees — reportedly gaining Gulf support. Oil swung wildly: Brent hit ~$81 Tuesday (lowest in a week) then rebounded ~4% to ~$88 Wednesday after a fresh Iranian attack on US troops and Iraqi-militia drones hit Saudi facilities (a ~$32 intra-month range). Caspian Pipeline (Kazakh oil) resumed. A durable de-escalation would cool the war premium; the sector's driver is now the domestic order pipeline and Q1 FY27 execution.",
