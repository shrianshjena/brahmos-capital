...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4263.8, day:0.61,pe:31.2,pb:6.9, roe:24.0,mc:2852,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:412.05, day:-0.22,pe:49.6,pb:12.6, roe:27.6,mc:3012,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2435.3, day:1.94,pe:38.0,pb:10.1, roe:28.8,mc:982,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1441.2, day:2.42,pe:52.8,pb:6.7, roe:12.5,mc:379,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2672.6, day:2.36,pe:44.5,pb:11.7, roe:31.8,mc:306,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1202.8, day:1.33,pe:104.5,pb:10.4, roe:9.9,mc:441,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4558.5, day:10.07,pe:94.1,pb:14.7, roe:16.7,mc:255,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1039.15, day:7.71,pe:95.3,pb:12.5, roe:13.1,mc:84,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1782.5, day:1.68,pe:82.7,pb:8.9, roe:11.8,mc:160,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18267.0, day:0.84,pe:98.9,pb:26.3, roe:31.3,mc:1653,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:7458.0, day:5.76,pe:246.0,pb:30.8, roe:12.6,mc:229,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:1925.4, day:1.71,pe:85.5,pb:9.6, roe:11.6,mc:921,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1457.7, day:3.22,pe:71.7,pb:10.5, roe:16.5,mc:138,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1764.2, day:1.31,pe:104.5,pb:5.2, roe:5.1,mc:147,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:413.05, day:1.49,pe:132.0,pb:10.9, roe:11.2,mc:148,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:450.35, day:7.01,pe:64.1,pb:5.9, roe:8.9,mc:84,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:964.9, day:2.79,pe:null,pb:7.0, roe:-2.8,mc:42,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:721.95, day:4.93,pe:84.6,pb:13.4, roe:16.5,mc:39,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1149.75, day:10.0,pe:92.4,pb:8.3, roe:9.0,mc:58,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:18692.0, day:2.3,pe:276.5,pb:19.8, roe:7.2,mc:280,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:189.97, day:3.52,pe:null,pb:1.3, roe:-0.5,mc:21,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10138.0, day:-0.35,pe:212.0,pb:8.7, roe:4.3,mc:69,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:167.98, day:4.35,pe:305.4,pb:13.2, roe:5.2,mc:45,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1935.5, day:4.94,pe:115.3,pb:11.3, roe:10.4,mc:82,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:443.65, day:1.94,pe:48.1,pb:3.5, roe:7.5,mc:35,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 10 Jun 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; Operation Epic Fury (US–Iran war) under a FRAGILE ceasefire — Brent ~$94/bbl (down ~20% from the late-April ~$120 peak), Iran says it ended operations vs Israel, a 60-day US–Iran MoU is mostly agreed, Strait of Hormuz still largely closed under a dual blockade; Ukraine war in its 4th year with on-off ceasefire talks and continued NATO/European rearmament; ICICI Securities top picks HAL, Solar Industries, Astra Microwave, BEL (Buy on PTC Industries, MIDHANI); Nifty India Defence index ~8,900 (mid-May), outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🌊",color:A.orange, title:"US–Iran Ceasefire Holds, Fragile — Brent ~$94 as 60-Day MoU Nears",stat:"Brent ~$94/bbl · 9 Jun 2026",body:"The US–Iran ceasefire is holding but remains fragile, with Brent crude around $94/bbl — down roughly 20% from its late-April peak near $120. Iran has said it ended military operations against Israel, and Washington and Tehran are reported to have mostly agreed a 60-day memorandum of understanding to extend the truce, though the Strait of Hormuz remains largely closed under a dual blockade and weekend strikes briefly breached the ceasefire. Sustained Gulf risk keeps air-defence, naval and missile procurement urgency elevated — supporting BDL, ZENTEC and the shipbuilders."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ESCALATING",score:8,region:"Middle East",color:A.orange,date:"9 Jun 2026",hot:true,
     title:"US–Iran Ceasefire Holds, Fragile — Brent ~$94 as 60-Day MoU Nears",
     detail:"The US–Iran ceasefire is holding but fragile, with Brent crude around $94/bbl — down roughly 20% from its late-April peak near $120. Iran has said it ended military operations against Israel, and Washington and Tehran are reported to have mostly agreed a 60-day MoU to extend the truce, though the Strait of Hormuz remains largely closed under a dual blockade and weekend strikes briefly breached the ceasefire. Sustained Gulf risk keeps air-defence, naval and missile procurement urgency elevated.",
