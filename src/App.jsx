...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🎯",color:A.orange,  title:"Nifty India Defence Index — Resilient Through the Oil Shock; Submarine Talks Add Fuel",stat:"18 Sep 2026 · Defence outperforming",body:"Through the September energy shock the defence index has held up well, outperforming a jittery Nifty 50 as the war premium and the structural spending story offset macro pressure from ~$104 crude and a hawkish Fed. On 12 September the Nifty logged its 8th straight gain with defence stocks rallying after the government began talks for six next-generation submarines (a P-75I follow-on that cascades to Mazagon Dock and GRSE for build and to BEL for combat systems), BEL among the top gainers. BEL (~26%) and HAL (~24%) remain the largest index weights. Index P/E sits near ~52-54x — rich, but underpinned by a multi-year order pipeline, deepening indigenisation and the start of Tejas Mk-1A deliveries. The near-term swing factors are execution cadence and whether the oil-driven macro tightening (rupee ~88/dollar, Fed higher-for-longer) crimps broader risk appetite, against a domestic order book that keeps building."},
