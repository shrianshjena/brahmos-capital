...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4695.6, day:0.01,pe:34.1,pb:7.8, roe:24.0,mc:3187,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:385.75, day:0.74,pe:48.6,pb:12.5, roe:27.6,mc:2987,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2231.9, day:-0.18,pe:37.3,pb:10.2, roe:28.8,mc:998,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1319.0, day:-0.45,pe:57.4,pb:6.7, roe:12.5,mc:391,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2314.6, day:-1.87,pe:35.9,pb:10.9, roe:31.8,mc:288,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1136.0, day:0.09,pe:88.8,pb:10.9, roe:9.9,mc:461,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4321.7, day:-0.85,pe:95.8,pb:14.8, roe:16.7,mc:257,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1318.8, day:-1.52,pe:120.3,pb:15.7, roe:13.1,mc:114,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1662.8, day:1.46,pe:90.0,pb:9.1, roe:11.8,mc:163,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18900.0, day:-1.82,pe:97.5,pb:31.0, roe:31.3,mc:1946,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:6792.0, day:-2.23,pe:157.5,pb:25.5, roe:12.6,mc:210,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:1885.0, day:0.42,pe:133.6,pb:9.9, roe:11.6,mc:947,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1621.9, day:1.76,pe:83.8,pb:12.0, roe:16.5,mc:158,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1991.9, day:2.71,pe:97.4,pb:5.9, roe:5.1,mc:173,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:370.35, day:-4.2,pe:115.1,pb:10.1, roe:11.2,mc:142,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:399.25, day:-1.63,pe:57.8,pb:5.1, roe:8.9,mc:78,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:702.35, day:-0.27,pe:844.1,pb:5.7, roe:-2.8,mc:39,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:667.85, day:-0.07,pe:107.1,pb:12.4, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1515.8, day:-1.48,pe:104.1,pb:10.1, roe:9.0,mc:75,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:22500.0, day:-0.27,pe:283.4,pb:23.7, roe:7.2,mc:357,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:160.76, day:-0.53,pe:null,pb:1.1, roe:-0.5,mc:19,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:12077.0, day:0.05,pe:183.5,pb:9.9, roe:4.3,mc:78,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:141.89, day:-1.81,pe:372.6,pb:12.3, roe:5.2,mc:42,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1684.5, day:-1.93,pe:116.4,pb:10.1, roe:10.4,mc:74,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:867.4, day:-1.73,pe:80.9,pb:6.6, roe:7.5,mc:66,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 3 Sep 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — WAR REIGNITES, heavy strikes both ways, Brent ~$95 (as of 3 Sep): the conflict flared back into open military exchange after ~a month of relative calm, the most serious escalation in weeks; over the weekend US CENTCOM launched dozens of strikes on Iran (hundreds of targets) after accusing Iranian forces of 'blatantly' attacking a Cyprus-flagged container ship (MV GFS Galaxy) transiting the Strait of Hormuz (earlier trigger: a US strike on Iran's Larak Island against rocket launchers said to be preparing to mine the strait); Iran retaliated by firing missiles and drones at US bases across Jordan, Kuwait, Bahrain, Iraq and the UAE; oil surged (WTI +~9% over three sessions), Brent settled below $96 Wed before easing 0.4% to ~$95.25 Thu (up ~20% on the month, ~42% YoY), with US diesel at a four-year high feeding a global bond sell-off; Trump said the strikes would be short-lived ('I don't think too long' but 'prepared to do another one'), and Bessent framed economic pressure as making a large-scale kinetic restart unlikely; the strait remains largely shut (~8M bpd vs ~20M pre-war); this sharp re-escalation reinforces the war premium and the structural case for defence spending, though sector returns remain anchored by domestic drivers (Budget-capex expectations, the order pipeline, indigenisation, Tejas deliveries beginning); Brent near $95 is a growing headwind for India's import bill/rupee; on the sector, HAL's Tejas Mk-1A deliveries are targeted to begin Aug-Sep 2026 (~20 aircraft planned FY27) after the GE F404 engine-supply constraint (~6 of 99 engines arrived since 2021); the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"War Reignites: US and Iran Trade Heavy Strikes, Brent Surges to ~$95 Then Steadies",stat:"Sharp re-escalation · 3 Sep 2026",body:"The conflict has flared back into open military exchange after roughly a month of relative calm, the most serious escalation in weeks. Over the weekend US Central Command launched dozens of strikes on Iran (hitting hundreds of targets) after accusing Iranian forces of 'blatantly' attacking a Cyprus-flagged container ship, the MV GFS Galaxy, as it transited the Strait of Hormuz; the earlier trigger was a US strike on Iran's Larak Island against rocket launchers said to be preparing to seed the strait with mines. Iran retaliated by firing missiles and drones at US bases across Jordan, Kuwait, Bahrain, Iraq and the UAE. Oil surged on the renewed hostilities, with WTI up about 9% over three sessions; Brent settled below $96 on Wednesday before easing 0.4% to about $95.25 on Thursday as the rally paused, leaving it up roughly 20% over the past month and about 42% year-on-year, with US diesel at a four-year high and the jump in energy costs feeding a global bond sell-off. President Trump said the latest strikes would be short-lived ('I don't think too long,' while adding 'we're prepared to do another one'), and Treasury Secretary Bessent framed the economic-pressure track as making a large-scale kinetic restart unlikely. The strait remains largely shut, with only about 8 million barrels a day passing versus roughly 20 million before the war. For Indian defence, this sharp re-escalation reinforces the war premium in sentiment and the structural case for defence spending, though the sector's returns remain anchored by domestic drivers (Budget-capex expectations, the order pipeline, indigenisation, Tejas deliveries beginning). Brent near $95 is a clear and growing headwind for India's import bill, rupee and inflation, making the conflict's path the single most important macro variable to watch."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ACTIVE WAR",score:9,region:"Middle East",color:A.red,date:"3 Sep 2026",hot:true,
     title:"War Reignites: US and Iran Trade Heavy Strikes, Brent Surges to ~$95 Then Steadies",
     detail:"The conflict flared back into open military exchange after ~a month of relative calm — the most serious escalation in weeks. Over the weekend US CENTCOM launched dozens of strikes on Iran (hundreds of targets) after accusing Iranian forces of 'blatantly' attacking a Cyprus-flagged container ship (MV GFS Galaxy) transiting Hormuz; the earlier trigger was a US strike on Iran's Larak Island against rocket launchers said to be preparing to mine the strait. Iran retaliated with missiles and drones at US bases across Jordan, Kuwait, Bahrain, Iraq and the UAE. Oil surged (WTI +~9% over three sessions); Brent settled below $96 Wed before easing 0.4% to ~$95.25 Thu, up ~20% on the month and ~42% YoY, with US diesel at a four-year high feeding a global bond sell-off. Trump said the strikes would be short-lived ('I don't think too long' but 'prepared to do another one'); Bessent framed economic pressure as making a large-scale kinetic restart unlikely. The strait stays largely shut (~8M bpd vs ~20M pre-war). Reinforces the war premium and the structural case for defence spending; sector returns still anchored by domestic drivers (Budget capex, orders, indigenisation, Tejas deliveries). Brent ~$95 is a growing headwind for India.",
