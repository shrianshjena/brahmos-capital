...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4998.0, day:-0.38,pe:36.5,pb:8.1, roe:24.0,mc:3343,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:409.4, day:0.05,pe:49.0,pb:12.5, roe:27.6,mc:2993,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2570.0, day:0.24,pe:38.7,pb:10.6, roe:28.8,mc:1037,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1489.0, day:0.27,pe:57.6,pb:6.7, roe:12.5,mc:392,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2617.8, day:-0.78,pe:37.4,pb:11.4, roe:31.8,mc:300,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1317.0, day:-2.37,pe:95.7,pb:11.4, roe:9.9,mc:483,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4700.2, day:-1.55,pe:98.5,pb:15.2, roe:16.7,mc:263,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1502.0, day:0.37,pe:130.4,pb:16.7, roe:13.1,mc:121,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1909.1, day:-1.22,pe:95.4,pb:9.6, roe:11.8,mc:172,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:19760.0, day:0.2,pe:89.5,pb:28.5, roe:31.3,mc:1788,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:7113.5, day:2.82,pe:168.6,pb:26.6, roe:12.6,mc:219,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2062.0, day:-0.34,pe:142.4,pb:10.3, roe:11.6,mc:986,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1684.2, day:-0.99,pe:88.4,pb:12.2, roe:16.5,mc:160,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1962.8, day:-0.21,pe:91.5,pb:5.6, roe:5.1,mc:163,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:386.75, day:0.01,pe:116.1,pb:10.2, roe:11.2,mc:144,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:420.5, day:-1.79,pe:58.2,pb:5.1, roe:8.9,mc:79,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:806.6, day:-2.25,pe:886.4,pb:5.9, roe:-2.8,mc:40,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:663.55, day:0.07,pe:78.2,pb:12.4, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1508.3, day:0.66,pe:108.2,pb:10.4, roe:9.0,mc:77,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:19623.0, day:0.76,pe:236.1,pb:19.5, roe:7.2,mc:294,  ob:3, seed:2011,sector:"Aerospace"},
  ...
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:11765.0, day:0.26,pe:189.1,pb:10.1, roe:4.3,mc:80,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:162.96, day:-0.55,pe:379.0,pb:12.8, roe:5.2,mc:43,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1600.6, day:0.49,pe:108.2,pb:9.4, roe:10.4,mc:68,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:730.25, day:2.05,pe:72.9,pb:5.7, roe:7.5,mc:58,  ob:1, seed:2016,sector:"Electronics"},
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"Brent Grinds Toward $93 on US-Iran Impasse; Trump Hints at Talks 'At Some Point'",stat:"Impasse, oil elevated · 20 Aug 2026",body:"The standoff continues to keep a firm risk premium in crude, with Brent grinding toward $93 and up more than 4% on the week, its fourth-to-fifth straight session of gains, as Washington and Tehran remain at an impasse over ending the war and reopening the Strait of Hormuz. The tone softened at the margin: President Trump said oil continues to flow through the waterway and, notably, that he would be open to resuming talks with Tehran 'at some point,' a small step back from this week's flat 'no negotiations' stance, though no talks are scheduled and the naval blockade stays in force. The pressure on Iran is still building on the economic front, with the UAE having suspended all financial and economic transactions with Tehran after accusing it of launching ballistic missiles at its territory. Physical flows remain the key swing factor: Gulf producers continue moving significant volumes via alternative routes and discreet shipments, US refinery runs are at their highest since September 2019, and EIA data showed a 4.4-million-barrel crude build last week, all tempering the spike. For Indian defence, the entrenched conflict sustains a war premium, but the sector's durable drivers (Budget-capex hopes, the domestic order pipeline, and continued indigenisation policy) remain firmly in control. Brent near $93 is a growing headwind for India's import bill, rupee and inflation, and a key macro variable to watch."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ACTIVE WAR",score:8,region:"Middle East",color:A.red,date:"20 Aug 2026",hot:true,
     title:"Brent Grinds Toward $93 on US-Iran Impasse; Trump Hints at Talks 'At Some Point'",
     detail:"The standoff keeps a firm risk premium in crude, with Brent grinding toward $93 (up >4% on the week, a 4th-5th straight up session) as Washington and Tehran remain at an impasse over ending the war and reopening Hormuz. Tone softened at the margin: Trump said oil keeps flowing through the strait and that he'd be open to resuming talks with Tehran 'at some point' — a small step back from this week's flat 'no negotiations' stance, though none are scheduled and the naval blockade stays. Economic pressure still building: the UAE suspended all financial/economic transactions with Iran after accusing it of a ballistic-missile attack. Physical flows the key swing factor: Gulf producers keep moving volumes via alternative routes, US refinery runs highest since Sept 2019, and EIA showed a 4.4M-barrel crude build — tempering the spike. Sector's durable drivers (Budget capex, order pipeline, indigenisation policy) remain in control. Brent near $93 is a growing headwind for India's import bill/rupee.",
