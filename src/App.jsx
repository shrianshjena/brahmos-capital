...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4581.7, day:2.02,pe:33.6,pb:7.5, roe:24.0,mc:3064,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:410.05, day:0.47,pe:49.5,pb:12.5, roe:27.6,mc:2997,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2354.1, day:0.32,pe:36.7,pb:9.7, roe:28.8,mc:950,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1405.3, day:-0.16,pe:51.5,pb:6.3, roe:12.5,mc:370,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2619.7, day:2.26,pe:43.5,pb:11.4, roe:31.8,mc:300,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1273.2, day:1.24,pe:111.3,pb:11.0, roe:9.9,mc:467,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4243.9, day:6.34,pe:87.9,pb:13.7, roe:16.7,mc:238,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1222.6, day:1.33,pe:111.3,pb:13.6, roe:13.1,mc:99,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1818.7, day:3.94,pe:84.2,pb:9.1, roe:11.8,mc:164,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:19045.0, day:0.09,pe:103.2,pb:27.5, roe:31.3,mc:1723,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:5573.5, day:-2.97,pe:190.3,pb:20.8, roe:12.6,mc:171,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2201.8, day:-0.33,pe:97.7,pb:11.0, roe:11.6,mc:1053,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1747.1, day:-0.22,pe:86.0,pb:12.6, roe:16.5,mc:166,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1786.3, day:0.89,pe:105.1,pb:5.1, roe:5.1,mc:149,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:390.55, day:-0.57,pe:126.0,pb:10.3, roe:11.2,mc:145,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:411.1, day:0.38,pe:58.7,pb:5.0, roe:8.9,mc:77,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:850.35, day:-0.81,pe:null,pb:6.2, roe:-2.8,mc:42,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:657.7, day:-0.59,pe:77.1,pb:12.3, roe:16.5,mc:35,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1276.2, day:0.13,pe:103.3,pb:9.2, roe:9.0,mc:65,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:17853.0, day:-0.98,pe:260.6,pb:17.8, roe:7.2,mc:268,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:185.7, day:0.15,pe:null,pb:1.2, roe:-0.5,mc:21,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10352.0, day:0.65,pe:218.8,pb:8.9, roe:4.3,mc:70,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:171.01, day:-0.88,pe:397.7,pb:13.4, roe:5.2,mc:45,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1575.4, day:-0.53,pe:93.8,pb:9.2, roe:10.4,mc:67,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:623.0, day:4.52,pe:67.4,pb:4.9, roe:7.5,mc:49,  ob:1, seed:2016,sector:"Electronics"},
...
const CONSENSUS_STATIC={
  HAL:        {buy:20,hold:6, sell:2, target:5500, brokers:["Antique","Motilal","HDFC Sec","Nomura","CLSA"]},
  BEL:        {buy:17,hold:6, sell:2, target:510,  brokers:["InCred","Motilal","Emkay","ICICI Sec","JM Fin"]},
  MAZDOCK:    {buy:16,hold:4, sell:2, target:2850, brokers:["Kotak","Motilal","Nuvama","CLSA","Jefferies"]},
  COCHINSHIP: {buy:12,hold:6, sell:3, target:1680, brokers:["HDFC Sec","Motilal","ICICI Sec","Axis","Prabhudas"]},
  GRSE:       {buy:14,hold:5, sell:2, target:3160, brokers:["Kotak","Emkay","Motilal","Yes Sec","BOB Cap"]},
...
Macro context (as of 21 Jul 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; Operation Epic Fury (US–Iran war) — the 18 Jun MoU (signed by Trump, Pakistan/Qatar-mediated) has COLLAPSED: after early-July tanker strikes, US Central Command resumed airstrikes on Iran and reimposed a naval blockade on Iranian ports (~14 Jul), the US Treasury revoked its Iranian-oil waiver (effective 17 Jul), and Trump (at the NATO summit) declared the ceasefire 'over'; Iran struck vessels in Hormuz and fired at US assets in Bahrain/Kuwait; Brent has climbed back to ~$84/bbl from sub-$74 early-July lows (still below the ~$120 April peak, ~8.5M bbl/day still transiting), a renewed near-term war premium for defence though oil pass-through is a mild negative for India's import bill; on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"US–Iran Ceasefire Collapses — US Reimposes Naval Blockade, Brent ~$84",stat:"Conflict resumed · 21 Jul 2026",body:"The June 18 MoU has broken down. After the early-July tanker strikes, the conflict re-ignited through mid-July: US Central Command resumed airstrikes on Iran and reimposed a naval blockade on Iranian ports (~14 Jul), the US Treasury revoked its waiver on Iranian oil sales (effective 17 Jul), and President Trump — at the NATO summit — declared the ceasefire 'over' and further talks a 'waste of time.' Iran had struck commercial vessels in the Strait of Hormuz and fired missiles/drones toward US assets in Bahrain and Kuwait. Brent crude has climbed back to ~$84/bbl from the sub-$74 early-July lows — still below the ~$120 April peak, as ~8.5M bbl/day reportedly still transits Hormuz. The renewed war premium is a near-term tailwind for defence sentiment, though the sector's structural driver remains India's domestic order pipeline (DAC ₹52,000 Cr + ₹79,000 Cr FY26). Watch oil's pass-through to India's import bill and rupee."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ESCALATING",score:9,region:"Middle East",color:A.red,date:"21 Jul 2026",hot:true,
     title:"US–Iran Ceasefire Collapses — US Reimposes Naval Blockade, Brent ~$84",
     detail:"The June 18 MoU has broken down. After the early-July tanker strikes, the conflict re-ignited through mid-July: US Central Command resumed airstrikes on Iran and reimposed a naval blockade on Iranian ports (~14 Jul), the US Treasury revoked its waiver on Iranian oil sales (effective 17 Jul), and Trump — at the NATO summit — declared the ceasefire 'over' and further talks a 'waste of time.' Iran struck commercial vessels in Hormuz and fired missiles/drones toward US assets in Bahrain and Kuwait. Brent has climbed to ~$84/bbl from the sub-$74 early-July lows (still below the ~$120 April peak; ~8.5M bbl/day reportedly still transits). The renewed war premium is a near-term tailwind for defence sentiment; the structural driver remains India's domestic order pipeline.",
