...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4284.7, day:2.2,pe:31.4,pb:7.0, roe:24.0,mc:2866,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:409.55, day:0.75,pe:49.4,pb:12.5, roe:27.6,mc:2994,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2440.4, day:1.26,pe:38.1,pb:10.1, roe:28.8,mc:984,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1411.8, day:-0.88,pe:51.9,pb:6.3, roe:12.5,mc:371,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2669.2, day:0.77,pe:44.4,pb:11.6, roe:31.8,mc:306,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1209.7, day:0.79,pe:105.0,pb:10.4, roe:9.9,mc:443,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4425.5, day:-2.64,pe:91.0,pb:14.3, roe:16.7,mc:248,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1108.15, day:1.0,pe:101.0,pb:12.3, roe:13.1,mc:89,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1789.1, day:-0.26,pe:83.1,pb:9.0, roe:11.8,mc:161,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:17277.0, day:0.78,pe:93.3,pb:24.9, roe:31.3,mc:1563,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:7344.0, day:2.58,pe:238.5,pb:27.5, roe:12.6,mc:226,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2020.5, day:3.88,pe:89.6,pb:10.1, roe:11.6,mc:966,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1458.0, day:0.98,pe:72.1,pb:10.5, roe:16.5,mc:138,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1778.8, day:0.17,pe:104.3,pb:5.3, roe:5.1,mc:148,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:421.65, day:2.99,pe:133.9,pb:11.1, roe:11.2,mc:152,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:436.35, day:0.29,pe:62.2,pb:5.7, roe:8.9,mc:82,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:864.85, day:-0.49,pe:null,pb:6.3, roe:-2.8,mc:38,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:683.3, day:-1.35,pe:80.2,pb:12.7, roe:16.5,mc:37,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1146.85, day:-1.1,pe:92.4,pb:8.3, roe:9.0,mc:58,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:18656.0, day:0.29,pe:278.6,pb:19.7, roe:7.2,mc:280,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:185.51, day:0.68,pe:null,pb:1.2, roe:-0.5,mc:21,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10602.0, day:4.24,pe:221.8,pb:9.1, roe:4.3,mc:72,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:167.06, day:0.32,pe:303.7,pb:13.1, roe:5.2,mc:44,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1905.8, day:-2.15,pe:113.8,pb:11.2, roe:10.4,mc:81,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:468.55, day:4.19,pe:50.8,pb:3.7, roe:7.5,mc:37,  ob:1, seed:2016,sector:"Electronics"},
...
const CONSENSUS_STATIC={
  ...
  PARAS:      {buy:10,hold:5, sell:4, target:1160,  brokers:["ICICI Sec","Axis","YES Sec","Nirmal Bang","Monarch"]},
  ZENTEC:     {buy:13,hold:4, sell:2, target:1900, brokers:["Motilal","HDFC Sec","Emkay","Nirmal Bang","BOB Cap"]},
  SOLARINDS:  {buy:18,hold:5, sell:2, target:21000,brokers:["ICICI Sec","Motilal","Emkay","Kotak","Jefferies"]},
  MTAR:       {buy:12,hold:6, sell:3, target:8000, brokers:["Motilal","HDFC Sec","Kotak","Emkay","Nuvama"]},
  BHARATFORG: {buy:16,hold:7, sell:2, target:2200, brokers:["Motilal","ICICI Sec","Kotak","CLSA","Nomura"]},
  ASTRAMICRO: {buy:14,hold:5, sell:2, target:1630, brokers:["ICICI Sec","Motilal","Axis","BOB Cap","Prabhudas"]},
  ...
  PREMEXPLN:  {buy:10,hold:5, sell:3, target:810,  brokers:["Motilal","HDFC Sec","YES Sec","Nirmal Bang","Monarch"]},
  ...
  DYNAMATECH: {buy:8, hold:6, sell:4, target:11200,brokers:["Kotak","Emkay","Motilal","YES Sec","Nuvama"]},
...
Macro context (as of 15 Jun 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; Operation Epic Fury (US–Iran war, since 28 Feb) is ENDING — a framework peace deal was REACHED on 14-15 Jun: both sides declared permanent termination of military operations on all fronts incl. Lebanon, Trump authorized the toll-free reopening of the Strait of Hormuz and removal of the US naval blockade, with formal signing set for Fri 19 Jun in Switzerland (lifts US oil sanctions, prewar shipping within ~30 days); Brent eased into the mid-$80s from the ~$95 closure peak; Indian defence stocks still rose on 15 Jun, confirming structural demand is independent of the ceasefire; Ukraine war in its 4th year with on-off ceasefire talks and continued NATO/European rearmament; ICICI Securities top picks HAL, Solar Industries, Astra Microwave, BEL (Buy on PTC Industries, MIDHANI); Nifty India Defence index ~8,900 (mid-May), outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"US–Iran Peace Deal REACHED — War Ends, Hormuz Reopening Authorized",stat:"Signing 19 Jun · Switzerland",body:"The US–Iran war (Operation Epic Fury, since 28 Feb) is ending. A framework deal has been REACHED: both sides declared the immediate and permanent termination of military operations on all fronts — including Lebanon — and Trump authorized the toll-free reopening of the Strait of Hormuz and removal of the US naval blockade ('let the oil flow'). The formal signing is set for Friday 19 June in Switzerland; the MoU lifts US oil sanctions and restores prewar shipping within ~30 days (mine clearance first). Brent has eased into the mid-$80s from the ~$95 closure peak, and global equities and the G7 welcomed the deal. Notably, Indian defence stocks still rose on 15 June — confirming that India's structural demand (record order books, ₹7.85L Cr FY27 budget, exports, P-75I/BrahMos pipelines) is independent of the ceasefire. Residual risk: implementation timelines and the durability of the Lebanon truce."},
