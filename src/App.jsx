...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4192.0, day:0.47,pe:30.8,pb:6.8, roe:24.0,mc:2804,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:407.8, day:1.37,pe:49.2,pb:12.4, roe:27.6,mc:2981,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2412.0, day:2.75,pe:37.6,pb:10.0, roe:28.8,mc:973,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1424.5, day:2.64,pe:52.4,pb:6.4, roe:12.5,mc:375,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2653.0, day:4.61,pe:44.1,pb:11.6, roe:31.8,mc:304,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1202.0, day:3.59,pe:104.3,pb:10.4, roe:9.9,mc:441,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4522.0, day:7.54,pe:93.0,pb:14.6, roe:16.7,mc:253,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1099.5, day:11.16,pe:100.2,pb:12.2, roe:13.1,mc:89,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1797.4, day:4.8,pe:83.5,pb:9.0, roe:11.8,mc:162,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:17170.0, day:0.17,pe:92.7,pb:24.8, roe:31.3,mc:1554,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:7147.0, day:13.34,pe:232.1,pb:29.5, roe:12.6,mc:220,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:1938.6, day:-0.22,pe:85.9,pb:9.7, roe:11.6,mc:927,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1441.0, day:3.2,pe:71.3,pb:10.4, roe:16.5,mc:137,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1773.0, day:2.64,pe:104.0,pb:5.3, roe:5.1,mc:148,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:409.4, day:7.24,pe:130.0,pb:10.8, roe:11.2,mc:148,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:435.0, day:3.07,pe:62.1,pb:5.7, roe:8.9,mc:81,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:870.0, day:-0.1,pe:null,pb:6.4, roe:-2.8,mc:38,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:688.0, day:5.06,pe:80.8,pb:12.8, roe:16.5,mc:37,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1158.0, day:7.54,pe:93.3,pb:8.3, roe:9.0,mc:59,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:18600.0, day:2.31,pe:277.7,pb:19.7, roe:7.2,mc:279,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:185.15, day:6.09,pe:null,pb:1.2, roe:-0.5,mc:21,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10195.0, day:3.17,pe:213.3,pb:8.7, roe:4.3,mc:69,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:166.0, day:5.62,pe:301.8,pb:13.0, roe:5.2,mc:44,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1967.4, day:5.0,pe:117.5,pb:11.5, roe:10.4,mc:84,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:452.0, day:4.67,pe:49.0,pb:3.5, roe:7.5,mc:36,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 15 Jun 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; Operation Epic Fury (US–Iran war) is now DE-ESCALATING — after the 11 Jun Hormuz shutdown, the US and Iran agreed the final MoU text to reopen the Strait of Hormuz immediately (no tolls, prewar shipping within ~30 days), extend the ceasefire 60 days, lift US sanctions and open nuclear talks; Trump says it could be signed over the weekend; Brent fell to ~$87/bbl from ~$95 and equities rebounded; the defence sector bounced back sharply on 12 Jun (MTAR +13% recovering its Bloom Energy drop) after the 11 Jun profit-booking selloff; Ukraine war in its 4th year with on-off ceasefire talks and continued NATO/European rearmament; ICICI Securities top picks HAL, Solar Industries, Astra Microwave, BEL (Buy on PTC Industries, MIDHANI); Nifty India Defence index ~8,900 (mid-May), outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"De-escalation: US–Iran Peace Deal Near Signing — Brent Falls to ~$87",stat:"Deal imminent · 15 Jun 2026",body:"After the 11 June Hormuz shutdown, the conflict has swung toward resolution. The US and Iran are reported to have agreed the final text of a memorandum of understanding that would reopen the Strait of Hormuz immediately (no tolls, prewar shipping restored within ~30 days), extend the ceasefire 60 days, lift US sanctions and open nuclear talks — with Trump saying it could be signed over the weekend. Brent crude has fallen to ~$87/bbl (from ~$95) on the breakthrough, and global equities rebounded. A lasting peace would ease the oil-driven war premium, but India's structural defence demand — record order books, the ₹7.85L Cr FY27 budget, exports and indigenisation — is independent of the ceasefire. Wildcard: continued Israeli strikes in Lebanon could still unsettle the deal."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"EASING",score:8,region:"Middle East",color:A.teal,date:"15 Jun 2026",hot:true,
     title:"US–Iran Peace Deal Near Signing — Hormuz to Reopen, Brent Falls to ~$87",
     detail:"After the 11 June Hormuz shutdown, the conflict has swung toward resolution. The US and Iran are reported to have agreed the final text of an MoU that would reopen the Strait of Hormuz immediately (no tolls, prewar shipping within ~30 days), extend the ceasefire 60 days, lift US sanctions and open nuclear talks — Trump says it could be signed over the weekend. Brent has fallen to ~$87/bbl from ~$95, and global equities rebounded. India's structural defence demand (order books, FY27 budget, exports) is independent of the ceasefire; continued Israeli strikes in Lebanon remain a wildcard.",
