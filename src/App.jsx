...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4995.0, day:1.75,pe:35.8,pb:8.0, roe:24.0,mc:3283,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:405.7, day:-0.04,pe:48.3,pb:12.4, roe:27.6,mc:2967,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2552.0, day:-0.08,pe:38.4,pb:10.6, roe:28.8,mc:1030,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1506.0, day:0.67,pe:55.0,pb:6.7, roe:12.5,mc:394,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2576.4, day:0.04,pe:36.9,pb:11.2, roe:31.8,mc:295,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1340.0, day:2.48,pe:112.1,pb:11.3, roe:9.9,mc:479,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4491.0, day:2.26,pe:91.8,pb:14.2, roe:16.7,mc:246,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1280.7, day:-0.26,pe:110.1,pb:14.3, roe:13.1,mc:103,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1824.3, day:0.25,pe:90.4,pb:9.1, roe:11.8,mc:164,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18730.0, day:-0.21,pe:100.7,pb:27.1, roe:31.3,mc:1698,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:7111.5, day:3.17,pe:162.8,pb:25.8, roe:12.6,mc:212,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2081.5, day:1.49,pe:98.0,pb:10.2, roe:11.6,mc:981,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1665.4, day:-2.25,pe:86.1,pb:12.3, roe:16.5,mc:162,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1900.6, day:-0.09,pe:88.6,pb:5.4, roe:5.1,mc:158,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:379.85, day:-2.28,pe:128.3,pb:10.2, roe:11.2,mc:144,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:408.45, day:-4.51,pe:61.2,pb:5.2, roe:8.9,mc:80,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:810.3, day:-4.99,pe:null,pb:6.2, roe:-2.8,mc:42,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:651.15, day:-0.03,pe:76.6,pb:12.2, roe:16.5,mc:35,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1418.5, day:-0.2,pe:100.9,pb:9.8, roe:9.0,mc:72,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:18895.0, day:-0.06,pe:275.3,pb:18.8, roe:7.2,mc:283,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:177.01, day:-0.57,pe:null,pb:1.2, roe:-0.5,mc:20,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10674.0, day:0.7,pe:221.1,pb:9.1, roe:4.3,mc:72,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:158.23, day:-1.27,pe:381.6,pb:12.6, roe:5.2,mc:43,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1543.4, day:-0.14,pe:94.6,pb:9.0, roe:10.4,mc:66,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:688.95, day:-2.83,pe:68.4,pb:5.6, roe:7.5,mc:56,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 11 Aug 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — HORMUZ STANDOFF HARDENS as of 11 Aug: Trump told Axios the US is 'only semi-negotiating' with Iran (walking back last week's claim that talks were underway) and signaled he'd rely on the US naval blockade rather than fresh airstrikes to pressure Tehran ('watching Iran with its huge inflation... they have no money'), countering Iran's war-damage compensation demand with his own; Tehran insists the blockade must lift before it fully reopens the Strait of Hormuz and has rejected direct US talks for now; Iran and Oman still haven't finalized a shipping-route deal, and after weekend attacks on Saudi's Jazan refinery (Houthis) and an ADNOC tanker in Hormuz, Brent climbed a fourth straight session to nearly $88 (highest in ~2 weeks, +5% Monday), so crude ~$88 is a renewed negative for India's import bill/rupee after the brief dip toward $77; the sector's own drivers (Budget-capex hopes, the domestic order pipeline) remain in control; Astra Microwave reported Q1 FY27 (10 Aug) — consolidated PAT ₹12 Cr (-24% YoY), revenue ₹177 Cr (-11.5% YoY), EBITDA margin 18.7% on execution delays, stock -6-9%, BUT a record order book of ₹2,849 Cr (multi-year visibility), with MD S.G. Reddy exiting 30 Sep and Dr M.V. Reddy becoming MD from 1 Oct; Apollo Micro won ₹213 Cr of new orders (5 Aug) + IPREK Prime Development Agency empanelment; HAL is reportedly fining GE over a ~$716m engine crisis constraining Tejas Mk-1A production; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"📊",color:A.blue,   title:"Astra Micro Q1 Misses (PAT -24%) but Order Book Hits Record ₹2,849 Cr",stat:"Results · 11 Aug 2026",body:"Astra Microwave's Q1 FY27 print (reported 10 Aug) captured the sector's central tension in one name. Consolidated net profit fell 24% YoY to ₹12 crore and revenue dropped 11.5% to ₹177 crore, with EBITDA margin compressing to 18.7% (from 28.7% in FY26) — the company blamed temporary execution delays tied to customer approvals and supply-chain issues, and the stock fell 6-9%. But the structural story strengthened: the consolidated order book reached a record ₹2,849 crore, and that excludes the bulk of the ₹2,205 crore HAL Uttam-radar award still to flow in, giving multi-year revenue visibility. Management flagged a leadership transition — MD S. G. Reddy steps down on 30 September (to steer the planned demerger), with Dr. M. V. Reddy taking over from 1 October. The takeaway mirrors the wider group: near-term earnings are lumpy and valuations leave no room for a soft quarter, but the order pipeline underpinning the multi-year thesis is intact and growing. Earlier in the week, Apollo Micro's ₹213 crore of fresh orders and IPREK empanelment reinforced the same private-sector-participation theme."},
    ...
    {icon:"🕊️",color:A.teal, title:"Hormuz Standoff Hardens — Trump 'Only Semi-Negotiating', Brent Nears $88",stat:"Stalemate · 11 Aug 2026",body:"The diplomatic path has soured further and oil has pushed higher. President Trump told Axios the US is 'only semi-negotiating' with Iran, walking back last week's claim that talks were underway, and signaled he would rely on the US naval blockade to pressure Tehran rather than launch fresh airstrikes ('we are just watching Iran with its huge inflation and the fact they have no money'). He also lashed out at Iran's demand for war-damage compensation, countering with his own demand for reparations. Tehran, for its part, insists the US must lift the blockade before it will fully reopen the Strait of Hormuz, and has rejected direct US talks for now. With Iran and Oman still not having finalized a shipping-route agreement, and after weekend attacks on Saudi Arabia's Jazan refinery (Houthis) and an ADNOC tanker in Hormuz, Brent has climbed for a fourth straight session to nearly $88 — its highest in about two weeks and up ~5% on Monday alone — as the market prices out a near-term deal. For Indian defence, the entrenched standoff sustains a modest war premium, but the sector's own drivers (Budget-capex hopes, the domestic order pipeline) remain firmly in control. Crude near $88 is a renewed negative for India's import bill, rupee and inflation after the brief dip toward $77."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ESCALATING",score:7,region:"Middle East",color:A.orange,date:"11 Aug 2026",hot:true,
     title:"Hormuz Standoff Hardens — Trump 'Only Semi-Negotiating', Brent Nears $88",
     detail:"The diplomatic path soured further and oil pushed higher. Trump told Axios the US is 'only semi-negotiating' with Iran, walking back last week's claim that talks were underway, and signaled he'd rely on the US naval blockade rather than fresh airstrikes to pressure Tehran ('watching Iran with its huge inflation... they have no money'). He lashed out at Iran's demand for war-damage compensation with a counter-demand. Tehran insists the US must lift the blockade before it fully reopens Hormuz and has rejected direct US talks for now. With Iran-Oman still not finalizing a shipping-route deal, and after weekend attacks on Saudi's Jazan refinery (Houthis) and an ADNOC tanker in Hormuz, Brent climbed a fourth straight session to nearly $88 (highest in ~2 weeks, +5% Monday) as the market prices out a near-term deal. The entrenched standoff sustains a modest war premium; the sector's own drivers (Budget capex, order pipeline) remain in control. Crude ~$88 is a renewed negative for India after the brief dip toward $77.",
