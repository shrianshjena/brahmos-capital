...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4998.0, day:-0.38,pe:36.0,pb:8.2, roe:24.0,mc:3355,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:409.4, day:0.05,pe:48.7,pb:12.5, roe:27.6,mc:2991,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2570.0, day:0.24,pe:38.6,pb:10.6, roe:28.8,mc:1034,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1489.0, day:0.27,pe:57.5,pb:6.7, roe:12.5,mc:391,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2617.8, day:-0.78,pe:37.8,pb:11.5, roe:31.8,mc:302,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1317.0, day:-2.37,pe:94.9,pb:11.7, roe:9.9,mc:494,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4700.2, day:-1.55,pe:99.8,pb:15.4, roe:16.7,mc:267,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1502.0, day:0.37,pe:127.2,pb:16.6, roe:13.1,mc:121,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1909.1, day:-1.22,pe:96.5,pb:9.7, roe:11.8,mc:174,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:19760.0, day:0.2,pe:89.2,pb:28.4, roe:31.3,mc:1785,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:7113.5, day:2.82,pe:159.0,pb:25.9, roe:12.6,mc:213,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2062.0, day:-0.34,pe:140.8,pb:10.3, roe:11.6,mc:989,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1684.2, day:-0.99,pe:86.0,pb:12.3, roe:16.5,mc:162,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1962.8, day:-0.21,pe:91.8,pb:5.6, roe:5.1,mc:164,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:386.75, day:0.01,pe:115.8,pb:10.2, roe:11.2,mc:144,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:420.5, day:-1.79,pe:59.3,pb:5.2, roe:8.9,mc:80,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:806.6, day:-2.25,pe:897.0,pb:6.0, roe:-2.8,mc:41,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:663.55, day:0.07,pe:78.1,pb:12.4, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1508.3, day:0.66,pe:106.2,pb:10.3, roe:9.0,mc:76,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:19623.0, day:0.76,pe:234.3,pb:19.4, roe:7.2,mc:292,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:173.71, day:-0.55,pe:null,pb:1.2, roe:-0.5,mc:19,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:11765.0, day:0.26,pe:188.1,pb:10.0, roe:4.3,mc:80,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:162.96, day:-0.55,pe:390.1,pb:12.9, roe:5.2,mc:44,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1600.6, day:0.49,pe:107.7,pb:9.3, roe:10.4,mc:68,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:730.25, day:2.05,pe:69.4,pb:5.6, roe:7.5,mc:57,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 19 Aug 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — WIDENING, oil climbs toward $92 (as of 19 Aug): with the interim ceasefire lapsed and no talks underway, the conflict has widened and Brent climbed toward $92 (fourth straight up session); the sharpest new development is the UAE suspending ALL financial and economic transactions with Iran after accusing Tehran of launching ballistic missiles at its territory; Trump confirmed no ongoing negotiations while the US naval blockade remains (he claims Hormuz is open and mines cleared, but traffic stays very limited); shipping risks are intensifying (three China-linked supertankers turned back, a vessel struck by a projectile, ~8 attacks on Hormuz-transiting ships incl. UAE/Saudi-linked this month); Gulf producers keep moving volumes via alternative routes and US refinery activity hit its highest since Sept 2019, with rising US inventories tempering the spike; Brent near $92 is a growing negative for India's import bill/rupee; the sector's durable drivers (Budget-capex hopes, the domestic order pipeline) remain in control; the Defence Ministry notified its sixth Positive Indigenisation List (18 Aug) via the SRIJAN portal (33,000+ items offered for indigenisation, 15,700+ already indigenised, ~₹9,000 Cr import substitution) reinforcing the Atmanirbhar theme for BEL/HAL/BDL; Astra Microwave reported a weak Q1 FY27 (10 Aug, PAT ₹12 Cr -24% YoY) but a record order book of ₹2,849 Cr; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"Brent Climbs Toward $92 as Conflict Widens — UAE Cuts Financial Ties With Iran",stat:"Escalating · 19 Aug 2026",body:"With the interim ceasefire lapsed and no talks underway, the conflict has widened and crude has pushed higher for a fourth straight session, with Brent climbing toward $92. The sharpest new development is regional: the UAE announced a suspension of all financial and economic transactions with Iran after accusing Tehran of launching ballistic missiles at its territory, a significant escalation among Gulf states. President Trump confirmed there are no ongoing negotiations with Tehran while the US naval blockade remains in force; he claims Hormuz is open and mines cleared, but traffic through the strait stays very limited. Shipping risks are intensifying: three China-linked supertankers turned back while transiting the waterway, a vessel was struck by a projectile near the strait, and roughly eight attacks on Hormuz-transiting ships (including UAE- and Saudi-linked vessels) have been reported so far this month. Gulf producers continue moving significant volumes via alternative routes and discreet shipments, and US refinery activity has reached its highest since September 2019 — factors that, with rising US crude inventories, are tempering the spike. For Indian defence, the entrenched, widening conflict sustains a firm war premium, though the sector's durable drivers (Budget-capex hopes, the domestic order pipeline) remain in control. Brent near $92, up sharply year-on-year, is a growing negative for India's import bill, rupee and inflation."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ESCALATING",score:8,region:"Middle East",color:A.red,date:"19 Aug 2026",hot:true,
     title:"Brent Climbs Toward $92 as Conflict Widens — UAE Cuts Financial Ties With Iran",
     detail:"With the interim ceasefire lapsed and no talks underway, the conflict has widened and crude pushed higher for a fourth straight session, Brent climbing toward $92. Sharpest new development: the UAE suspended all financial and economic transactions with Iran after accusing Tehran of launching ballistic missiles at its territory — a significant escalation among Gulf states. Trump confirmed there are no ongoing negotiations while the US naval blockade remains; he claims Hormuz is open and mines cleared, but traffic stays very limited. Shipping risks intensifying: three China-linked supertankers turned back transiting the strait, a vessel was struck by a projectile, and ~8 attacks on Hormuz-transiting ships (incl. UAE- and Saudi-linked) reported this month. Gulf producers keep moving volumes via alternative routes/discreet shipments, and US refinery activity hit its highest since Sept 2019 — with rising US inventories, tempering the spike. War premium firm; the sector's durable drivers (Budget capex, order pipeline) remain in control. Brent near $92 is a growing negative for India's import bill/rupee.",
