...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4800.0, day:0.54,pe:34.9,pb:7.8, roe:24.0,mc:3210,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:393.55, day:0.4,pe:47.4,pb:12.0, roe:27.6,mc:2877,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2199.6, day:-0.11,pe:33.1,pb:9.1, roe:28.8,mc:887,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1377.0, day:0.51,pe:53.2,pb:6.2, roe:12.5,mc:362,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2319.0, day:-1.07,pe:33.7,pb:10.1, roe:31.8,mc:266,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1140.0, day:-1.3,pe:80.9,pb:9.8, roe:9.9,mc:418,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4418.8, day:0.53,pe:92.5,pb:14.3, roe:16.7,mc:247,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1321.0, day:-1.67,pe:113.0,pb:14.7, roe:13.1,mc:106,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1682.4, day:2.23,pe:83.8,pb:8.4, roe:11.8,mc:151,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:19745.0, day:1.36,pe:90.5,pb:28.5, roe:31.3,mc:1787,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:6900.0, day:-2.13,pe:157.9,pb:25.8, roe:12.6,mc:212,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2008.0, day:0.46,pe:135.8,pb:10.0, roe:11.6,mc:981,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1622.4, day:1.64,pe:82.0,pb:11.7, roe:16.5,mc:154,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:2036.5, day:-0.39,pe:97.7,pb:5.8, roe:5.1,mc:170,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:395.6, day:-0.86,pe:115.3,pb:10.4, roe:11.2,mc:147,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:405.05, day:-0.45,pe:57.5,pb:5.0, roe:8.9,mc:76,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:729.85, day:0.48,pe:776.4,pb:5.3, roe:-2.8,mc:36,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:680.35, day:-0.02,pe:108.7,pb:12.7, roe:16.5,mc:37,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1665.1, day:-1.61,pe:118.3,pb:11.5, roe:9.0,mc:85,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:21810.0, day:-0.05,pe:263.0,pb:21.7, roe:7.2,mc:327,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:161.99, day:-0.18,pe:null,pb:1.1, roe:-0.5,mc:18,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:13153.0, day:4.8,pe:209.6,pb:11.3, roe:4.3,mc:89,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:155.94, day:0.39,pe:371.3,pb:12.3, roe:5.2,mc:41,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1892.1, day:-1.61,pe:128.3,pb:11.1, roe:10.4,mc:80,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:931.4, day:2.05,pe:90.3,pb:7.3, roe:7.5,mc:74,  ob:1, seed:2016,sector:"Electronics"},
...
const CONSENSUS_STATIC={
  HAL:        {buy:18,hold:7, sell:3, target:5400, brokers:["Antique ₹5,706","Motilal ₹5,500","Kotak Add ₹4,810","Nomura","CLSA"]},
  BEL:        {buy:14,hold:8, sell:4, target:515, brokers:["Antique ₹532","Motilal ₹510","Kotak Reduce","ICICI Sec","JM Fin"]},
  MAZDOCK:    {buy:9,hold:8, sell:5, target:2700, brokers:["Antique ₹3,275 Buy","Kotak SELL ₹1,950","Motilal","Nuvama","Emkay"]},
  COCHINSHIP: {buy:10,hold:7, sell:4, target:1690, brokers:["Antique ₹1,693","Motilal","Kotak","ICICI Sec","Emkay"]},
  GRSE:       {buy:11,hold:6, sell:4, target:3140, brokers:["Antique ₹3,141","Motilal","Kotak","Nuvama","Emkay"]},
  BDL:        {buy:8,hold:11, sell:4, target:1250, brokers:["Nomura","Kotak","HDFC Sec","Axis","Jefferies"]},
  DATAPATTNS: {buy:8, hold:6, sell:6, target:5110, brokers:["HDFC Sec","Motilal","Kotak","Emkay","Prabhudas"]},
  PARAS:      {buy:10,hold:5, sell:4, target:1440,  brokers:["ICICI Sec","Axis","YES Sec","Nirmal Bang","Monarch"]},
  ZENTEC:     {buy:8, hold:9, sell:4, target:1850, brokers:["Antique ₹2,000 Buy","MOFSL ₹1,700","record OB","cons."]},
  SOLARINDS:  {buy:8,hold:9, sell:6, target:18000, brokers:["Antique ₹18,633","Kotak SELL ₹10,300","Motilal","Jefferies","Emkay"]},
  ...
  ASTRAMICRO: {buy:5, hold:4, sell:1, target:1900, brokers:["record OB ₹2,849 Cr","Q1 miss (exec delays)","HAL Uttam order","cons."]},
  BEML:       {buy:11,hold:6, sell:3, target:2200, brokers:["Antique ₹2,245","Motilal","ICICI Sec","Nuvama","Emkay"]},
  ...
  IDEAFORGE:  {buy:8, hold:7, sell:4, target:950, brokers:["Invic ₹1,046","Wall St avg ₹892","Univest ₹895","cons."]},
  PREMEXPLN:  {buy:10,hold:5, sell:3, target:860,  brokers:["Motilal","HDFC Sec","YES Sec","Nirmal Bang","Monarch"]},
  UNIMECH:    {buy:11,hold:5, sell:2, target:1430, brokers:["Kotak","Motilal","Emkay","YES Sec","BOB Cap"]},
  PTCIND:     {buy:12,hold:4, sell:2, target:21500,brokers:["ICICI Sec","Motilal","Kotak","Emkay","Nuvama"]},
  DCXINDIA:   {buy:9, hold:6, sell:3, target:220,  brokers:["HDFC Sec","Motilal","YES Sec","Nirmal Bang","Monarch"]},
  DYNAMATECH: {buy:8, hold:6, sell:4, target:12000,brokers:["Kotak","Emkay","Motilal","YES Sec","Nuvama"]},
  AVANTEL:    {buy:7, hold:5, sell:5, target:195,  brokers:["ICICI Sec","Axis","YES Sec","Nirmal Bang","Monarch"]},
  AXISCADES:  {buy:3, hold:5, sell:3, target:1700, brokers:["TradingView ₹2,131","TipRanks Hold ₹1,387","JM Fin","Univest","cons."]},
  CYIENTDLM:  {buy:8, hold:6, sell:3, target:871, brokers:["PL ₹871 (18 Sep)","MOFSL ₹830","order visibility","cons."]},
};
...
const NEWS=[
  // --- March 12 ---
  {id:"m12a", date:"21 Apr 2026",cat:"MARKET", impact:"MIXED",   hot:false,tickers:["HAL","GRSE","DATAPATTNS","SOLARINDS","AXISCADES"],
  ...
  {id:"m12b", date:"21 Apr 2026",cat:"GEOPO",  impact:"BULLISH", hot:true, tickers:["BDL","ZENTEC","HAL","PARAS"],
  ...
  {id:"m12c", date:"21 Apr 2026",cat:"ORDER",  impact:"BULLISH", hot:false,tickers:["AXISCADES"],
  ...
  {id:"m12d", date:"21 Apr 2026",cat:"POLICY", impact:"BULLISH", hot:false,tickers:["HAL","BEL","DATAPATTNS"],
  ...
  // --- March 10 ---
  {id:3, date:"21 Apr 2026",cat:"DEAL",   impact:"BULLISH",hot:true, tickers:["HAL","BEL","BDL"],
  ...
  {id:4, date:"21 Apr 2026",cat:"BROKER", impact:"BULLISH",hot:false,tickers:["HAL","BEL","BDL","MAZDOCK"],
  ...
  // --- March 8 ---
  {id:6, date:"21 Apr 2026", cat:"RESULTS",impact:"BULLISH",hot:false,tickers:["DATAPATTNS"],
  ...
  // --- March 5 ---
  {id:10,date:"21 Apr 2026", cat:"ORDER",  impact:"BULLISH",hot:true, tickers:["MAZDOCK"],
   ...
   source:"Defence News India"},
  {id:11,date:"21 Apr 2026", cat:"GEOPO",  impact:"BULLISH",hot:true, tickers:["SECTOR"],
  ...
  // --- March 4 ---
  {id:12,date:"21 Apr 2026", cat:"ORDER",  impact:"BULLISH",hot:false,tickers:["HAL"],
...
function buildPrompt(stocks){
  const priceLines=stocks.map(s=>{
    ...
    return `- ${s.ticker} | ${fullName} | CMP ₹${s.px.toFixed(0)} | Entry ₹${s.buy} | Return ${s.ret>=0?"+":""}${s.ret.toFixed(1)}% | P/E ${s.pe==null?"NM (loss-making TTM)":s.pe+"x"}${c?" | Target ₹"+c.target:""}`;
  }).join("\n");
...
Macro context (as of 25 Sep 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — TENTATIVE DE-ESCALATION: peace talks in New York explore a phased Hormuz reopening, Brent eases to ~$106 (as of 25 Sep): for the first time in the arc a genuine diplomatic off-ramp is in view even as fighting continues; US and Iranian negotiators are holding talks in New York, reportedly exploring a PHASED deal to reopen the Strait of Hormuz, which moderated an oil rally that touched ~$108 intraday on 24 Sep; Brent eased 0.9% to ~$105.70 on 25 Sep, ending above $100 for a 2nd straight week but well off the ~$110 peak of the prior week; tangibly, tanker traffic is resuming (four large VLCCs, ~2M barrels each of Saudi crude, exited the strait Thursday); but the path is bumpy — on 24 Sep oil climbed after an Iranian military adviser threatened to widen the war to the Indian Ocean and Saudi intercepted fresh Houthi missiles, and BofA warned (22 Sep) Brent could top $150 if disruptions persist (~350M barrels drained from global inventories since March); this follows the mid-month spike (Brent crossed $100 on 9 Sep after the US destroyed five IRGC tankers on 8 Sep, the Saudi East-West pipeline was shut 11 Sep, Brent peaked ~$108-110 around 15-16 Sep, and the Fed HIKED 25bp to 3.75-4% on 16 Sep — its first hike since 2023 — on oil-driven inflation); a credible de-escalation would gradually drain the war premium from sentiment but leave the structural domestic defence thesis intact, and lower oil would be a clear macro positive for India's import bill/rupee (~88/dollar)/inflation; India-defence catalysts this week: BEL won fresh orders worth ~₹648 Cr (19 Sep; IR jammers, comms, cybersecurity, thermal imagers, AI software) with CLSA Outperform ₹522 and HSBC initiating Buy on HAL at ₹6,350, and on 23 Sep Emkay Global published a constructive sector note (HAL & BEL top picks, 'sustained growth ahead', Nifty India Defence index +23% in 2026); earlier, on 8 Sep the government approved ~₹1.1 trillion (~$11bn) of military purchases (98% from Indian industry, BSE Defence +2.1%), on 11 Sep the Nifty logged its 8th straight gain on six-next-gen-submarine talks, and on 15 Sep defence corrected sharply (Nifty India Defence index -5.5% to ~9,190, Solar -14%) amid a broad selloff before recovering; the sector's returns remain anchored by domestic drivers (order pipeline, indigenisation, Tejas Mk-1A deliveries targeted to begin Aug-Sep 2026 with ~20 aircraft planned FY27); the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
/* ═══ PORTFOLIO ════════════════════════════════════════════════════════════ */
const SIGNALS_STATIC=[{id:1,ticker:"BDL",type:"STRONG BUY",cat:"Geo",conf:87,date:"30 May 2026",title:"Vietnam BrahMos Deal Signed — ₹60,000 Cr",detail:"India signed a ~₹60,000 Cr BrahMos export deal with Vietnam at the Shangri-La Dialogue; Indonesia pact in final stages. BDL is the key warhead & propulsion supplier on every BrahMos contract."},{id:2,ticker:"HAL",type:"STRONG BUY",cat:"Market",conf:86,date:"May 2026",title:"FY26 Order Book Record ₹2.54L Cr",detail:"HAL reported a record ₹2.54L Cr order book (from ₹1.89L Cr) and ₹9,115 Cr PAT, guiding FY27 to 10–12% revenue growth at 30–31% EBITDA margins. ~31x P/E — the large-cap value pick."},{id:3,ticker:"BEL",type:"BUY",cat:"Market",conf:78,date:"May 2026",title:"FY26 Revenue ₹27,480 Cr, ~29% ROE",detail:"BEL FY26 revenue ₹27,480 Cr (+16.2%), PAT ₹6,048 Cr (+14.4%), order book ₹73,882 Cr, ₹0.55 dividend. Quality compounder but ~49x P/E; accumulate on dips. Entry: ₹385–405."},{id:4,ticker:"MAZDOCK",type:"STRONG BUY",cat:"Gov",conf:82,date:"Jun 2026",title:"P-75I Cleared by MoF — ~₹70,000 Cr Order Imminent",detail:"The Ministry of Finance has approved the P-75I stealth submarine programme; only CCS sign-off remains before contracting. MDL — having just delivered the 6th & final P-17A frigate — is the front-runner. Adds multi-decade visibility on top of the Scorpène (P-75) line."},{id:5,ticker:"ZENTEC",type:"BUY",cat:"Gov",conf:75,date:"Jun 2026",title:"Lowest Bidder on AVNL Weapon Stations; Anti-Drone Tailwind",detail:"Zen Technologies emerged as lowest bidder on AVNL's remote-controlled weapon stations project, adding to a strong order pipeline. The fragile US–Iran ceasefire keeps emergency C-UAV procurement elevated, and ZENTEC is a primary domestic anti-drone beneficiary."},{id:6,ticker:"SOLARINDS",type:"BUY",cat:"Geo",conf:71,date:"May 2026",title:"Munitions & Propellant Demand Surge",detail:"Sustained global conflict and Indian ammunition indigenisation drive Solar Industries' defence order book. Premium valuation (~100x) reflects strong growth visibility."},{id:7,ticker:"COCHINSHIP",type:"HOLD",cat:"Market",conf:60,date:"May 2026",title:"Re-rated to ~55x — Await Pullback",detail:"NGOPV execution strong and margin recovery underway, but the stock has re-rated to ~55x vs sector ~52x. Less of a bargain than earlier; accumulate on dips."},{id:8,ticker:"DATAPATTNS",type:"REDUCE",cat:"Market",conf:64,date:"May 2026",title:"Q4 Revenue Miss; ~89x Prices in Perfection",detail:"Data Patterns fell ~9% on a Q4 revenue miss. Strong franchise but ~89x P/E leaves no room for slippage. Trim 20–30% on strength."},{id:9,ticker:"MTAR",type:"WATCH",cat:"Market",conf:48,date:"9 Jul 2026",title:"Rich at ~226x P/E — Bloom Energy Concentration Persists",detail:"MTAR has drifted ~16% off its mid-June high as the sector's war premium faded. At ~226x P/E the stock still prices in flawless execution, and its dependence on Bloom Energy (>55% of revenue) remains a structural concentration risk. Hold; watch for client diversification and order-book breadth before adding."}];
...
function ScreenerView({stocks}){
  ...
  const filtered=stocks.filter(s=>(s.pe==null||s.pe<=peMax)&&s.ret>=retMin&&(sectorF==="All"||s.sector===sectorF)).sort((a,b)=>{const av=a[sortKey]==null?(sortAsc?Infinity:-Infinity):a[sortKey];const bv=b[sortKey]==null?(sortAsc?Infinity:-Infinity):b[sortKey];return sortAsc?(av-bv):(bv-av);});
...
function WhyDefenceView(){
  const THESIS=[
    {icon:"🎯",color:A.green,  title:"BEL's ₹30,000 Cr QRSAM Order Expected Within Weeks — Supply Chain Follows",stat:"Largest pending award · Jul 2026",body:"Motilal Oswal expects BEL to receive the ~₹30,000 crore Quick Reaction Surface-to-Air Missile (QRSAM) order within the next few weeks — the single largest pending award in the domestic pipeline — following the DAC's ₹52,000 crore July clearance. Subsequent QRSAM-linked contracts are expected to cascade through the supply chain: BDL for missiles, Astra Microwave for TR modules and EW subsystems, and Apollo Micro Systems for on-board computers and navigation. MOFSL has named BEL its top defence pick post-DAC, noting that the AoN approvals granted over the last two years materially expand the addressable market and order-inflow visibility for domestic players. BEL's order backlog already sits near ₹75,600+ crore."},
    {icon:"⚖️",color:A.orange, title:"Analysts Split on Valuation — Kotak Turns Cautious as Antique Stays Bullish",stat:"Stock selection over sector beta",body:"For the first time in this cycle, brokerage views have genuinely diverged. Kotak initiated with an unusually cautious stance: SELL on Mazagon Dock (fair value ₹1,950) and Solar Industries (₹10,300), REDUCE on BEL, and only an ADD on HAL (₹4,810) — arguing that after a multi-year rally, much of the expected earnings growth is already priced in. Antique, by contrast, maintains Buy across the board with far higher targets (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532, GRSE ₹3,141, BEML ₹2,245, Cochin ₹1,693). The gap is a valuation debate, not a fundamental one: both camps accept the order-book story. The practical implication is that stock selection now matters far more than simply owning the sector, and execution — visible in the Q1 FY27 results season — becomes the differentiator that settles it."},
    {icon:"📊",color:A.blue,   title:"The Sector's Core Tension: HAL's Tejas Execution and the Engine Bottleneck",stat:"Execution watch · 31 Aug 2026",body:"HAL's recent pullback from its all-time high crystallises the question hanging over the whole sector: not whether the orders exist, but how fast they convert to revenue. The proximate constraint is the Tejas Mk-1A, where around 30 airframes have been built, flown and tested but deliveries have been gated by GE F404 engine supply, with only about 6 of 99 engines received since 2021. The encouraging development is that handovers are now targeted to begin in the August-September 2026 window, with roughly 20 aircraft planned for FY27, the start of the conversion the market has been waiting for. HAL, in short, has far more signed work than it has been able to execute (an order book of roughly ₹2.5 lakh crore against about ₹33,000 crore of FY26 revenue, some seven-plus years of cover), the mirror image of BEL, which is still waiting for a roughly ₹30,000 crore QRSAM order to be signed. The episode is a useful reminder that in this sector order-book conversion, not just backlog size, is the variable that matters: in the June quarter Mazagon Dock converted about 16.2% of its order book into revenue while Bharat Dynamics converted only 2.2%. It also underlines a valuation nuance the market often misses, that the three most profitable names (Mazagon at roughly 29% ROE, BEL at 27%, HAL at 24%) are also among the cheapest on earnings. None of this dents the multi-year structural thesis (record FY27 defence budget of ₹7.85 lakh crore, deep indigenisation, a full order pipeline stretching toward FY30), but it does argue for watching Tejas delivery cadence and engine-supply resolution as the near-term swing factors."},
    {icon:"✅",color:A.green,  title:"DAC Clears ₹52,000 Cr — FY26 Approvals Hit ~₹3.3 Lakh Cr, ~2x Annual Outlay",stat:"AoN tranche · 3 Jul 2026",body:"The Defence Acquisition Council, chaired by Rajnath Singh, approved fresh capital-acquisition proposals worth about ₹52,000 crore on 3 July (with a further ~₹79,000 crore of clearances referenced by brokerages) — spanning air-defence layering, unmanned/ISR systems, missiles, electronics and shipbuilding under 'Buy and Make'. Motilal Oswal notes FY26 year-to-date defence capital approvals now total roughly ₹3.3 lakh crore, nearly double the ~₹1.8 lakh crore annual capital outlay — an exceptional order-visibility signal. The Nifty India Defence index rose on the news, with BDL, BEML, Cochin Shipyard and Paras Defence up more than 2%. Brokers reiterated Buy on BEL, HAL and BDL (Motilal targets ₹500 / ₹5,800 / ₹2,000) and named Astra Microwave and Solar Industries among preferred picks. The key question shifts from approvals to the pace of AoN-to-contract conversion and execution."},
    {icon:"🏭",color:A.green,  title:"Record FY26 Defence Production ₹1.78 Lakh Cr — Sector Leads Market to New Highs",stat:"Nifty Defence ~9,400 · 17 Jun 2026",body:"India's domestic defence production hit a record ₹1.78 lakh crore in FY26, underscoring the indigenisation push and long-term order visibility. The data lit a fire under the sector on 17 June: the Nifty India Defence index jumped ~3% to a fresh high near 9,400 (17 of 19 constituents higher), with Paras Defence +14%, MTAR +7.6%, Astra Microwave +5.2% and Data Patterns +4.9% leading. Falling crude (Brent below $80 on the US–Iran peace progress) and the broader Nifty crossing 24,000 amplified the move. Record production plus record order books (HAL ₹2.54L Cr, BEL ₹73,882 Cr) reinforce the structural growth runway."},
    {icon:"🛥️",color:A.blue,   title:"P-75I Stealth Submarine Programme Cleared — ~₹70,000 Cr to MDL Next",stat:"Navy submarine order imminent · Jun 2026",body:"The Ministry of Finance has approved the P-75I stealth submarine programme, leaving only CCS sign-off before official contracting — clearing the path for the long-awaited ~₹70,000 Cr Navy order. Mazagon Dock, which has just delivered the 6th and final P-17A stealth frigate, is the front-runner. This is the single largest pending naval contract and would give MDL multi-decade revenue visibility on top of its existing Scorpène (P-75) line."},
    {icon:"🔬",color:A.indigo, title:"Research: What the US–Iran Conflict Means for Indian Defence",stat:"Analysis · 15 Jun 2026",body:"The US–Iran war (Operation Epic Fury) has been 2026's dominant macro driver — swinging Brent from ~$70 to ~$120 and back toward ~$87 as the conflict escalated to a full Strait of Hormuz closure (11 Jun), then a fragile MoU signed on 18 Jun that has held — barely — through renewed flare-ups in early July (Iran struck a tanker on 7 Jul; Trump has called the deal 'over'). For Indian defence equities the read-through is two-layered. Near term, a 'war premium' on sentiment ebbs and flows with each headline — visible in the 11 Jun selloff and the 12 Jun rebound. Structurally, sustained global conflict has reset defence-budget priorities worldwide and reinforced India's indigenisation, air-defence, missile and naval-procurement urgency. Crucially, India's demand is largely insulated from the ceasefire outcome: order books (HAL ₹2.54L Cr, BEL ₹73,882 Cr, plus record ₹1.78L Cr FY26 production), the ₹7.85L Cr FY27 budget, the ₹50,000 Cr FY29 export target and the P-75I/BrahMos pipelines are policy-driven and multi-year. A durable peace would compress the oil-driven war premium and macro-risk overhang — but it does not dent India's structural capex. Watch items: oil's path (a sustained spike pressures India's import bill and inflation) and any rotation out of defensives into broader cyclicals on de-escalation."},
    {icon:"🧭",color:A.indigo, title:"Research: Does an Eventual Peace Deflate the Defence Trade?",stat:"Analysis · 8 Jul 2026",body:"As the US–Iran MoU staggers toward a durable settlement — signed 18 June but since collapsed — US airstrikes and a naval blockade resumed in mid-July, and Trump has declared it 'over' — the question for the sector is whether an eventual peace removes its catalyst. The bear case: part of 2026's defence strength rode a 'war premium' — oil spikes and geopolitical fear — and a lasting ceasefire could fade that near-term driver and spark rotation into oil-sensitive cyclicals, with the sector still richly valued. The bull case, stronger for India specifically: domestic defence demand is capex- and policy-driven, not conflict-driven. The pipeline is locked in regardless of the Gulf — the ~₹70,000 Cr P-75I order, the fresh ₹52,000 Cr DAC clearance, Vietnam BrahMos, record ₹1.78L Cr FY26 production, the ₹7.85L Cr FY27 budget and the ₹50,000 Cr FY29 export target. The tell: each flicker of peace has only briefly cooled the names — the market keeps voting that the structural order story dominates the war premium. The nuanced read-through: expect the most macro-sensitive names to stay volatile near term while structural compounders (HAL, BEL, MDL on execution + order books) remain supported — stock selection matters more after the war than it did during the fear-driven rising tide. Watch oil's floor and any re-escalation from Israel's rejection of the framework."},
    {icon:"📦",color:A.teal,   title:"Order Momentum Accelerates — BEL ₹2,100 Cr, GRSE NG-OPV, US FMS $428M",stat:"FY26 DAC approvals at all-time high",body:"Order awarding is picking up sharply. BEL booked a cumulative ₹2,100 Cr in fresh orders; GRSE launched the first of 11 next-gen offshore patrol vessels; Zen Technologies emerged as lowest bidder on AVNL's remote-controlled weapon stations; and the US State Department cleared $428M in foreign military sales to India. ICICI Securities expects FY27 order build-up to outpace FY26 — with air-defence, missiles, electronic warfare and drones leading — and names HAL, Solar Industries, Astra Microwave and BEL as top picks."},
    {icon:"🚀",color:A.green,  title:"India–Vietnam BrahMos Deal Signed — ₹60,000 Cr Export Breakthrough",stat:"₹60,000 Cr · 30 May 2026 · Shangri-La",body:"At the Shangri-La Dialogue in Singapore on 30 May 2026, India confirmed a signed BrahMos supersonic cruise missile export deal with Vietnam — valued at roughly ₹60,000 Cr (~$629M), covering the Block-3 variant (290–300 km range), training and logistics. A similar Indonesia pact is in its final stages. Vietnam becomes the second foreign BrahMos customer after the Philippines (2022). India's defence exports have crossed ₹21,000+ Cr and the ₹50,000 Cr FY29 target now looks conservative. BDL (warhead and propulsion), HAL and BEL benefit from every contract signed."},
    {icon:"📈",color:A.teal,   title:"FY26 Results: HAL Order Book Hits Record ₹2.54L Cr; BEL Tops ₹27,000 Cr Revenue",stat:"HAL ₹9,115 Cr PAT · May 2026",body:"The FY26 earnings season confirmed the structural story. HAL reported a record order book of ₹2.54 lakh crore (up from ₹1.89 lakh crore), ₹9,115 Cr standalone net profit (+9.1%), and guided FY27 revenue growth of 10–12% at 30–31% EBITDA margins. BEL delivered FY26 revenue of ₹27,480 Cr (+16.2%) and PAT of ₹6,048 Cr (+14.4%) on a ₹73,882 Cr order book with ~29% ROE. Execution — not order intake — is now the key variable for the sector."},
    {icon:"🕊️",color:A.teal, title:"Peace Talks in New York Explore a Phased Hormuz Reopening; Brent Eases to ~$106",stat:"Tentative de-escalation · 25 Sep 2026",body:"For the first time in the arc, a genuine diplomatic off-ramp is in view, even as the fighting continues. US and Iranian negotiators are holding talks in New York and are reported to be exploring a phased deal to reopen the Strait of Hormuz, which moderated an oil rally that had touched about $108 intraday on 24 September. Brent eased 0.9% to roughly $105.70 on 25 September, ending above $100 for a second straight week but well off the ~$110 peak of the prior week. Tangibly, tanker traffic is beginning to resume: four large VLCCs, each carrying about 2 million barrels of Saudi crude, exited the strait on Thursday. The path is far from smooth, though. On 24 September oil had climbed after an Iranian military adviser threatened to widen the war to the Indian Ocean and Saudi Arabia intercepted fresh Houthi missiles, and Bank of America warned on 22 September that Brent could top $150 if the disruptions persist, estimating that at least 350 million barrels have drained from global inventories since March. The Brent-WTI spread widened to $12.68 (its largest since May) on a potential US diesel-export ban. This backdrop follows the mid-month spike that had crossed $100 on 9 September, peaked near $108-110 around 15-16 September, and pushed the Federal Reserve to hike 25bp to 3.75-4% on 16 September (its first increase since 2023) on oil-driven inflation. For Indian defence, a credible move toward de-escalation would gradually drain the war premium from sentiment, but the structural domestic thesis (order pipeline, indigenisation, Tejas deliveries beginning) is intact, and a lower oil price would be a clear macro positive for India's import bill, rupee (around 88/dollar) and inflation. The conflict's path remains the single most important near-term macro variable."},
    ...
    {icon:"🌊",color:A.orange, title:"Strait of Hormuz Under Renewed US Blockade — Traffic Disrupted Again",stat:"~20% of global oil transits here",body:"After a brief partial reopening in late June, the Strait of Hormuz is disrupted again: the US reimposed a naval blockade on Iranian ports in mid-July amid renewed strikes, and ship tracking shows a fresh drop in transits — though the US Energy Department noted ~8.5M barrels still crossed on one recent day. Roughly 20% of global oil trade transits this chokepoint. Trump has dropped his earlier demand for a 20% Hormuz transit fee. The repeated closures underscore India's maritime exposure: securing sea lanes and a growing blue-water navy keeps accelerated naval procurement — submarines, OPVs, frigates — a national-security imperative regardless of the ceasefire's fate."},
    ...
    {icon:"💡",color:A.indigo, title:"Valuation: HAL at 31x P/E — Still Cheap vs ~52x Sector Average",stat:"HAL, COCHINSHIP: relative bargains",body:"Not all defence stocks are expensive. HAL at ~31x P/E and Cochin Shipyard at ~55x offer more reasonable entry relative to their growth trajectories, with HAL the clear large-cap value pick. BEL, by contrast, now trades near ~49x and MAZDOCK ~47x — the latter justified by its transformative submarine pipeline. Quality names at fair prices still exist in this sector, but they require selectivity."},    {icon:"🤝",color:A.teal,    title:"BrahMos Export Pipeline — Philippines, Vietnam, Indonesia Next",stat:"₹60,000 Cr Vietnam · 30 May 2026",body:"The Philippines was the first BrahMos buyer ($375M, 2022, deliveries underway). The signed ~₹60,000 Cr Vietnam deal (30 May 2026) is the breakthrough export, with Indonesia in final stages and other ASEAN and Gulf nations in discussions. India's defence exports have crossed ₹21,000+ Cr, and the ₹50,000 Cr FY29 target looks increasingly achievable. BDL, HAL and BEL are the direct beneficiaries of every export contract signed."},
    {icon:"⚡",color:A.orange,  title:"Akash-NG Cleared for Production — Domestic Air Defence Boom",stat:"DRDO Clearance · Mar 2026",body:"DRDO's clearance of the Akash Next-Generation missile system for series production is a landmark event for BEL and BDL. The Akash-NG offers double the range and triple the hit probability of Akash-1. With 72 squadrons planned for the Indian Army and Air Force, the order pipeline spans the next 8–10 years. This was a key driver missing from the original Akash thesis."},
    {icon:"🇩🇪",color:A.green,  title:"Germany Submarine Deal Imminent — €5B Inflow for MDL",stat:"21 Apr 2026 · TKMS x MDL",body:"Rajnath Singh's 21-23 Apr Germany visit is expected to finalise a €5 billion inter-governmental agreement for 6 TKMS stealth submarines to be built by Mazagon Dock. This is India's largest European defence deal in a decade. MDL is also in discussion for the Eurodrone MALE UAV programme. MDL shares rallied 4.65% in a single session on the news."},
    {icon:"🚀",color:A.green,    title:"₹2.38L Cr DAC Deals — Multi-Year Order Book Visibility",stat:"FY27 Capex ₹2.2L Cr",body:"The Defence Acquisition Council's approval of ₹2.38 lakh crore in new procurements in April 2026 gives BEL, HAL and BDL the strongest order-book visibility in a decade. Key tailwinds: QRSAM (BEL), Akash missile variants (BEL+BDL), Su-30 SLEP (HAL), medium transport aircraft (HAL), drone-killer missiles (BDL+Zen Tech), and 6 TKMS submarines (MDL). FY27 defence capex allocation is ₹2.2 lakh crore."},
    {icon:"✈️",color:A.teal,     title:"HAL Su-57 Licence Production — 5th-Gen Stealth Fighter",stat:"Apr 2026 · Technical Assessments",body:"HAL Chairman Dr DK Sunil confirmed Su-57 Felon licence production talks with Russia have advanced to on-ground inspections and technical assessments. This would make India the first foreign operator to build a 5th-gen stealth fighter. Combined with the indigenous AMCA programme (BEL-L&T avionics) and Tejas Mk2 rollout, HAL's product portfolio spans every combat aircraft tier — including 4.5-gen, 5-gen, and trainer programmes."},
    {icon:"🏭",color:A.green,    title:"HAL Nashik 3rd Assembly Line — Tejas Output 24/year",stat:"Apr 2026 · Capacity Expansion",body:"HAL's third Tejas Mk1A assembly line at Nashik is now operational, scaling total production to 24 jets/year. This resolves the historic bottleneck on HAL's 83-aircraft Tejas Mk1A order. IAF has signalled intent for 100+ HLFT-42 supersonic trainers, and the Rafale DRAL joint venture (HAL-Dassault) is preparing for indigenous Rafale assembly. HAL's delivery execution — the key concern for brokerages — is finally accelerating."},
    {icon:"🎯",color:A.orange,  title:"Nifty India Defence Index — Recovered From Mid-Month Dip; +23% YTD, Brokers Constructive",stat:"25 Sep 2026 · Defence sector",body:"After a choppy first half of September, the defence sector has steadied and is now up about 23% in 2026. The month's arc: on 8 September the government approved roughly ₹1.1 trillion (~$11bn) of military purchases (98% sourced from Indian industry), lifting the BSE Defence index as much as 2.1%; on 11 September the Nifty logged its 8th straight gain on talks for six next-generation submarines (a P-75I follow-on cascading to Mazagon Dock and GRSE for build and BEL for combat systems). The sector then corrected sharply on 15 September — the Nifty India Defence index fell ~5.5% to ~9,190 as HAL, BEL and Solar Industries (over half the index weight) sold off amid a broad decline (the Sensex shed ~2,200 points in September on ~$106 crude, 5% US yields and the hawkish Fed) — before recovering through the back half of the month. Fresh catalysts: BEL won ~₹648 crore of new orders (19 September; IR jammers, communications, cybersecurity, thermal imagers, AI software), CLSA rates it Outperform (₹522) and HSBC initiated Buy on HAL (₹6,350), and on 23 September Emkay Global published a constructive note flagging HAL and BEL as top picks with 'sustained growth ahead'. BEL (~26%) and HAL (~24%) remain the largest weights; index P/E sits near ~52-54x — rich, but underpinned by a multi-year order pipeline, deepening indigenisation and the start of Tejas Mk-1A deliveries. The key swing factors now are execution cadence and whether an eventual US-Iran de-escalation (peace talks are underway) compresses the war premium, against a domestic order book that keeps building."},
...
function HeatmapView({stocks}){
  ...
  const vals=stocks.map(s=>s[metric]).filter(v=>v!=null);
  ...
  return(
    <div style={{padding:"24px 28px"}}>
      ...
      <div className="heatmap-grid" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:14,marginBottom:18}}>
        {stocks.map(s=>{const v=s[metric];const isNA=v==null;const c=isNA?A.t4:getColor(v);const lbl=isNA?"NM":getLabel(v);return(<div key={s.ticker} style={{background:A.card,borderRadius:16,padding:20,border:`1px solid ${A.sepLight}`,position:"relative",overflow:"hidden"}}><div style={{position:"absolute",inset:0,background:"radial-gradient(circle at 80% 20%,"+c+"22 0%,transparent 60%)",pointerEvents:"none"}}/><div style={{display:"flex",justifyContent:"space-between",marginBottom:12}} className="heatmap-card-inner"><span style={{color:A.blue,fontSize:13,fontWeight:700,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",maxWidth:"55%"}}>{s.ticker}</span><span style={{background:c+"22",color:c,borderRadius:6,fontSize:10,fontWeight:700,padding:"3px 8px",flexShrink:0}}>{lbl}</span></div><p className="heatmap-val" style={{color:c,fontSize:34,fontWeight:800,letterSpacing:"-0.03em",lineHeight:1,marginBottom:6}}>{isNA?"NM":m.fmt(v)}</p><p style={{color:A.t3,fontSize:11,marginBottom:12}}>{isNA?"Loss-making (TTM)":m.desc}</p><div style={{height:4,background:A.sep,borderRadius:2,marginBottom:4}}><div style={{width:""+(isNA?0:((v-minV)/(maxV-minV))*100)+"%",height:"100%",background:c,borderRadius:2}}/></div><div style={{display:"flex",justifyContent:"space-between"}}><span style={{fontSize:10,color:A.t4}}>{m.fmt(minV)}</span><span style={{fontSize:10,color:A.t4}}>{m.fmt(maxV)}</span></div></div>);})}
      </div>
      {metric==="pe"&&(<div style={{background:A.card,borderRadius:14,padding:"16px 20px",border:`1px solid ${A.sepLight}`,display:"flex",gap:12,alignItems:"flex-start"}}><Info size={16} color={A.blue} style={{marginTop:1,flexShrink:0}}/><p style={{fontSize:13,color:A.t2,lineHeight:1.65}}><span style={{color:A.t1,fontWeight:600}}>Sector average P/E: ~52x</span> · Among large-caps, HAL (~31x) and MAZDOCK (~37x) screen most reasonably relative to growth; GRSE (~43x) is mid-pack. BEL (~49x), Cochin Shipyard (~53x), Solar Industries (~100x) and BDL (~103x) trade richer. Several small-caps now price in aggressive execution — MTAR (~244x), PTC Industries (~276x) and Avantel (~317x) leave little margin of safety, while IDEAFORGE and DCX Systems are loss-making on a trailing basis (P/E not meaningful).</p></div>)}
    </div>
  );
}
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    {id:109,impact:"ACTIVE WAR",score:9,region:"Commodities",color:A.red,date:"9 Sep 2026",hot:true,
     title:"Brent Crosses $100 for First Time Since July as US Destroys IRGC Oil Tankers",
     detail:"A milestone in the war's energy shock: on 9 Sep Brent crossed $100/bbl for the first time since July (~$100.19-100.96), and by that day's close had surged further — WTI +6.7% to $102.48, Brent +6.3% to $107.63 — its highest since May. The trigger was 8 Sep US CENTCOM strikes that destroyed five IRGC oil tankers in the Strait of Hormuz (retaliation for an attempted attack on a US aircraft carrier), after which the IRGC warned all tankers to evacuate Kuwaiti and Bahraini waters. Iran retaliated with missile attacks on US forces in Jordan, and Houthi strikes injured 70+ at Saudi energy facilities. Sec of State Rubio vowed continued strikes on Iranian tankers. Oil was up >18% in September at this point; Goldman flagged $120+ risk. A textbook war-premium repricing that cascaded into inflation and rate expectations worldwide.",
     tickers:["SOLARINDS","BDL","MAZDOCK","COCHINSHIP","HAL"]},
    {id:110,impact:"HAWKISH",score:7,region:"Global Macro",color:A.orange,date:"16 Sep 2026",hot:false,
     title:"Fed Hikes 25bp to 3.75-4% — First Increase Since 2023 — on Oil-Driven Inflation",
     detail:"The crude spike flowed straight through to monetary policy: on 16 Sep the Federal Reserve raised the federal funds rate 25bp to 3.75-4% in a unanimous 12-0 vote, its first hike since 2023, explicitly to combat inflation driven by spiralling oil prices. Chair Kevin Warsh said inflation had been 'too high for too long'; the dot plot signalled another hike possible in December (year-end 4.1-4.4%), a higher-for-longer stance. The US 10-year Treasury yield touched the psychologically key 5% level around the decision before easing to ~4.93% as oil pulled back. For India, a hawkish Fed plus ~$104 Brent pressures the rupee (~88/dollar), FPI flows and the RBI's own policy runway — a macro headwind that sits alongside, but does not derail, the domestic defence-spending thesis.",
     tickers:["SECTOR"]},
    {id:108,impact:"BULLISH",score:9,region:"India",color:A.green,date:"22 Jul 2026",hot:true,
     title:"BEL's ₹30,000 Cr QRSAM Order Expected Within Weeks",
     detail:"Motilal Oswal expects BEL to receive the ~₹30,000 crore QRSAM (Quick Reaction Surface-to-Air Missile) order within weeks — the largest pending domestic award — following the DAC's ₹52,000 Cr July clearance. QRSAM-linked contracts should cascade to BDL (missiles), Astra Microwave (TR modules, EW subsystems) and Apollo Micro Systems (on-board computers, navigation). MOFSL names BEL its top defence pick post-DAC; BEL's backlog already sits near ₹75,600+ Cr. Separately, analyst views have split on valuation — Kotak is cautious (SELL on Mazagon ₹1,950 and Solar ₹10,300, REDUCE on BEL) while Antique stays Buy across the board — making execution in Q1 FY27 the differentiator.",
     tickers:["BEL","BDL","ASTRAMICRO","APOLLOMICRO"]},
    {id:107,impact:"BULLISH",score:9,region:"India",color:A.green,date:"3 Jul 2026",hot:true,
     title:"DAC Clears ₹52,000 Cr — FY26 Approvals ~₹3.3 Lakh Cr, Nearly 2x Annual Outlay",
     detail:"The Defence Acquisition Council (chaired by Rajnath Singh) approved fresh capital-acquisition proposals worth ~₹52,000 crore on 3 July, with a further ~₹79,000 crore of clearances referenced by brokerages — spanning air-defence layering, unmanned/ISR, missiles, electronics and shipbuilding under 'Buy and Make'. Motilal Oswal notes FY26 YTD defence capital approvals now total ~₹3.3 lakh crore, nearly double the ~₹1.8 lakh crore annual outlay. The Nifty India Defence index rose, with BDL, BEML, Cochin Shipyard and Paras up >2%. Brokers reiterated Buy on BEL, HAL, BDL (targets ₹500 / ₹5,800 / ₹2,000) and named Astra Microwave and Solar among preferred picks. Focus shifts to AoN-to-contract conversion and execution.",
     tickers:["BEL","HAL","BDL","BEML","COCHINSHIP","PARAS"]},
    {id:106,impact:"BULLISH",score:8,region:"India",color:A.green,date:"17 Jun 2026",hot:true,
     title:"Record FY26 Defence Production ₹1.78 Lakh Cr — Sector Hits Fresh Highs",
     detail:"India's domestic defence production hit a record ₹1.78 lakh crore in FY26, lifting the Nifty India Defence index ~3% to a fresh high near 9,400 on 17 June (17 of 19 constituents higher): Paras Defence +14%, MTAR +7.6%, Astra Microwave +5.2%, Data Patterns +4.9%, BDL +4.5%. Falling crude (Brent below $80 on the US–Iran peace progress) and the Nifty crossing 24,000 amplified the move. Record production alongside record order books reinforces the structural growth runway.",
     tickers:["PARAS","MTAR","ASTRAMICRO","DATAPATTNS","BDL","HAL"]},
    {id:104,impact:"BULLISH",score:9,region:"India",color:A.blue,date:"9 Jun 2026",hot:true,
     title:"P-75I Stealth Submarine Programme Cleared — ~₹70,000 Cr Navy Order Next",
     detail:"The Ministry of Finance has approved the P-75I stealth submarine programme, leaving only CCS sign-off before official contracting of the long-awaited ~₹70,000 Cr Navy order. Mazagon Dock — which has just delivered the 6th and final P-17A stealth frigate — is the front-runner, which would add multi-decade visibility on top of its Scorpène (P-75) line. The single largest pending naval contract in India.",
     tickers:["MAZDOCK","GRSE","BEL"]},
    {id:105,impact:"BULLISH",score:8,region:"India",color:A.green,date:"8 Jun 2026",hot:false,
     title:"Order Momentum Accelerates — BEL ₹2,100 Cr, GRSE NG-OPV, US FMS $428M",
     detail:"Order awarding is picking up across segments: BEL booked a cumulative ₹2,100 Cr in fresh orders, GRSE launched the first of 11 next-gen offshore patrol vessels, Zen Technologies emerged as lowest bidder on AVNL's remote-controlled weapon stations, and the US State Department cleared $428M in foreign military sales to India. With FY26 DAC approvals at an all-time high, ICICI Securities expects FY27 order build-up to outpace FY26 and names HAL, Solar Industries, Astra Microwave and BEL as top picks.",
     tickers:["BEL","HAL","GRSE","ZENTEC","SOLARINDS","ASTRAMICRO"]},
    {id:101,impact:"BULLISH",score:9,region:"Indo-Pacific",color:A.green,date:"30 May 2026",hot:true,
     title:"India–Vietnam BrahMos Deal Signed — ₹60,000 Cr Export at Shangri-La",
     detail:"At the Shangri-La Dialogue in Singapore on 30 May 2026, Defence Secretary Rajesh Kumar Singh confirmed India has signed a BrahMos supersonic cruise missile export deal with Vietnam — ~₹60,000 Cr (~$629M) for the Block-3 variant (290–300 km), with training and logistics. An Indonesia pact is in its final stages. Vietnam is the second foreign BrahMos buyer after the Philippines (2022). Direct positive for BDL (warhead/propulsion), HAL and BEL; India's defence exports have crossed ₹21,000+ Cr toward the ₹50,000 Cr FY29 target.",
     tickers:["BDL","HAL","BEL"]},
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     title:"FY26 Results: HAL Order Book Record ₹2.54L Cr; BEL Tops ₹27,000 Cr Revenue",
     detail:"The FY26 earnings season confirmed the structural story. HAL posted a record order book of ₹2.54 lakh crore (up from ₹1.89L Cr) with ₹9,115 Cr standalone net profit (+9.1%) and guided FY27 to 10–12% revenue growth at 30–31% EBITDA margins. BEL delivered FY26 revenue of ₹27,480 Cr (+16.2%) and PAT of ₹6,048 Cr (+14.4%) on a ₹73,882 Cr order book with ~29% ROE. Execution — not order intake — is now the key variable.",
     tickers:["HAL","BEL"]},
    {id:103,impact:"DE-ESCALATION?",score:7,region:"Middle East",color:A.orange,date:"25 Sep 2026",hot:true,
     title:"Peace Talks in New York Explore a Phased Hormuz Reopening; Brent Eases to ~$106",
     detail:"For the first time in the arc, a genuine diplomatic off-ramp is in view even as fighting continues. US and Iranian negotiators are holding talks in New York, reportedly exploring a phased deal to reopen the Strait of Hormuz, which moderated an oil rally that touched ~$108 intraday on 24 Sep. Brent eased 0.9% to ~$105.70 on 25 Sep, ending above $100 for a 2nd straight week but well off the ~$110 peak of the prior week. Tangibly, tanker traffic is resuming: four large VLCCs (~2M barrels each of Saudi crude) exited the strait Thursday. But the path is bumpy: on 24 Sep oil climbed after an Iranian military adviser threatened to widen the war to the Indian Ocean and Saudi intercepted fresh Houthi missiles; BofA warned (22 Sep) Brent could top $150 if disruptions persist (~350M barrels drained from global inventories since March). Follows the mid-month spike (crossed $100 on 9 Sep, peaked ~$108-110 around 15-16 Sep, Fed hiked to 3.75-4% on 16 Sep). A credible de-escalation would drain the war premium but leave the structural domestic thesis intact; lower oil = macro positive for India (rupee ~88/$).",
     tickers:["BDL","ZENTEC","MAZDOCK","COCHINSHIP","SOLARINDS"]},
    {id:1,impact:"BULLISH",score:10,region:"Europe",color:A.green,date:"21 Apr 2026",hot:true,
     title:"Rajnath Singh in Germany — €5B Submarine Deal on Table with TKMS–MDL",
     detail:"Defence Minister Rajnath Singh began a three-day Germany visit on 21 Apr 2026. ThyssenKrupp Marine Systems (TKMS) and Mazagon Dock Shipbuilders (MDL) are finalising a €5 billion inter-governmental deal for 6 stealth submarines under Project P-75I. A Defence Industrial Cooperation Roadmap and Eurodrone MALE UAV collaboration are also expected. This is the first Indian Defence Minister visit to Germany in 7 years.",
     tickers:["MAZDOCK","BEL","BDL"]},
    {id:2,impact:"BULLISH",score:9,region:"India",color:A.green,date:"21 Apr 2026",hot:true,
     title:"Defence Stocks Rally Up to 14% — Zen Tech Leads on Germany Visit Optimism",
     detail:"Defence stocks rallied sharply on 21 Apr 2026 — Zen Technologies surged 14.84%, Apollo Micro +21.80%, Axiscades +11.96%, Cyient DLM +9.92%. The Nifty India Defence index climbed 1.3% as investor sentiment turned upbeat on expectations of fresh deals during Rajnath Singh's Germany visit. Mazagon Dock +4.65%, GRSE +5.52%, Cochin Shipyard +5.25% — shipbuilders rallied on the €5B TKMS submarine deal prospect.",
     tickers:["ZENTEC","APOLLOMICRO","AXISCADES","CYIENTDLM","MAZDOCK"]},
    {id:3,impact:"BULLISH",score:9,region:"India",color:A.green,date:"Apr 2026",hot:true,
     title:"DAC Approves ₹2.38L Cr Defence Deals — BEL, HAL, BDL Primary Beneficiaries",
     detail:"India's Defence Acquisition Council approved ₹2.38 lakh crore in new deals in April 2026, set to fuel multi-year growth for BEL, HAL, BDL. Key programmes: QRSAM (BEL-led), Akash missile variants, Su-30 service life extension (HAL), medium transport aircraft orders, surface-to-air missiles (BDL). Brokers stayed constructive into FY26 results — CLSA Outperform on HAL; consensus targets now HAL ~₹5,300, BEL ~₹480, BDL ~₹1,400.",
     tickers:["BEL","HAL","BDL"]},
    {id:4,impact:"LT BULL",score:9,region:"India",color:A.teal,date:"Apr 2026",hot:true,
     title:"HAL–Russia Su-57 Licence Production Talks Advance — Technical Assessments Underway",
     detail:"HAL Chairman Dr DK Sunil confirmed Su-57 Felon licence production talks with Russia have advanced to on-ground inspections and technical assessments. This positions India to become the first foreign operator of a 5th-gen stealth fighter programme. Simultaneously, Moscow greenlit sale of R-37M ultra-long-range air-to-air missiles (~400 km range) to India — game-changer for IAF Su-30MKI fleet.",
     tickers:["HAL"]},
    {id:5,impact:"BULLISH",score:8,region:"India",color:A.green,date:"Apr 2026",hot:true,
     title:"HAL Nashik: 3rd Tejas Mk1A Assembly Line Operational — Output Scaling to 24/year",
     detail:"HAL launched its third assembly line for Tejas Mk1A at the Nashik facility. This major capacity expansion scales total production to 24 jets annually, addressing long-standing delivery delay concerns. IAF has also signalled intent for 100+ HLFT-42 supersonic trainers. Combined with Rafale DRAL JV assembly and AMCA programme, India's aerospace manufacturing ecosystem is in unprecedented expansion.",
     tickers:["HAL","BEL","DATAPATTNS"]},
    {id:6,impact:"ACTIVE WAR",score:9,region:"Middle East",color:A.red,date:"28 Feb – 21 Apr 2026",hot:true,
     title:"Operation Epic Fury — US-Iran Ceasefire Deadline Looms, Hormuz Incident",
     detail:"US-Israel Operation Epic Fury (started 28 Feb 2026) continues with ceasefire talks ongoing. Iran rejected 2nd round of peace talks; Trump indicates no deadline extension. IRGC fired on 14 India-bound crude/gas tankers transiting Strait of Hormuz — 13 vessels returned to Persian Gulf ports. Brent crude at ~$94.5/bbl after easing from March highs. Defence procurement urgency remains elevated globally.",
     tickers:["BDL","ZENTEC","HAL","BEL","PARAS"]},
    {id:7,impact:"BULLISH",score:9,region:"India",color:A.green,date:"Apr 2026",hot:false,
     title:"Indian Navy Drone Killer Missile — IR-Guided 7km Range, Industry RFP Out",
     detail:"Indian Army published detailed specifications for a fire-and-forget, IR-guided anti-drone missile with 7km minimum range and 90%+ single-shot kill probability. BDL, BEL, Solar Industries, and Zen Technologies are primary contenders. DRDO also readying 100kW DURGA-II high-power laser weapon for ship-borne trials on stealth destroyers — India's first directed energy weapon.",
     tickers:["BDL","BEL","SOLARINDS","ZENTEC"]},
    {id:8,impact:"BULLISH",score:8,region:"India",color:A.green,date:"10 Mar 2026",hot:false,
     title:"Indonesia BrahMos $375M Deal — Philippines, Vietnam Next in Pipeline",
     detail:"The Philippines was India's first BrahMos buyer ($375M, 2022). The signed ~₹60,000 Cr Vietnam deal (May 2026) is the breakthrough export, with Indonesia in final stages and other ASEAN/Gulf nations in discussions. India's ₹50,000 Cr FY29 export target looks increasingly achievable. BDL (warhead/propulsion), HAL and BEL (guidance) are direct beneficiaries.",
     tickers:["BDL","HAL","BEL"]},
    {id:9,impact:"BULLISH",score:10,region:"India",color:A.green,date:"1 Feb 2026",hot:false,
     title:"India FY27 Defence Budget ₹7.85L Cr (+15.2%) — Largest Ever",
     detail:"Record defence allocation with 20.1% capex surge to ₹2.31L Cr. Funds Rafale-M, Predator UAVs, P-75I submarines, AMCA, and modernisation across all three services. Government signalling long-term intent to raise spending to 2.5% of GDP — NATO-equivalent levels. FY27 capital outlay expected at ₹2.2L Cr.",
     tickers:["HAL","BEL","MAZDOCK","BDL","GRSE"]},
    {id:10,impact:"LT BULL",score:8,region:"India",color:A.teal,date:"Feb–Apr 2026",hot:false,
     title:"AMCA Stealth Fighter — Private Sector Lead, ₹1.5L Cr / 30-Year Programme",
     detail:"India's Advanced Medium Combat Aircraft (AMCA) 5th-gen fighter programme will be executed primarily by private industry (Tata Advanced Systems, L&T, Bharat Forge shortlisted). BEL-L&T among avionics finalists. ADA projects AMCA as world's most cost-effective 5th-gen programme at just $1.8B R&D budget. Production partners compete alongside Tejas Mk2 (HAL) and Rafale DRAL JV.",
     tickers:["BEL","HAL","BHARATFORG","DATAPATTNS"]},
    {id:11,impact:"YEAR 4",score:7,region:"Eastern Europe",color:A.blue,date:"24 Feb 2026",hot:false,
     title:"Russia-Ukraine War Year 4 — NATO €400B Rearmament Accelerating",
     detail:"Russia-Ukraine conflict entered Year 4. NATO committed €400B in new defence orders. Europe's rearmament is the fastest since the Cold War. India's defence exports are entering NATO supply chains — 155mm shells (Solar Industries, Sunita Tools), BrahMos components, and dual-use parts in active procurement. Trump's $1.5T defence budget (+40% YoY) — largest US military expansion since WWII.",
     tickers:["SECTOR","SOLARINDS","BDL","HAL"]},
  ];
        ...
        {stocks.map(s=>(
          <div key={s.ticker} style={{background:A.card,borderRadius:14,border:`1px solid ${A.sepLight}`,padding:16}}>
            ...
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:10}}>
              {[["P/E",s.pe==null?"NM":s.pe+"x"],["Cap","₹"+s.mc+"Cr"],["Ret",pct(s.ret)]].map(([l,v])=>(
                <div key={l}>
