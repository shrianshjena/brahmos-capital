...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4900.0, day:-0.12,pe:35.2,pb:8.0, roe:24.0,mc:3277,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:413.25, day:1.04,pe:49.3,pb:12.6, roe:27.6,mc:3021,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2610.0, day:2.76,pe:39.0,pb:10.8, roe:28.8,mc:1053,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1518.5, day:0.3,pe:58.7,pb:6.8, roe:12.5,mc:399,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2607.5, day:0.44,pe:37.3,pb:11.4, roe:31.8,mc:299,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1359.9, day:-0.59,pe:95.6,pb:11.7, roe:9.9,mc:498,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4542.3, day:-4.09,pe:94.9,pb:14.6, roe:16.7,mc:254,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1445.2, day:-4.92,pe:125.1,pb:16.0, roe:13.1,mc:116,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1877.7, day:-1.35,pe:92.8,pb:9.4, roe:11.8,mc:169,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:19800.0, day:-0.63,pe:90.3,pb:28.5, roe:31.3,mc:1792,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:6928.5, day:1.71,pe:158.9,pb:25.9, roe:12.6,mc:213,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2052.5, day:0.56,pe:139.6,pb:10.2, roe:11.6,mc:981,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1708.0, day:2.59,pe:86.3,pb:12.3, roe:16.5,mc:162,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1923.0, day:0.42,pe:88.7,pb:5.5, roe:5.1,mc:160,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:389.65, day:1.17,pe:117.7,pb:10.2, roe:11.2,mc:145,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:414.4, day:-0.88,pe:57.6,pb:5.1, roe:8.9,mc:78,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:788.8, day:-0.96,pe:896.4,pb:5.8, roe:-2.8,mc:39,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:665.55, day:-0.27,pe:106.1,pb:12.4, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1473.5, day:-1.73,pe:105.1,pb:10.2, roe:9.0,mc:75,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:21116.0, day:-2.57,pe:249.8,pb:21.0, roe:7.2,mc:317,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:173.76, day:-1.12,pe:null,pb:1.2, roe:-0.5,mc:19,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:11514.0, day:-1.13,pe:184.0,pb:9.9, roe:4.3,mc:78,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:157.78, day:-0.55,pe:366.9,pb:12.4, roe:5.2,mc:42,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1604.1, day:3.03,pe:105.7,pb:9.4, roe:10.4,mc:68,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:769.35, day:4.55,pe:75.6,pb:6.0, roe:7.5,mc:61,  ob:1, seed:2016,sector:"Electronics"},
...
const CONSENSUS_STATIC={
  ...
  IDEAFORGE:  {buy:9, hold:6, sell:4, target:1080,  brokers:["Motilal","Emkay","YES Sec","Nirmal Bang","BOB Cap"]},
  ...
  CYIENTDLM:  {buy:9, hold:6, sell:3, target:745,  brokers:["Motilal","HDFC Sec","Kotak","Emkay","Nuvama"]},
};
...
Macro context (as of 25 Aug 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — RHETORIC RE-HARDENS, Brent ~$94 (as of 25 Aug): Friday's conciliatory signal from Iran's president proved short-lived, with both sides hardening again over the weekend; Iran's newly appointed top security chief Mohsen Rezaei threatened to halt ALL oil movement through the Strait of Hormuz if neighbours help the US weaken Tehran's economy, insisting the strait stays closed until Washington meets its commitments; Iran published formal enforcement protocols (vessels violating its Hormuz rules face fines, detention or confiscation); Treasury Secretary Bessent promised an 'economic D-Day' with a fresh wave of sanctions expected as peace talks remain at a stalemate; Brent held ~$94 (dipping marginally to ~$93.77 Sunday), near two-month highs; structurally, ship-tracking suggests more crude now leaves the Gulf via a southern Oman-coast route, gradually eroding Iran's leverage, even as ~8-9M bpd still transit vs ~20M before the war; the renewed escalation keeps the war premium firmly in place; the sector's durable domestic drivers (Budget-capex expectations, the order pipeline, indigenisation policy) remain in control; Brent ~$94 stays a headwind for India's import bill/rupee; on the sector, HAL's Tejas Mk-1A execution is constrained by GE F404 engine deliveries (~6 of 99 engines arrived since 2021, though ~30 airframes are built/flown/tested and awaiting engines) and HAL fell to ~₹4,906 on 24 Aug, ~4.7% below its 17 Aug all-time high of ₹5,149.90; BEL awaits a ₹30,000 Cr QRSAM order to be signed; the MoD notified its sixth Positive Indigenisation List (18 Aug) via SRIJAN (33,000+ items offered, ~₹9,000 Cr import substitution) reinforcing the Atmanirbhar theme; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"📊",color:A.blue,   title:"The Sector's Core Tension: HAL's Tejas Execution Meets an Engine Bottleneck",stat:"Execution watch · 24 Aug 2026",body:"HAL's pullback from its all-time high crystallises the question hanging over the whole sector: not whether the orders exist, but how fast they convert to revenue. HAL closed at about ₹4,906 on 24 August, down 1.9% and the worst of the large defence names, roughly 4.7% below the ₹5,149.90 record it touched on 17 August. The proximate cause is the Tejas Mk-1A: around 30 airframes have been built, flown and tested but cannot be handed to the Air Force because only about 6 of 99 GE F404 engines have arrived since 2021. HAL, in short, has more signed work than it can currently execute, the mirror image of BEL, which is still waiting for a roughly ₹30,000 crore QRSAM order to be signed. The episode is a useful reminder that in this sector order-book conversion, not just backlog size, is the variable that matters: in the June quarter Mazagon Dock converted about 16.2% of its order book into revenue while Bharat Dynamics converted only 2.2%. It also underlines a valuation nuance the market often misses, that the three most profitable names (Mazagon at roughly 29% ROE, BEL at 27%, HAL at 24%) are also among the cheapest on earnings. None of this dents the multi-year structural thesis (record FY27 defence budget of ₹6.81 lakh crore, deep indigenisation, a full order pipeline), but it does argue for watching execution and engine-supply resolution as the near-term swing factors."},
    ...
    {icon:"🕊️",color:A.teal, title:"Rhetoric Re-Hardens: Iran Threatens Full Hormuz Halt as US Readies 'Economic D-Day'",stat:"Re-escalation · 25 Aug 2026",body:"Friday's conciliatory signal from Iran's president proved short-lived, with both sides hardening again over the weekend and into this week. Iran's newly appointed top security chief, Mohsen Rezaei, threatened to halt all oil movement through the Strait of Hormuz if neighbouring countries help the US weaken Tehran's economy, insisting the strait will stay closed until Washington meets its commitments and that Iran 'will not yield to US pressure.' Iran also published formal enforcement protocols, warning that vessels violating its Hormuz rules would face fines, detention or confiscation. On the US side, Treasury Secretary Scott Bessent promised an 'economic D-Day,' with a fresh wave of sanctions expected as peace talks remain at a stalemate. Brent crude has held around $94 (dipping marginally to about $93.77 on Sunday), still near two-month highs. One structurally important shift: ship-tracking data suggests more crude is now leaving the Gulf via a southern route close to Oman's coast, gradually eroding the leverage Iran has exercised over the waterway, even as roughly 8-9 million barrels a day continue to transit versus about 20 million before the war. For Indian defence, the renewed escalation keeps the war premium firmly in place; the sector's durable domestic drivers (Budget-capex expectations, the order pipeline, indigenisation policy) remain in control. Brent near $94, up sharply year-on-year, stays a meaningful headwind for India's import bill, rupee and inflation, and the swing between escalation and de-escalation remains the key macro variable to watch."},
    ...
    {icon:"🎯",color:A.orange,  title:"Nifty India Defence Index — Consolidating After Its Mid-June High, Still Outperforming",stat:"mid-2026 · Rotation to Defence",body:"The Nifty India Defence index peaked near 9,400 in mid-June, then consolidated as the US–Iran war premium faded, while continuing to outperform the Nifty 50 YTD; BEL (~26%) and HAL (~24%) are the largest weights. Index P/E sits near ~52–54x — rich, but backed by record order books and the 3 July DAC clearances. Global defence rotation remains a tailwind: sustained NATO and European rearmament alongside Indian FY27 capex of ~₹2.2L Cr is a rare simultaneous demand surge."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ACTIVE WAR",score:8,region:"Middle East",color:A.red,date:"25 Aug 2026",hot:true,
     title:"Rhetoric Re-Hardens: Iran Threatens Full Hormuz Halt as US Readies 'Economic D-Day'",
     detail:"Friday's conciliatory signal from Iran's president proved short-lived, with both sides hardening again over the weekend and into this week. Iran's newly appointed top security chief Mohsen Rezaei threatened to halt ALL oil movement through the Strait of Hormuz if neighbouring countries help the US weaken Tehran's economy, insisting the strait stays closed until Washington meets its commitments and that Iran 'will not yield to US pressure.' Iran published formal enforcement protocols (vessels violating its Hormuz rules face fines, detention or confiscation). On the US side, Treasury Sec Bessent promised an 'economic D-Day' with a fresh wave of sanctions expected as peace talks remain at a stalemate. Brent held ~$94 (dipping marginally to ~$93.77 Sunday), near two-month highs. Structurally important: ship-tracking suggests more crude now leaves the Gulf via a southern Oman-coast route, gradually eroding Iran's leverage, even as ~8-9M bpd still transit vs ~20M before the war. The renewed escalation keeps the war premium firmly in place; the sector's durable domestic drivers (Budget capex, order pipeline, indigenisation) remain in control. Brent ~$94 stays a headwind for India's import bill/rupee.",
     tickers:["BDL","ZENTEC","MAZDOCK","COCHINSHIP"]},
