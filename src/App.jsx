...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4500.2, day:-0.33,pe:32.4,pb:7.2, roe:24.0,mc:2950,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:420.0, day:-2.67,pe:51.8,pb:13.1, roe:27.6,mc:3133,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2506.7, day:-1.38,pe:39.5,pb:10.5, roe:28.8,mc:1022,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1483.6, day:0.49,pe:54.0,pb:6.6, roe:12.5,mc:387,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2802.2, day:-2.04,pe:46.9,pb:12.3, roe:31.8,mc:324,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1390.6, day:-1.14,pe:114.1,pb:11.3, roe:9.9,mc:481,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4831.0, day:-0.72,pe:99.3,pb:15.5, roe:16.7,mc:269,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1310.3, day:1.92,pe:120.3,pb:14.5, roe:13.1,mc:106,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1962.1, day:-1.75,pe:89.7,pb:9.7, roe:11.8,mc:174,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18227.0, day:-1.16,pe:96.1,pb:25.6, roe:31.3,mc:1607,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:8374.5, day:0.83,pe:269.7,pb:31.0, roe:12.6,mc:255,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2152.3, day:2.31,pe:89.6,pb:10.1, roe:11.6,mc:966,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1688.7, day:0.79,pe:82.3,pb:12.1, roe:16.5,mc:159,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1740.6, day:-1.26,pe:104.7,pb:5.3, roe:5.1,mc:148,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:406.95, day:-4.19,pe:135.9,pb:11.2, roe:11.2,mc:154,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:438.15, day:-0.81,pe:61.3,pb:5.6, roe:8.9,mc:81,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:860.45, day:-3.43,pe:null,pb:6.7, roe:-2.8,mc:40,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:758.75, day:-2.13,pe:87.4,pb:13.8, roe:16.5,mc:40,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1138.1, day:-4.19,pe:91.4,pb:8.2, roe:9.0,mc:58,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:17538.0, day:-2.09,pe:259.4,pb:18.4, roe:7.2,mc:261,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:202.71, day:-1.37,pe:null,pb:1.3, roe:-0.5,mc:22,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10621.0, day:-3.34,pe:226.6,pb:9.3, roe:4.3,mc:74,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:171.95, day:-2.52,pe:332.9,pb:14.1, roe:5.2,mc:48,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1841.8, day:-1.93,pe:115.7,pb:11.4, roe:10.4,mc:83,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:469.7, day:-2.71,pe:50.8,pb:3.7, roe:7.5,mc:37,  ob:1, seed:2016,sector:"Electronics"},
...
const CONSENSUS_STATIC={
  ...
  BDL:        {buy:11,hold:7, sell:4, target:1400, brokers:["Nomura","Kotak","HDFC Sec","Axis","Jefferies"]},
  ...
  ASTRAMICRO: {buy:14,hold:5, sell:2, target:1760, brokers:["ICICI Sec","Motilal","Axis","BOB Cap","Prabhudas"]},
  ...
  CYIENTDLM:  {buy:9, hold:6, sell:3, target:510,  brokers:["Motilal","HDFC Sec","Kotak","Emkay","Nuvama"]},
};
...
Macro context (as of 18 Jun 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; Operation Epic Fury (US–Iran war, a 108-day conflict since 28 Feb) is ENDING — the MoU (signed by Trump, VP Vance and Iranian speaker Qalibaf) mandates the permanent termination of military operations on all fronts incl. Lebanon, lifts the US naval blockade and reopens the Strait of Hormuz toll-free, with the formal signing ceremony set for Fri 19 Jun in Geneva (VP Vance leading); implementation underway with the first India-bound LNG carrier Disha reaching Dahej on 18 Jun, Brent below $80/bbl and the rupee firmer ~95.1 (Israel has rejected the framework — the key residual risk); India's FY26 defence production hit a record ₹1.78L Cr and the Nifty India Defence index made a fresh high ~9,400 on 17 Jun, confirming structural demand is independent of the ceasefire; Ukraine war in its 4th year with on-off ceasefire talks and continued NATO/European rearmament; ICICI Securities top picks HAL, Solar Industries, Astra Microwave, BEL (Buy on PTC Industries, MIDHANI); Nifty India Defence index ~9,400 (mid-June, fresh high), outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🎯",color:A.orange,  title:"Nifty India Defence Index ~8,900 — Still Outperforming Nifty 50",stat:"mid-2026 · Rotation to Defence",body:"The Nifty India Defence index trades around 9,400 (mid-June 2026, a fresh high), continuing to outperform the Nifty 50 YTD, with BEL (~26%) and HAL (~24%) the largest weights. Index P/E sits near ~54x — rich, but backed by record order books. Global defence rotation remains a tailwind: sustained NATO and European rearmament alongside Indian FY27 capex of ~₹2.2L Cr is a rare simultaneous demand surge."},
