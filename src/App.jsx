...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4460.5, day:4.81,pe:32.8,pb:7.3, roe:24.0,mc:2983,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:419.85, day:3.02,pe:50.8,pb:12.8, roe:27.6,mc:3069,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2552.4, day:3.44,pe:39.8,pb:10.6, roe:28.8,mc:1030,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1500.2, day:4.79,pe:55.2,pb:6.7, roe:12.5,mc:395,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2818.4, day:5.83,pe:46.8,pb:12.3, roe:31.8,mc:323,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1309.8, day:5.91,pe:113.9,pb:11.3, roe:9.9,mc:480,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4769.6, day:6.53,pe:98.6,pb:15.4, roe:16.7,mc:267,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1285.65, day:18.02,pe:118.1,pb:14.3, roe:13.1,mc:104,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1887.4, day:1.76,pe:87.7,pb:9.4, roe:11.8,mc:170,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:17457.0, day:3.3,pe:94.4,pb:25.2, roe:31.3,mc:1580,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:8319.0, day:8.06,pe:270.2,pb:31.1, roe:12.6,mc:256,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2034.5, day:1.1,pe:90.3,pb:10.2, roe:11.6,mc:973,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1574.4, day:6.37,pe:77.6,pb:11.4, roe:16.5,mc:149,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1808.3, day:1.49,pe:106.8,pb:5.4, roe:5.1,mc:151,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:438.75, day:0.76,pe:139.7,pb:11.5, roe:11.2,mc:158,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:448.85, day:2.23,pe:63.8,pb:5.8, roe:8.9,mc:84,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:929.1, day:2.32,pe:null,pb:6.8, roe:-2.8,mc:40,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:765.95, day:3.82,pe:90.3,pb:14.3, roe:16.5,mc:41,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1160.35, day:1.97,pe:93.6,pb:8.4, roe:9.0,mc:59,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:17771.0, day:-0.21,pe:264.6,pb:18.8, roe:7.2,mc:266,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:193.81, day:2.96,pe:null,pb:1.3, roe:-0.5,mc:22,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10717.0, day:2.62,pe:223.1,pb:9.2, roe:4.3,mc:73,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:174.81, day:3.18,pe:323.7,pb:13.7, roe:5.2,mc:46,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1916.5, day:5.0,pe:114.1,pb:11.2, roe:10.4,mc:82,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:464.9, day:-0.81,pe:50.4,pb:3.6, roe:7.5,mc:37,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 17 Jun 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; Operation Epic Fury (US–Iran war, since 28 Feb) is ENDING — a framework peace deal was REACHED on 14-15 Jun: both sides declared permanent termination of military operations on all fronts incl. Lebanon, Trump authorized the toll-free reopening of the Strait of Hormuz and removal of the US naval blockade, with formal signing set for Fri 19 Jun in Switzerland (lifts US oil sanctions, prewar shipping within ~30 days); Brent has fallen below $80/bbl from the ~$95 closure peak; India's FY26 defence production hit a record ₹1.78L Cr and the Nifty India Defence index rose to a fresh high ~9,400 on 17 Jun, confirming structural demand is independent of the ceasefire; Ukraine war in its 4th year with on-off ceasefire talks and continued NATO/European rearmament; ICICI Securities top picks HAL, Solar Industries, Astra Microwave, BEL (Buy on PTC Industries, MIDHANI); Nifty India Defence index ~9,400 (mid-June, fresh high), outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"US–Iran Peace Deal REACHED — War Ends, Hormuz Reopening Authorized",stat:"Signing 19 Jun · Switzerland",body:"The US–Iran war (Operation Epic Fury, since 28 Feb) is ending. A framework deal has been REACHED: both sides declared the immediate and permanent termination of military operations on all fronts — including Lebanon — and Trump authorized the toll-free reopening of the Strait of Hormuz and removal of the US naval blockade ('let the oil flow'). The formal signing is set for Friday 19 June in Switzerland; the MoU lifts US oil sanctions and restores prewar shipping within ~30 days (mine clearance first). Brent crude has fallen below $80/bbl from the ~$95 closure peak (Indian markets cheered, Nifty crossing 24,000), and the G7 welcomed the deal. Notably, Indian defence stocks still rose on 15 June — confirming that India's structural demand (record order books, ₹7.85L Cr FY27 budget, exports, P-75I/BrahMos pipelines) is independent of the ceasefire. Residual risk: implementation timelines and the durability of the Lebanon truce."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"EASING",score:9,region:"Middle East",color:A.teal,date:"15 Jun 2026",hot:true,
     title:"US–Iran Peace Deal REACHED — War Ends, Hormuz Reopening Authorized",
     detail:"The US–Iran war (since 28 Feb) is ending. A framework deal has been reached: both sides declared the immediate and permanent termination of military operations on all fronts including Lebanon, and Trump authorized the toll-free reopening of the Strait of Hormuz and removal of the US naval blockade. Formal signing is set for Friday 19 June in Switzerland; the MoU lifts US oil sanctions and restores prewar shipping within ~30 days. Brent eased into the mid-$80s from the ~$95 closure peak. Indian defence stocks still rose on 15 Jun — structural demand (order books, FY27 budget, exports) is independent of the ceasefire; implementation timelines are the residual risk.",
