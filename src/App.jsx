...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4573.4, day:-0.42,pe:33.6,pb:7.5, roe:24.0,mc:3059,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:405.0, day:-0.09,pe:48.8,pb:12.3, roe:27.6,mc:2960,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2293.8, day:-0.22,pe:35.8,pb:9.5, roe:28.8,mc:925,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1392.4, day:-0.24,pe:51.0,pb:6.2, roe:12.5,mc:366,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2565.8, day:-0.33,pe:42.7,pb:11.2, roe:31.8,mc:294,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1243.0, day:0.26,pe:108.7,pb:10.7, roe:9.9,mc:456,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4584.5, day:-0.28,pe:94.3,pb:14.8, roe:16.7,mc:257,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1195.2, day:-0.19,pe:109.9,pb:13.3, roe:13.1,mc:96,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1768.7, day:-1.78,pe:82.0,pb:8.9, roe:11.8,mc:159,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18494.0, day:-0.68,pe:100.0,pb:26.7, roe:31.3,mc:1674,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:5805.0, day:-1.19,pe:188.7,pb:21.7, roe:12.6,mc:179,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2151.6, day:-1.09,pe:95.2,pb:10.7, roe:11.6,mc:1029,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1813.4, day:1.7,pe:89.3,pb:13.1, roe:16.5,mc:172,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1713.2, day:-1.01,pe:101.0,pb:4.9, roe:5.1,mc:143,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:394.3, day:-0.3,pe:125.2,pb:10.4, roe:11.2,mc:147,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:392.7, day:-0.48,pe:55.9,pb:4.8, roe:8.9,mc:74,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:870.65, day:1.11,pe:null,pb:6.4, roe:-2.8,mc:43,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:662.1, day:-0.23,pe:77.5,pb:12.4, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1237.4, day:1.82,pe:100.0,pb:8.5, roe:9.0,mc:63,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:17732.0, day:-0.58,pe:263.2,pb:17.6, roe:7.2,mc:266,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:180.68, day:0.48,pe:null,pb:1.2, roe:-0.5,mc:20,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10458.0, day:2.72,pe:217.4,pb:8.9, roe:4.3,mc:71,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:163.49, day:-0.6,pe:380.2,pb:12.8, roe:5.2,mc:43,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1608.0, day:2.92,pe:95.3,pb:9.4, roe:10.4,mc:68,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:670.45, day:0.8,pe:65.0,pb:5.3, roe:7.5,mc:53,  ob:1, seed:2016,sector:"Electronics"},
...
const CONSENSUS_STATIC={
  ...
  AXISCADES:  {buy:10,hold:5, sell:3, target:2170, brokers:["HDFC Sec","Kotak","Emkay","YES Sec","BOB Cap"]},
  CYIENTDLM:  {buy:9, hold:6, sell:3, target:700,  brokers:["Motilal","HDFC Sec","Kotak","Emkay","Nuvama"]},
};
...
Macro context (as of 26 Jul 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) is VOLATILE as of 25 Jul — two crosscurrents: de-escalation (for the first time in two weeks the US did not announce fresh strikes on Iran, and an Omani delegation visited Tehran on Hormuz traffic) versus a widening energy shock (Yemen's Houthis effectively blockaded Bab al-Mandeb, ~5M bbl/day of Saudi oil, a second chokepoint alongside Hormuz); Brent spiked toward ~$100 then eased to ~$97 Friday, so crude near $97 is now a MATERIAL negative for India's import bill, rupee and inflation; the QRSAM award is now expected Q2 FY27; on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"📊",color:A.blue,   title:"Q1 FY27 Earnings — BEL Call 27 Jul (4 PM), FY27 Order Target ₹55,000+ Cr",stat:"Execution in focus · 27 Jul 2026",body:"BEL headlines the June-quarter results season with its board meeting and investor call on Monday 27 July (4 PM IST) — the market's read on whether the order story is converting to execution and margins (Street expects EBITDA margins above 23%). BEL enters it with an order book of ₹73,882 crore (as of 1 Apr) plus ₹1,653 crore of fresh wins across June-July, and management is guiding to a FY27 order-intake target of ₹55,000+ crore. Notably, the ₹30,000 crore QRSAM award is now expected in Q2 FY27 (slightly later than the 'within weeks' framing), which will cascade to BDL, Astra Microwave and Apollo Micro. Elsewhere, HAL's Tejas Mk-1A deliveries are targeted to begin August-September (~20 aircraft in FY27). The season, not the Gulf, is now the sector's near-term swing factor."},
    ...
    {icon:"🕊️",color:A.teal, title:"US Pauses Strikes as Oil Spikes to ~$97 — Houthis Blockade Bab al-Mandeb",stat:"Tentative de-escalation · 25 Jul 2026",body:"Two crosscurrents define the conflict now. On the de-escalation side: for the first time in two weeks the US did not announce fresh strikes on Iran (25 Jul), and an Omani delegation visited Tehran to discuss restoring Strait of Hormuz traffic — the first tangible diplomacy since the June MoU collapsed. But the energy shock has widened: Yemen's Houthis have effectively blockaded the Bab al-Mandeb strait (~5M bbl/day of Saudi oil), a second chokepoint alongside a still-disrupted Hormuz, and have attacked Saudi vessels in the Red Sea. Brent spiked toward ~$100 before easing 4% to ~$97 on Friday; US pump prices are back up (~$4.11/gal) and the US SPR is at its lowest since 1983. For Indian defence, the war premium stays elevated, but crude near $97 is now a material negative for India's import bill, rupee and inflation — the clearest macro headwind the sector has faced in this cycle. The durable driver remains the domestic order pipeline (QRSAM, DAC clearances, Q1 FY27 execution)."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"VOLATILE",score:9,region:"Middle East",color:A.orange,date:"25 Jul 2026",hot:true,
     title:"US Pauses Strikes as Oil Spikes to ~$97 — Houthis Blockade Bab al-Mandeb",
     detail:"Two crosscurrents. De-escalation: for the first time in two weeks the US did not announce fresh strikes on Iran (25 Jul), and an Omani delegation visited Tehran to discuss restoring Hormuz traffic — the first real diplomacy since the June MoU collapsed. But the energy shock widened: Yemen's Houthis have effectively blockaded Bab al-Mandeb (~5M bbl/day of Saudi oil) and attacked Saudi vessels in the Red Sea, a second chokepoint alongside a still-disrupted Hormuz. Brent spiked toward ~$100 then eased 4% to ~$97 Friday; US pump prices ~$4.11/gal, SPR at its lowest since 1983. War premium stays elevated, but crude near $97 is now a material negative for India's import bill, rupee and inflation. Durable driver: the domestic order pipeline (QRSAM, DAC, Q1 FY27 execution).",
