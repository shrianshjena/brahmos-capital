...
const CONSENSUS_STATIC={
  HAL:        {buy:21,hold:5, sell:2, target:5300, brokers:["Antique","Motilal","HDFC Sec","Nomura","CLSA"]},
  BEL:        {buy:16,hold:7, sell:3, target:480,  brokers:["InCred","Motilal","Emkay","ICICI Sec","JM Fin"]},
  ...
  BDL:        {buy:11,hold:7, sell:4, target:1490, brokers:["Nomura","Kotak","HDFC Sec","Axis","Jefferies"]},
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"US–Iran Peace Deal REACHED — War Ends, Hormuz Reopening Underway",stat:"Signing 19 Jun · Geneva",body:"The US–Iran war (Operation Epic Fury, a 108-day conflict since 28 Feb) is ending. The MoU — signed by Trump, VP Vance and Iranian speaker Qalibaf — mandates the immediate and permanent termination of military operations on all fronts including Lebanon, lifts the US naval blockade and reopens the Strait of Hormuz toll-free; the formal signing ceremony is set for Friday 19 June in Geneva, with VP Vance leading the US team. Implementation is already underway: the first India-bound LNG carrier (Disha, ~62,000 T) has transited Hormuz and reaches Dahej, Gujarat on 18 June, and Brent crude has fallen below $80/bbl from the ~$95 closure peak — easing India's import bill and lifting the rupee to ~95.1. Indian defence stocks still hit fresh highs into the deal — confirming India's structural demand (record order books, ₹7.85L Cr FY27 budget, exports, P-75I/BrahMos pipelines) is independent of the ceasefire. Key residual risk: Israel has rejected the framework (Netanyahu/Katz/Ben Gvir) and won't withdraw from Lebanon, alongside a narrow 60-day nuclear-talks window."},
    ...
    {icon:"🌊",color:A.orange, title:"Strait of Hormuz Set to Reopen Under US–Iran MoU",stat:"~20% of global oil transits here",body:"After weeks of disruption — including the 11 June total closure — the pending US–Iran MoU would reopen the Strait of Hormuz immediately and restore prewar shipping within ~30 days. Roughly 20% of global oil trade transits this chokepoint. The episode underscored India's maritime exposure: securing sea lanes and a growing blue-water navy keeps accelerated naval procurement — submarines, OPVs, frigates — a national-security imperative regardless of the ceasefire's outcome."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"EASING",score:9,region:"Middle East",color:A.teal,date:"18 Jun 2026",hot:true,
     title:"US–Iran Peace Deal REACHED — Hormuz Reopening Underway, Signing 19 Jun Geneva",
     detail:"The US–Iran war (a 108-day conflict since 28 Feb) is ending. The MoU — signed by Trump, VP Vance and Iranian speaker Qalibaf — mandates the permanent termination of military operations on all fronts including Lebanon, lifts the US naval blockade and reopens the Strait of Hormuz toll-free; the formal signing ceremony is set for Friday 19 June in Geneva (VP Vance leading the US team). Implementation is underway: the first India-bound LNG carrier, Disha (~62,000 T), has transited Hormuz and reaches Dahej, Gujarat on 18 June, and Brent has fallen below $80/bbl from the ~$95 peak — easing India's import bill and lifting the rupee to ~95.1. Key residual risk: Israel rejected the framework (Netanyahu/Katz/Ben Gvir) and won't withdraw from Lebanon.",
