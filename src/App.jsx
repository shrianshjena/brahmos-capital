...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4600.1, day:-0.41,pe:33.9,pb:7.5, roe:24.0,mc:3089,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:389.0, day:-4.46,pe:49.1,pb:12.4, roe:27.6,mc:2976,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2295.8, day:-1.48,pe:36.4,pb:9.6, roe:28.8,mc:940,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1382.6, day:-1.4,pe:51.4,pb:6.3, roe:12.5,mc:369,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2610.7, day:-1.39,pe:44.1,pb:11.5, roe:31.8,mc:303,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1271.0, day:1.16,pe:109.8,pb:10.9, roe:9.9,mc:461,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4381.7, day:-4.31,pe:94.2,pb:14.8, roe:16.7,mc:256,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1186.1, day:-2.88,pe:112.3,pb:13.6, roe:13.1,mc:98,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1640.6, day:-2.82,pe:78.2,pb:8.4, roe:11.8,mc:152,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18244.0, day:-2.06,pe:100.7,pb:26.9, roe:31.3,mc:1686,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:5467.0, day:-5.0,pe:187.0,pb:21.5, roe:12.6,mc:177,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2162.7, day:-0.85,pe:96.6,pb:10.9, roe:11.6,mc:1043,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1704.1, day:-5.42,pe:88.7,pb:13.0, roe:16.5,mc:171,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1759.2, day:-1.17,pe:105.0,pb:5.1, roe:5.1,mc:148,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:378.75, day:-3.61,pe:124.7,pb:10.3, roe:11.2,mc:146,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:391.75, day:-1.35,pe:56.5,pb:4.9, roe:8.9,mc:74,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:847.95, day:-1.43,pe:null,pb:6.3, roe:-2.8,mc:43,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:663.15, day:-0.89,pe:78.3,pb:12.5, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1180.8, day:-1.86,pe:97.3,pb:8.3, roe:9.0,mc:61,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:17874.0, day:-0.27,pe:266.0,pb:17.8, roe:7.2,mc:269,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:178.71, day:-2.33,pe:null,pb:1.2, roe:-0.5,mc:20,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10343.0, day:-1.92,pe:219.2,pb:9.0, roe:4.3,mc:72,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:159.92, day:-3.11,pe:383.8,pb:13.0, roe:5.2,mc:44,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1491.2, day:-2.75,pe:90.8,pb:9.0, roe:10.4,mc:65,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:681.95, day:2.54,pe:64.4,pb:5.2, roe:7.5,mc:53,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 27 Jul 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) is DE-ESCALATING as of 27 Jul — the US and Iran halted strikes over the weekend (US paused late Friday without formal announcement; Tehran stopped retaliating; Trump reportedly open to renewed talks), and Iran engaged Oman on restoring Hormuz traffic; Brent eased from ~$100 toward ~$90 Monday as the truce held (still up ~40% off early-July lows), so crude near $90 is a mild negative for India's import bill; Houthis keep hitting Saudi Aramco Red Sea facilities (Jizan/Yanbu); BEL reported Q1 FY27 on 27 Jul — net profit ₹1,054 Cr (+8.7% YoY), revenue +25% YoY, FY27 margin guide 27%+; Zen fell ~9% on an earnings miss; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"US–Iran Halt Strikes, Diplomacy Revives — Brent Eases to ~$90",stat:"De-escalating · 27 Jul 2026",body:"The conflict is de-escalating for the first time since the June MoU collapsed. The US and Iran halted strikes against each other over the weekend — the US paused its attacks late Friday without a formal announcement, Tehran said it stopped retaliatory strikes, and Trump is reportedly open to renewed peace talks; Iran has engaged Oman on restoring Strait of Hormuz traffic. Brent crude, which had spiked toward ~$100 last week, declined back toward ~$90 on Monday as the truce took hold — still elevated, having run up nearly 40% from its early-July lows. Two risks keep a floor under prices: Yemen's Houthis continue attacking Saudi Aramco's Red Sea facilities (Jizan and Yanbu), and the Caspian Pipeline Consortium suspended Black Sea loadings after tanker attacks, disrupting ~80% of Kazakhstan's exports. For Indian defence, easing tensions may cool the near-term war premium, but crude near $90 remains a mild negative for India's import bill — and the sector's durable driver is now firmly the domestic order pipeline and the Q1 FY27 earnings underway."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"DE-ESCALATING",score:8,region:"Middle East",color:A.teal,date:"27 Jul 2026",hot:true,
     title:"US–Iran Halt Strikes, Diplomacy Revives — Brent Eases to ~$90",
     detail:"The conflict is de-escalating for the first time since the June MoU collapsed. The US and Iran halted strikes over the weekend — the US paused attacks late Friday without a formal announcement, Tehran said it stopped retaliatory strikes, and Trump is reportedly open to renewed talks; Iran has engaged Oman on restoring Hormuz traffic. Brent, which spiked toward ~$100 last week, eased back toward ~$90 Monday as the truce took hold (still up ~40% from early-July lows). Floors under prices: Houthis keep attacking Saudi Aramco's Red Sea facilities (Jizan, Yanbu), and the Caspian Pipeline Consortium suspended Black Sea loadings (~80% of Kazakhstan's exports). Easing tensions may cool the near-term war premium; crude near $90 stays a mild negative for India's import bill. The durable driver is now the domestic order pipeline and Q1 FY27 execution.",
