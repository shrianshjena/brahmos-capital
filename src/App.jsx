...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4780.0, day:-0.57,pe:34.4,pb:7.8, roe:24.0,mc:3211,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:405.75, day:-1.33,pe:49.3,pb:12.6, roe:27.6,mc:3030,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2459.0, day:-1.05,pe:37.3,pb:10.3, roe:28.8,mc:1000,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1463.0, day:-0.87,pe:58.5,pb:6.8, roe:12.5,mc:397,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2495.1, day:-1.39,pe:36.8,pb:11.2, roe:31.8,mc:294,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1253.7, day:0.3,pe:89.5,pb:11.0, roe:9.9,mc:467,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4516.7, day:0.03,pe:94.9,pb:14.6, roe:16.7,mc:253,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1413.1, day:2.39,pe:122.9,pb:15.9, roe:13.1,mc:115,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1829.1, day:2.72,pe:88.9,pb:8.9, roe:11.8,mc:160,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:20600.0, day:2.69,pe:91.3,pb:29.0, roe:31.3,mc:1820,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:6872.0, day:-1.07,pe:162.4,pb:26.3, roe:12.6,mc:217,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2031.8, day:-0.99,pe:142.6,pb:10.5, roe:11.6,mc:1006,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1641.8, day:-2.64,pe:84.1,pb:12.0, roe:16.5,mc:158,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:2032.4, day:3.16,pe:90.3,pb:5.5, roe:5.1,mc:161,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:382.65, day:0.83,pe:115.9,pb:10.1, roe:11.2,mc:143,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:414.4, day:-0.73,pe:57.3,pb:5.1, roe:8.9,mc:78,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:769.75, day:-1.77,pe:893.5,pb:5.8, roe:-2.8,mc:40,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:668.8, day:0.73,pe:106.4,pb:12.4, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1451.9, day:-1.57,pe:105.4,pb:10.3, roe:9.0,mc:76,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:22715.0, day:-0.18,pe:263.2,pb:22.0, roe:7.2,mc:332,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:171.23, day:-1.31,pe:null,pb:1.2, roe:-0.5,mc:19,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:11425.0, day:-2.17,pe:190.2,pb:10.2, roe:4.3,mc:81,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:156.81, day:0.09,pe:381.3,pb:12.6, roe:5.2,mc:43,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1689.7, day:2.77,pe:112.7,pb:9.8, roe:10.4,mc:71,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:854.75, day:-0.29,pe:81.7,pb:6.6, roe:7.5,mc:67,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 31 Aug 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — US STRIKES MINE-LAYING UNITS, Brent ~$91 (as of 31 Aug): the conflict swung back to direct military action Monday even as a diplomatic track quietly reopened; US forces struck Iranian rocket launchers preparing to deploy mines into the Strait of Hormuz — the first US military action in the waterway in over a month (some reports also cite US strikes on Iran's Larak Island and Iranian retaliatory missile launches); Brent jumped ~2.9% to $90.69, though it sits below last week's ~$94 and is set for a modest monthly loss (up ~8% on the month, ~33% YoY); underneath the flare-up is a genuine diplomatic thread — Iran and Oman outlined a proposal for a temporary Hormuz shipping corridor (which sent oil lower for three straight sessions), Qatar's PM visited Tehran, and an Iranian official said Friday that resuming diplomacy 'isn't impossible' after constructive talks with Qatar; the US keeps squeezing Iran's economy via sanctions to force it back to the table; ~6-8M bpd still move through the strait vs ~20M before the war; the persistent conflict keeps a war premium in sentiment, but the sector's durable domestic drivers (Budget-capex expectations, the order pipeline, indigenisation policy) remain in control; Brent ~$91 stays a headwind for India's import bill/rupee; on the sector, HAL's Tejas Mk-1A execution remains constrained by GE F404 engine deliveries (~6 of 99 engines arrived since 2021, ~30 airframes built/flown/tested) but deliveries are targeted to begin Aug-Sep 2026 with ~20 aircraft planned for FY27; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"US Strikes Iranian Mine-Laying Units in Hormuz; Brent Jumps to ~$91 as Diplomacy Simmers",stat:"Military flare-up · 31 Aug 2026",body:"The conflict swung back to direct military action on Monday even as a diplomatic track quietly reopened. US forces struck Iranian rocket launchers that were preparing to deploy mines into the Strait of Hormuz, the first US military action in the waterway in more than a month (some reports also cite US strikes on Iran's Larak Island and Iranian retaliatory missile launches). Brent crude jumped about 2.9% to $90.69, though it remains set for a modest monthly loss and sits below last week's ~$94, up roughly 8% on the month and about 33% year-on-year. Running underneath the flare-up is a genuine diplomatic thread: earlier in the week Iran and Oman outlined a proposal for a temporary shipping corridor through Hormuz (which sent oil lower for three straight sessions), Qatar's prime minister visited Tehran, and an Iranian official said on Friday that resuming diplomacy with Washington 'isn't impossible' after constructive talks with Qatar. The US has kept its focus on squeezing Iran's economy through sanctions to force it back to the table, while roughly 6-8 million barrels a day still move through the strait versus about 20 million before the war. For Indian defence, the persistent conflict keeps a war premium in sentiment, but the sector's durable domestic drivers (Budget-capex expectations, the order pipeline, indigenisation policy) remain in control. Brent near $91 stays a meaningful headwind for India's import bill, rupee and inflation, and the tug-of-war between fresh strikes and corridor diplomacy remains the key macro variable to watch."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ACTIVE WAR",score:8,region:"Middle East",color:A.red,date:"31 Aug 2026",hot:true,
     title:"US Strikes Iranian Mine-Laying Units in Hormuz; Brent Jumps to ~$91 as Diplomacy Simmers",
     detail:"The conflict swung back to direct military action Monday even as a diplomatic track quietly reopened. US forces struck Iranian rocket launchers preparing to deploy mines into the Strait of Hormuz, the first US military action in the waterway in over a month (some reports also cite US strikes on Iran's Larak Island and Iranian retaliatory missile launches). Brent jumped ~2.9% to $90.69, though it is set for a modest monthly loss and sits below last week's ~$94 (up ~8% on the month, ~33% YoY). Underneath the flare-up is a genuine diplomatic thread: earlier in the week Iran and Oman outlined a proposal for a temporary Hormuz shipping corridor (which sent oil lower for three straight sessions), Qatar's PM visited Tehran, and an Iranian official said Friday that resuming diplomacy 'isn't impossible' after constructive talks with Qatar. The US keeps squeezing Iran's economy via sanctions to force it back to the table; ~6-8M bpd still move through the strait vs ~20M before the war. The persistent conflict keeps a war premium in sentiment, but the sector's durable domestic drivers (Budget capex, order pipeline, indigenisation) remain in control. Brent ~$91 stays a headwind for India's import bill/rupee.",
