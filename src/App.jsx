...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4581.7, day:2.02,pe:32.2,pb:7.1, roe:24.0,mc:2928,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:410.05, day:0.47,pe:49.1,pb:12.4, roe:27.6,mc:2969,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2354.1, day:0.32,pe:37.1,pb:9.8, roe:28.8,mc:957,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1405.3, day:-0.16,pe:51.6,pb:6.3, roe:12.5,mc:370,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2619.7, day:2.26,pe:43.6,pb:11.5, roe:31.8,mc:301,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1273.2, day:1.24,pe:115.3,pb:11.5, roe:9.9,mc:486,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4243.9, day:6.34,pe:88.4,pb:13.8, roe:16.7,mc:240,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1222.6, day:1.33,pe:110.8,pb:13.5, roe:13.1,mc:98,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1818.7, day:3.94,pe:84.5,pb:9.1, roe:11.8,mc:163,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18467.0, day:0.36,pe:93.9,pb:25.1, roe:31.3,mc:1573,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:5573.5, day:-2.97,pe:225.9,pb:25.9, roe:12.6,mc:213,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2201.8, day:-0.33,pe:94.8,pb:10.6, roe:11.6,mc:1019,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1747.1, day:-0.22,pe:90.5,pb:13.2, roe:16.5,mc:174,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1786.3, day:0.89,pe:106.5,pb:5.2, roe:5.1,mc:151,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:392.8, day:-1.26,pe:126.4,pb:10.5, roe:11.2,mc:148,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:409.55, day:0.38,pe:58.3,pb:5.0, roe:8.9,mc:77,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:850.35, day:-0.81,pe:null,pb:6.3, roe:-2.8,mc:37,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:657.7, day:-0.59,pe:84.0,pb:13.3, roe:16.5,mc:38,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1276.2, day:0.13,pe:97.4,pb:8.7, roe:9.0,mc:62,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:17853.0, day:-0.98,pe:255.2,pb:17.3, roe:7.2,mc:260,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:185.7, day:0.15,pe:null,pb:1.3, roe:-0.5,mc:22,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10352.0, day:0.65,pe:228.4,pb:9.3, roe:4.3,mc:74,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:171.01, day:-0.88,pe:326.9,pb:14.1, roe:5.2,mc:48,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1575.4, day:-0.53,pe:95.0,pb:9.4, roe:10.4,mc:68,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:623.0, day:4.52,pe:58.3,pb:4.2, roe:7.5,mc:43,  ob:1, seed:2016,sector:"Electronics"},
...
const CONSENSUS_STATIC={
  HAL:        {buy:21,hold:5, sell:2, target:5800, brokers:["Antique","Motilal","HDFC Sec","Nomura","CLSA"]},
  BEL:        {buy:16,hold:7, sell:3, target:505,  brokers:["InCred","Motilal","Emkay","ICICI Sec","JM Fin"]},
  ...
  BDL:        {buy:11,hold:7, sell:4, target:2000, brokers:["Nomura","Kotak","HDFC Sec","Axis","Jefferies"]},
  ...
  ZENTEC:     {buy:13,hold:4, sell:2, target:2110, brokers:["Motilal","HDFC Sec","Emkay","Nirmal Bang","BOB Cap"]},
  ...
  UNIMECH:    {buy:11,hold:5, sell:2, target:1290, brokers:["Kotak","Motilal","Emkay","YES Sec","BOB Cap"]},
  ...
  CYIENTDLM:  {buy:9, hold:6, sell:3, target:605,  brokers:["Motilal","HDFC Sec","Kotak","Emkay","Nuvama"]},
};
...
Macro context (as of 9 Jul 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; Operation Epic Fury (US–Iran war) — the MoU (the 'Islamabad MOU', signed 18 Jun 2026 at Versailles by Trump and Iran's President Pezeshkian, Pakistan-mediated) ended the intense fighting and has held for three weeks as of early July, though fragile; it extends the ceasefire 60 days for nuclear talks, reaffirms Iran won't build a nuclear weapon, and reopens the Strait of Hormuz (jointly managed by Iran and Oman) — but reopening is only PARTIAL (traffic ~one-third of normal, steep risk premium, several tankers turned back on 8 Jul); oil tumbled below pre-war levels after signing then climbed back to Brent ~$78 as the incomplete reopening and low US stockpiles keep a floor, still net positive for India (85%+ import-dependent) via a lower import bill and firmer rupee; on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"US–Iran Peace Fraying — Iran Attacks Tanker, Trump Calls Deal 'Over'",stat:"Fragile · Brent ~$78 · 8 Jul 2026",body:"The MoU that Trump signed on 18 June (ending the 108-day Operation Epic Fury) is now looking fragile. The formal Geneva signing ceremony was postponed, and after three weeks of partial peace — the Strait of Hormuz reopened to only about a third of normal traffic — tensions have flared again. On 7 July Iran attacked the Qatari LNG tanker Al-Rekayyat near Hormuz and the US revoked Iran's oil-sale authorization; on 8 July at least four tankers turned back from the strait and President Trump publicly called the deal 'over.' Brent crude, which had fallen below pre-war levels (~$74), has bounced back to ~$78/bbl on the renewed risk — still far below the ~$120 April peak. A permanent settlement is still being negotiated, with both sides holding incentives to contain the conflict (Trump wants low oil into the November midterms; Tehran wants sanctions relief). For Indian defence, the renewed instability keeps the geopolitical premium alive, but the sector's real driver now is the domestic order pipeline — not the ceasefire."},
    ...
    {icon:"🌊",color:A.orange, title:"Strait of Hormuz Only ~1/3 Reopened — Traffic Still Fragile",stat:"~20% of global oil transits here",body:"After the 11 June total closure, the Strait of Hormuz has only partially reopened under the fragile US–Iran MoU — traffic has run at roughly a third of normal for three weeks, mine-clearance is incomplete, and freight/insurance premiums to transit remain elevated (a tanker from inside the strait to Asia costs ~2x one from outside). Renewed Iranian attacks in early July have again turned vessels back. Roughly 20% of global oil trade transits this chokepoint. The episode underscores India's maritime exposure: securing sea lanes and a growing blue-water navy keeps accelerated naval procurement — submarines, OPVs, frigates — a national-security imperative regardless of the ceasefire's outcome."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ESCALATION RISK",score:8,region:"Middle East",color:A.orange,date:"8 Jul 2026",hot:true,
     title:"US–Iran Peace Fraying — Iran Attacks Tanker, Trump Calls Deal 'Over'",
     detail:"The MoU Trump signed on 18 June (ending the 108-day Operation Epic Fury) is now fragile. The formal Geneva ceremony was postponed, and after three weeks of partial peace — Hormuz reopened to only ~1/3 of normal traffic — tensions flared again. On 7 July Iran attacked the Qatari LNG tanker Al-Rekayyat near Hormuz and the US revoked Iran's oil-sale authorization; on 8 July at least four tankers turned back and Trump publicly called the deal 'over.' Brent, which had fallen below pre-war levels (~$74), bounced to ~$78/bbl on the renewed risk — still far below the ~$120 April peak. A permanent settlement is still being negotiated. Renewed instability keeps the geopolitical premium alive, though the sector's real driver is now the domestic order pipeline (DAC ₹52,000 Cr).",
