...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4690.0, day:0.94,pe:34.4,pb:7.6, roe:24.0,mc:3137,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:392.15, day:1.11,pe:46.6,pb:11.9, roe:27.6,mc:2867,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2390.0, day:0.34,pe:36.0,pb:9.9, roe:28.8,mc:964,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1441.9, day:1.33,pe:53.1,pb:6.5, roe:12.5,mc:379,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2582.7, day:-0.71,pe:43.0,pb:11.3, roe:31.8,mc:296,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1265.0, day:0.95,pe:109.7,pb:10.9, roe:9.9,mc:464,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4428.8, day:3.45,pe:92.4,pb:14.3, roe:16.7,mc:248,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1292.3, day:2.85,pe:118.2,pb:14.3, roe:13.1,mc:104,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1656.4, day:1.98,pe:82.9,pb:8.3, roe:11.8,mc:149,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18659.0, day:1.46,pe:100.5,pb:26.9, roe:31.3,mc:1688,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:6012.0, day:4.99,pe:138.1,pb:22.5, roe:12.6,mc:185,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2211.0, day:0.51,pe:97.6,pb:11.0, roe:11.6,mc:1057,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1848.8, day:-0.69,pe:91.1,pb:13.4, roe:16.5,mc:176,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1743.7, day:-0.38,pe:102.7,pb:5.0, roe:5.1,mc:145,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:397.35, day:1.91,pe:125.7,pb:10.4, roe:11.2,mc:148,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:403.65, day:1.93,pe:57.6,pb:4.9, roe:8.9,mc:76,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:887.1, day:1.37,pe:null,pb:6.5, roe:-2.8,mc:44,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:661.8, day:-0.35,pe:77.9,pb:12.3, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1259.8, day:1.93,pe:101.9,pb:8.7, roe:9.0,mc:64,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:17981.0, day:1.38,pe:266.8,pb:17.9, roe:7.2,mc:270,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:183.55, day:1.76,pe:null,pb:1.2, roe:-0.5,mc:20,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10763.0, day:4.1,pe:226.3,pb:9.2, roe:4.3,mc:73,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:162.99, day:0.68,pe:388.1,pb:12.8, roe:5.2,mc:43,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1572.9, day:1.25,pe:93.7,pb:9.2, roe:10.4,mc:67,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:671.7, day:0.25,pe:65.1,pb:5.3, roe:7.5,mc:53,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 3 Aug 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — UNRESOLVED, war premium elevated entering August (as of 3 Aug): Brent closed July around $88 (+~24% for the month, strongest since March) after late-July diplomacy collapsed (US struck dozens of IRGC sites, no deal reached, Tehran insists on controlling the Strait of Hormuz); Houthi Red Sea attacks and Saudi strikes on Iran-backed groups keep threatening shipping; the main counterweight is OPEC+ raising output for a fifth straight month in August (~188kbpd among core members), with the pre-war surplus capping upside vs the earlier ~$120 spike, so Brent in the high-$80s is a negative for India's import bill/rupee; BEL reported Q1 FY27 (27 Jul) net profit ₹1,054 Cr (+8.7% YoY), revenue +25%, FY27 margin guide 27%+; ICICI Securities sees a muted sector Q1 with HAL/Solar the likely outperformers; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"📊",color:A.blue,   title:"Astra Microwave Wins ₹2,205 Cr HAL Order for Uttam Radar; Mazagon Q1 PAT +22%",stat:"Order + results · 31 Jul 2026",body:"Two concrete positives closed out July. Astra Microwave secured a transformational ₹2,205 crore order from HAL — 122 Airborne Active Antenna Units and 121 interface frames for India's indigenous Uttam AESA radar programme, executable over five years — one of the largest in the company's history and larger than its entire prior order book. The stock jumped ~14% to a record high, and it reports Q1 FY27 on 10 August. Separately, Mazagon Dock delivered an in-line Q1 FY27: consolidated PAT ₹550 crore (+22% YoY), revenue ₹2,943 crore (+12% YoY), with EBITDA up 48% and margin expanding to 15.2%; Antique reiterated BUY with a ₹3,275 target. Both reinforce the sector's core theme — that domestic order flow and execution, not the Gulf war premium, are the durable drivers. The Astra win also validates the private-sector radar/EW supply chain (TR modules, AAAUs) that cascades from the larger PSU programmes."},
    ...
    {icon:"🕊️",color:A.teal, title:"War Premium Persists into August — Brent Ended July +24%, OPEC+ Adds Barrels",stat:"Elevated, unresolved · 3 Aug 2026",body:"The conflict remains unresolved entering August, keeping a firm risk premium in crude. Brent closed July around $88 a barrel, a gain of roughly 24% for the month — its strongest monthly rise since March — after the late-July collapse of diplomacy: the US struck dozens of IRGC sites, no agreement was reached (Tehran still insists on controlling the Strait of Hormuz), and Iran claimed to have turned back tankers in the strait, though ship-tracking showed some very large crude carriers still transiting. Houthi Red Sea attacks and Saudi strikes on Iran-backed groups continue to threaten shipping. The main counterweight is supply: OPEC+ agreed to raise output for a fifth straight month in August (adding ~188kbpd among core members), and the pre-war surplus plus stranded-tanker releases cap the upside versus the earlier spike toward $120. For Indian defence, the sustained war premium supports sentiment, but Brent in the high-$80s remains a negative for India's import bill, rupee and inflation. As ever, the durable driver is the domestic order pipeline (QRSAM expected Q2 FY27, DAC clearances) and Q1 FY27 execution, not the Gulf headlines."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ELEVATED",score:8,region:"Middle East",color:A.orange,date:"3 Aug 2026",hot:true,
     title:"War Premium Persists into August — Brent Ended July +24%, OPEC+ Adds Barrels",
     detail:"The conflict remains unresolved entering August, keeping a firm risk premium in crude. Brent closed July around $88 (+~24% for the month, its strongest since March) after late-July diplomacy collapsed: the US struck dozens of IRGC sites, no deal was reached (Tehran insists on controlling the Strait of Hormuz), and Iran claimed to turn back tankers, though tracking showed some VLCCs still transiting. Houthi Red Sea attacks and Saudi strikes on Iran-backed groups keep threatening shipping. Counterweight: OPEC+ agreed to raise output a fifth straight month in August (~188kbpd among core members), and the pre-war surplus plus stranded-tanker releases cap the upside vs the earlier ~$120 spike. Brent in the high-$80s is a negative for India's import bill/rupee; the durable driver is the domestic order pipeline (QRSAM Q2 FY27, DAC) and Q1 FY27 execution.",
