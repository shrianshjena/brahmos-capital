...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4774.2, day:-1.28,pe:34.5,pb:7.8, roe:24.0,mc:3210,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:392.0, day:-1.02,pe:46.9,pb:12.0, roe:27.6,mc:2875,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2202.0, day:-0.43,pe:34.3,pb:9.4, roe:28.8,mc:920,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1370.0, day:0.0,pe:54.0,pb:6.3, roe:12.5,mc:368,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2344.0, day:-1.54,pe:34.5,pb:10.5, roe:31.8,mc:276,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1155.0, day:-0.52,pe:84.4,pb:10.3, roe:9.9,mc:439,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4395.5, day:-0.61,pe:94.7,pb:14.6, roe:16.7,mc:253,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1343.4, day:-2.74,pe:117.8,pb:15.2, roe:13.1,mc:111,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1645.7, day:-1.59,pe:84.3,pb:8.4, roe:11.8,mc:152,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:19480.0, day:-1.27,pe:85.0,pb:26.7, roe:31.3,mc:1679,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:7050.0, day:-3.25,pe:167.2,pb:26.9, roe:12.6,mc:222,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:1998.9, day:-0.25,pe:132.8,pb:9.8, roe:11.6,mc:938,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1596.2, day:-0.37,pe:82.5,pb:11.8, roe:16.5,mc:155,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:2044.4, day:-2.43,pe:99.1,pb:6.1, roe:5.1,mc:178,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:399.05, day:-1.37,pe:106.5,pb:9.7, roe:11.2,mc:138,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:406.9, day:-2.23,pe:57.8,pb:5.1, roe:8.9,mc:78,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:726.35, day:0.82,pe:784.5,pb:5.3, roe:-2.8,mc:36,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:680.5, day:0.79,pe:107.6,pb:12.5, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1692.3, day:-1.39,pe:112.5,pb:11.0, roe:9.0,mc:81,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:21820.0, day:-2.39,pe:271.9,pb:22.7, roe:7.2,mc:342,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:162.28, day:-1.49,pe:null,pb:1.1, roe:-0.5,mc:18,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:12551.0, day:-0.08,pe:192.5,pb:10.3, roe:4.3,mc:82,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:155.34, day:6.27,pe:350.5,pb:11.6, roe:5.2,mc:39,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1923.1, day:-0.88,pe:122.2,pb:10.6, roe:10.4,mc:77,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:912.7, day:-5.27,pe:90.8,pb:7.4, roe:7.5,mc:75,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 18 Sep 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — CRUDE SPIKED PAST $100 TO A ~$110 PEAK, now easing to ~$104 (as of 18 Sep): the two weeks to 18 Sep saw the sharpest energy shock of the war; from ~$93 on 3 Sep, on 8 Sep US CENTCOM destroyed five IRGC oil tankers in the Strait of Hormuz (retaliation for an attempted strike on a US carrier) and the IRGC warned tankers to evacuate Kuwaiti/Bahraini waters; on 9 Sep Brent crossed $100 for the first time since July (~$100.19), closing that day with WTI +6.7% at $102.48 and Brent +6.3% at $107.63, as Iran fired missiles at US forces in Jordan and Houthi strikes injured 70+ at Saudi energy facilities (the US destroyed 8+ Iranian tankers over the period); on 11 Sep the Saudi East-West Crude Oil Pipeline was shut, and with Hormuz + Bab al-Mandab disrupted ~39% of global trade / 31% of shipments were affected; Brent peaked ~$108-110 around 15-16 Sep, then eased to ~$103.61 on the 17th (-2.1%) and ~$103-104 on the 18th, pulling US 10-year yields back from the 5% level and letting Wall Street rally; on 16 Sep the Federal Reserve HIKED rates 25bp to 3.75-4% (its first hike since 2023, unanimous 12-0) explicitly citing spiralling oil-driven inflation, with the dot plot signalling another hike possible in December; Brent ~$104 (+~54% YoY) is a serious headwind for India's import bill, rupee (~88/dollar) and inflation; on the India side, the sector had a volatile fortnight: on 8 Sep the government gave initial approval for ~$11bn of proposed military purchases (BSE Defence index +2.1%, its most in a month, HAL/BEL leading, plus bullish Jefferies calls); on 11 Sep the Nifty logged its 8th straight gain with defence stocks rallying after the government began talks for six next-generation submarines (a P-75I follow-on), BEL among the top gainers; then on 15 Sep defence stocks fell sharply (Nifty India Defence index -5.5% to ~9,190, Solar Industries -14% to ₹19,225) as the index breached its 2-month moving average amid a broad selloff (Sensex -2,200 pts in September), before a partial recovery on 17 Sep (Paras/Apollo/BEML/BEL/GRSE +up to 5% on value buying; Antique's 8 Sep note stayed constructive, top picks Mazagon/HAL/BEL/Astra); the sector's returns remain anchored by domestic drivers (order pipeline, indigenisation, Tejas Mk-1A deliveries targeted to begin Aug-Sep 2026 with ~20 aircraft planned FY27); the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"Crude Spiked Past $100 to a ~$110 Peak on Iran War; Easing to ~$104, Fed Hiked",stat:"Post-peak, oil elevated · 18 Sep 2026",body:"The two weeks to 18 September saw the sharpest energy shock of the war, now partly unwinding. After Brent sat near $93 on 3 September, the US-Iran conflict escalated hard: on 8 September US Central Command destroyed five IRGC oil tankers in the Strait of Hormuz (retaliation for an attempted strike on a US aircraft carrier), and the IRGC warned all tankers to evacuate Kuwaiti and Bahraini waters. On 9 September Brent crossed $100 for the first time since July (about $100.19), and by that day's close oil had jumped further, with WTI settling up 6.7% at $102.48 and Brent up 6.3% at $107.63, as Iran fired missiles at US forces in Jordan and Houthi strikes injured 70-plus at Saudi energy facilities; the US destroyed at least eight Iranian tankers over the period. On 11 September the Saudi East-West Crude Oil Pipeline was shut down, and with Hormuz and Bab al-Mandab also disrupted, roughly 39% of global trade and 31% of shipments were affected. Brent peaked near $108-110 around 15-16 September before easing to about $103.61 on the 17th (down 2.1%) and roughly $103-104 on the 18th as the market judged some risk priced in; the pullback pulled US 10-year yields back from the 5% level and let Wall Street rally. The energy-driven inflation forced a major macro response: on 16 September the Federal Reserve raised rates 25bp to 3.75-4%, its first hike since 2023 (a unanimous 12-0 vote), explicitly citing spiralling oil prices, with the dot plot signalling another hike possible in December. For Indian defence, this reinforces the war premium in sentiment and the structural case for defence spending, while the sector's returns remain anchored by domestic drivers (order pipeline, indigenisation, Tejas deliveries beginning). Brent near $104 (up ~54% year-on-year) remains a serious headwind for India's import bill, rupee (around 88/dollar) and inflation, keeping the conflict's path the single most important macro variable."},
    ...
    {icon:"🎯",color:A.orange,  title:"Nifty India Defence Index — Volatile Fortnight: Submarine Talks, a Sharp Correction, Recovery",stat:"18 Sep 2026 · Defence sector",body:"The defence sector had a choppy two weeks through the September oil shock. On 8 September the government gave initial approval for about $11 billion of proposed military purchases, lifting the BSE Defence index as much as 2.1% (its most in a month), and on 11 September the Nifty logged its 8th straight gain with defence rallying after the government began talks for six next-generation submarines (a P-75I follow-on that cascades to Mazagon Dock and GRSE for build and to BEL for combat systems). But on 15 September the Nifty India Defence index fell sharply, down about 5.5% to ~9,190, as HAL, BEL and Solar Industries (together over half the index weight) sold off and the index breached its 2-month moving average amid a broad market decline (the Sensex shed roughly 2,200 points in September on ~$104 crude, a 5% US 10-year yield and the hawkish Fed). Defence then recovered up to 5% on 17 September on value buying. BEL (~26%) and HAL (~24%) remain the largest weights; index P/E sits near ~52-54x — rich, but underpinned by a multi-year order pipeline, deepening indigenisation and the start of Tejas Mk-1A deliveries. The near-term swing factors are execution cadence and whether the oil-driven macro tightening crimps broader risk appetite, against a domestic order book that keeps building."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ACTIVE WAR",score:9,region:"Middle East",color:A.red,date:"18 Sep 2026",hot:true,
     title:"Crude Spiked Past $100 to a ~$110 Peak on Iran War; Easing to ~$104, Fed Hiked",
     detail:"The two weeks to 18 Sep saw the sharpest energy shock of the war, now partly unwinding. From ~$93 on 3 Sep: on 8 Sep US CENTCOM destroyed five IRGC oil tankers in Hormuz (retaliation for an attempted strike on a US carrier), and the IRGC warned tankers to evacuate Kuwaiti/Bahraini waters. On 9 Sep Brent crossed $100 for the first time since July (~$100.19); by that close WTI settled +6.7% at $102.48 and Brent +6.3% at $107.63, as Iran fired missiles at US forces in Jordan and Houthi strikes injured 70+ at Saudi energy facilities (US destroyed 8+ Iranian tankers over the period). On 11 Sep the Saudi East-West Crude Oil Pipeline was shut; with Hormuz + Bab al-Mandab disrupted, ~39% of global trade / 31% of shipments were affected. Brent peaked ~$108-110 around 15-16 Sep, then eased to ~$103.61 on the 17th (-2.1%) and ~$103-104 on the 18th, pulling US 10y yields back from 5% and letting Wall St rally. The oil-driven inflation forced the Fed to HIKE 25bp to 3.75-4% on 16 Sep (first hike since 2023, 12-0), citing spiralling oil. Reinforces the war premium and the structural defence-spend case; sector returns anchored by domestic drivers. Brent ~$104 (+~54% YoY) a serious headwind for India (rupee ~88/$).",
