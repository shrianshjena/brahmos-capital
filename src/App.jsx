...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4278.5, day:0.57,pe:31.4,pb:7.0, roe:24.0,mc:2861,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:407.85, day:0.16,pe:49.1,pb:12.4, roe:27.6,mc:2981,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2444.9, day:0.9,pe:38.2,pb:10.1, roe:28.8,mc:986,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1467.7, day:2.68,pe:53.8,pb:6.8, roe:12.5,mc:386,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2614.9, day:0.51,pe:43.5,pb:11.4, roe:31.8,mc:300,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1206.1, day:0.17,pe:105.4,pb:10.5, roe:9.9,mc:442,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4025.2, day:4.83,pe:83.2,pb:13.0, roe:16.7,mc:225,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:853.7, day:4.81,pe:78.2,pb:10.2, roe:13.1,mc:69,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1672.4, day:3.31,pe:77.7,pb:8.4, roe:11.8,mc:150,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18386.0, day:1.01,pe:99.0,pb:26.5, roe:31.3,mc:1664,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:7216.0, day:2.07,pe:237.4,pb:29.8, roe:12.6,mc:222,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:1902.9, day:-1.03,pe:84.6,pb:9.5, roe:11.6,mc:910,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1323.8, day:0.58,pe:65.3,pb:10.8, roe:16.5,mc:126,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1729.3, day:0.53,pe:101.5,pb:5.1, roe:5.1,mc:144,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:437.0, day:8.13,pe:138.7,pb:11.5, roe:11.2,mc:156,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:410.75, day:0.72,pe:58.6,pb:5.4, roe:8.9,mc:77,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:828.9, day:2.89,pe:null,pb:6.1, roe:-2.8,mc:36,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:651.85, day:1.28,pe:76.7,pb:12.7, roe:16.5,mc:35,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:993.15, day:5.0,pe:80.2,pb:7.2, roe:9.0,mc:51,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:19380.0, day:4.82,pe:283.3,pb:20.5, roe:7.2,mc:291,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:197.59, day:3.43,pe:null,pb:1.3, roe:-0.5,mc:22,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10321.0, day:-1.27,pe:214.6,pb:8.8, roe:4.3,mc:70,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:176.14, day:1.57,pe:326.2,pb:13.8, roe:5.2,mc:47,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1682.2, day:-5.0,pe:100.0,pb:9.8, roe:10.4,mc:72,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:463.9, day:7.14,pe:50.3,pb:3.6, roe:7.5,mc:37,  ob:1, seed:2016,sector:"Electronics"},
...
const CONSENSUS_STATIC={
  ...
  DATAPATTNS: {buy:8, hold:6, sell:6, target:4500, brokers:["HDFC Sec","Motilal","Kotak","Emkay","Prabhudas"]},
  PARAS:      {buy:10,hold:5, sell:4, target:950,  brokers:["ICICI Sec","Axis","YES Sec","Nirmal Bang","Monarch"]},
  ...
  ASTRAMICRO: {buy:14,hold:5, sell:2, target:1450, brokers:["ICICI Sec","Motilal","Axis","BOB Cap","Prabhudas"]},
  ...
  MIDHANI:    {buy:10,hold:6, sell:3, target:460,  brokers:["ICICI Sec","Motilal","Axis","Emkay","Kotak"]},
  IDEAFORGE:  {buy:9, hold:6, sell:4, target:900,  brokers:["Motilal","Emkay","YES Sec","Nirmal Bang","BOB Cap"]},
  PREMEXPLN:  {buy:10,hold:5, sell:3, target:730,  brokers:["Motilal","HDFC Sec","YES Sec","Nirmal Bang","Monarch"]},
  UNIMECH:    {buy:11,hold:5, sell:2, target:1100, brokers:["Kotak","Motilal","Emkay","YES Sec","BOB Cap"]},
  ...
  AXISCADES:  {buy:10,hold:5, sell:3, target:1850, brokers:["HDFC Sec","Kotak","Emkay","YES Sec","BOB Cap"]},
...
Macro context (as of 02 Jun 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3) at the Shangri-La Dialogue, Indonesia pact in final stages — Philippines was the first BrahMos buyer (2022); FY26 results in: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; US–Iran Operation Epic Fury (started 28 Feb 2026) now under a FRAGILE ceasefire — Brent crude eased to ~$95/bbl from its late-April peak near $120, but Israeli operations in Lebanon and Iranian threats to close the Strait of Hormuz keep risk elevated; Ukraine war in its 4th year with on-off ceasefire talks and continued NATO/European rearmament; Nifty India Defence index ~8,900 (mid-May), outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🌊",color:A.orange, title:"Fragile US–Iran Ceasefire Holds — Brent Eases to ~$95 from April Peak",stat:"Brent ~$95/bbl · 1 Jun 2026",body:"A fragile US–Iran ceasefire is holding after Operation Epic Fury, with Brent crude easing to ~$95/bbl from its late-April peak near $120. The latest flashpoint is Israeli operations in Lebanon, which prompted Iran to suspend communications with Washington and threaten a full closure of the Strait of Hormuz and Bab el-Mandeb. Trump has floated an MoU to reopen Hormuz within a week. Sustained Middle East risk keeps air-defence, naval and missile procurement urgency elevated — supporting BDL, ZENTEC and the shipbuilders."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ESCALATING",score:9,region:"Middle East",color:A.orange,date:"1 Jun 2026",hot:true,
     title:"Fragile US–Iran Ceasefire Holds — Brent Eases to ~$95 from April Peak",
     detail:"A fragile US–Iran ceasefire is holding after Operation Epic Fury, with Brent crude easing to ~$95/bbl from its late-April peak near $120. The latest flashpoint is Israeli operations in Lebanon, which prompted Iran to suspend communications with Washington and threaten a full closure of the Strait of Hormuz and Bab el-Mandeb. Trump has floated an MoU to reopen Hormuz within a week. Sustained Middle East risk keeps air-defence, naval and missile procurement urgency elevated — supporting BDL, ZENTEC and the shipbuilders.",
