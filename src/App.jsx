...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:4592.5, day:0.39,pe:33.7,pb:7.5, roe:24.0,mc:3071,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:405.35, day:-0.34,pe:48.8,pb:12.4, roe:27.6,mc:2963,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2298.9, day:-0.37,pe:35.8,pb:9.5, roe:28.8,mc:927,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1395.7, day:2.05,pe:51.3,pb:6.3, roe:12.5,mc:367,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2574.4, day:-0.56,pe:42.9,pb:11.2, roe:31.8,mc:295,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1239.8, day:-0.78,pe:107.8,pb:10.7, roe:9.9,mc:454,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4597.5, day:-3.87,pe:95.2,pb:14.8, roe:16.7,mc:257,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1197.5, day:-2.09,pe:110.0,pb:13.3, roe:13.1,mc:97,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1800.7, day:-0.77,pe:83.4,pb:9.0, roe:11.8,mc:162,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:18621.0, day:-1.25,pe:100.8,pb:26.8, roe:31.3,mc:1685,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:5875.0, day:0.39,pe:193.1,pb:22.0, roe:12.6,mc:181,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2175.3, day:-0.47,pe:96.6,pb:10.9, roe:11.6,mc:1040,  ob:70,seed:2003,sector:"Forgings"},
  {ticker:"ASTRAMICRO", name:"Astra Microwave Products",  sub:"Radar · EW Systems",           shares:180, buy:660,  px:1783.1, day:1.48,pe:88.2,pb:12.9, roe:16.5,mc:169,  ob:6, seed:2004,sector:"Electronics"},
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1730.7, day:-0.33,pe:101.7,pb:4.9, roe:5.1,mc:144,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:395.5, day:-2.32,pe:125.2,pb:10.4, roe:11.2,mc:147,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:394.6, day:-1.89,pe:56.1,pb:4.8, roe:8.9,mc:74,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:861.05, day:-0.07,pe:null,pb:6.3, roe:-2.8,mc:43,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:663.6, day:-1.73,pe:78.0,pb:12.4, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1215.3, day:-1.66,pe:97.4,pb:8.8, roe:9.0,mc:62,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:17836.0, day:0.33,pe:264.0,pb:17.7, roe:7.2,mc:267,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:179.81, day:-1.65,pe:null,pb:1.2, roe:-0.5,mc:20,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:10181.0, day:0.2,pe:213.2,pb:8.7, roe:4.3,mc:69,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:164.47, day:-0.18,pe:382.5,pb:12.9, roe:5.2,mc:44,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1562.4, day:1.06,pe:92.7,pb:9.1, roe:10.4,mc:66,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:665.1, day:-4.73,pe:64.4,pb:5.2, roe:7.5,mc:53,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 23 Jul 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: MOFSL expects BEL to win the ~₹30,000 Cr QRSAM order within weeks (largest pending award), cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) has ESCALATED — since the 18 Jun MoU collapsed the US has struck 95 locations across 12 Iranian cities in ten days (another round 20 Jul), several US troops have been killed, Iran hit a tanker in Hormuz on 21 Jul, and Yemen's Houthis declared a maritime embargo on Saudi Arabia (new front, Bab el-Mandeb at risk); Brent has climbed to ~$90/bbl from sub-$74 early-July lows, so rising crude is now a growing negative for India's import bill; regional mediators have floated a 10-day ceasefire that could revive the MoU; on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"📊",color:A.blue,   title:"Q1 FY27 Earnings Season Underway — BEL Reports 27 Jul, ₹572 Cr Fresh Order",stat:"Execution in focus · Jul 2026",body:"The June-quarter (Q1 FY27) results season is the sector's next catalyst, shifting the market's focus from order intake to execution and margins. BEL has scheduled its Q1 board meeting for 27 July and recently bagged a fresh ₹572 crore order; the Street expects EBITDA margins to hold above 23%. HAL's Tejas Mk-1A deliveries are targeted to begin August-September 2026 (~20 aircraft planned for FY27), a key execution milestone investors will track through quarterly delivery updates. With order books at record levels (HAL ₹2.54L Cr, BEL ₹73,882 Cr) and a ~₹4.2 trillion HAL pipeline through FY30, the question now is conversion pace — how fast the disclosed backlog turns into revenue and profit."},
    ...
    {icon:"🕊️",color:A.teal, title:"War Escalates — 95 Strikes in 10 Days, US Troops Killed, Brent ~$90",stat:"10-day truce floated · 23 Jul 2026",body:"The conflict has intensified sharply since the June 18 MoU collapsed. Iranian authorities say the US has struck 95 locations across 12 cities in the past ten days, and Washington completed another round of strikes on 20 July. Several US troops have been killed, with Trump vowing that Iran 'will pay many times over.' Iran attacked a tanker in the Strait of Hormuz on 21 July, and — opening a potential new front — Yemen's Houthis declared a maritime embargo against Saudi Arabia, putting Bab el-Mandeb back at risk alongside Hormuz. Brent crude has climbed to ~$90/bbl (from sub-$74 in early July), with Rystad warning of a further rebound. The one de-escalation thread: regional mediators have put a 10-day ceasefire proposal to both sides that could revive the MoU, though ING cautions that large divisions remain. For Indian defence, the renewed war premium supports sentiment, but rising crude is a growing negative for India's import bill and rupee — and the sector's durable driver remains the domestic order pipeline."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ESCALATING",score:9,region:"Middle East",color:A.red,date:"23 Jul 2026",hot:true,
     title:"War Escalates — 95 Strikes in 10 Days, US Troops Killed, Brent ~$90",
     detail:"The conflict has intensified sharply since the June 18 MoU collapsed. Iranian authorities say the US struck 95 locations across 12 cities in ten days, with another round completed on 20 July. Several US troops have been killed and Trump has vowed retaliation. Iran attacked a tanker in Hormuz on 21 July, and Yemen's Houthis declared a maritime embargo against Saudi Arabia — putting Bab el-Mandeb at risk alongside Hormuz and opening a potential new front. Brent has climbed to ~$90/bbl from sub-$74 in early July, with Rystad warning of further upside. Regional mediators have floated a 10-day ceasefire that could revive the MoU, though ING notes large divisions remain. Renewed war premium supports defence sentiment; rising crude is a growing negative for India's import bill.",
