...
const STOCKS=[
  {ticker:"HAL",        name:"Hindustan Aeronautics",    sub:"Aerospace · MRO",              shares:50,  buy:3200, px:5059.0, day:0.58,pe:36.3,pb:8.2, roe:24.0,mc:3383,  ob:1855,seed:1001,sector:"Aerospace"},
  {ticker:"BEL",        name:"Bharat Electronics",       sub:"Electronics · C4ISR",          shares:500, buy:310,  px:412.45, day:0.4,pe:49.2,pb:12.6, roe:27.6,mc:3015,  ob:740, seed:1002,sector:"Electronics"},
  {ticker:"MAZDOCK",    name:"Mazagon Dock Shipbuilders", sub:"Naval · Submarines",           shares:80,  buy:1800, px:2569.7, day:-0.4,pe:38.6,pb:10.6, roe:28.8,mc:1037,  ob:380, seed:1003,sector:"Naval"},
  {ticker:"COCHINSHIP", name:"Cochin Shipyard",           sub:"Naval · Shipbuilding",         shares:120, buy:1100, px:1457.8, day:-2.59,pe:53.5,pb:6.5, roe:12.5,mc:384,  ob:220, seed:1004,sector:"Naval"},
  {ticker:"GRSE",       name:"Garden Reach Shipbuilders", sub:"Naval · Patrol Vessels",       shares:60,  buy:1900, px:2600.1, day:-0.71,pe:37.2,pb:11.3, roe:31.8,mc:298,  ob:250, seed:1005,sector:"Naval"},
  {ticker:"BDL",        name:"Bharat Dynamics",           sub:"Missiles · Munitions",         shares:150, buy:900,  px:1380.0, day:-1.29,pe:96.8,pb:11.9, roe:9.9,mc:506,  ob:225, seed:1006,sector:"Missiles"},
  {ticker:"DATAPATTNS", name:"Data Patterns India",       sub:"Defence Electronics · Radar",  shares:30,  buy:2500, px:4528.7, day:1.64,pe:95.0,pb:14.6, roe:16.7,mc:254,  ob:14,  seed:1007,sector:"Electronics"},
  {ticker:"PARAS",      name:"Paras Defence & Space",     sub:"Optics · Space · EMP",         shares:200, buy:500,  px:1388.5, day:0.8,pe:118.6,pb:15.4, roe:13.1,mc:112,  ob:8,  seed:1008,sector:"Space"},
  {ticker:"ZENTEC",     name:"Zen Technologies",           sub:"Training · Anti-Drone",        shares:100, buy:900,  px:1864.5, day:0.39,pe:92.9,pb:9.3, roe:11.8,mc:168,  ob:12,  seed:1009,sector:"Electronics"},
  {ticker:"SOLARINDS",  name:"Solar Industries India",    sub:"Explosives · Propellants",     shares:15,  buy:10500,px:20000.0, day:0.16,pe:91.0,pb:28.8, roe:31.3,mc:1810,  ob:54,seed:2001,sector:"Explosives"},
  {ticker:"MTAR",       name:"MTAR Technologies",         sub:"Precision Aero · Propulsion",  shares:60,  buy:1600, px:7057.0, day:0.01,pe:164.0,pb:26.4, roe:12.6,mc:217,  ob:9, seed:2002,sector:"Aerospace"},
  {ticker:"BHARATFORG", name:"Bharat Forge",              sub:"Forgings · Artillery · UAV",   shares:100, buy:1250, px:2093.0, day:1.36,pe:140.8,pb:10.4, roe:11.6,mc:1001,  ob:70,seed:2003,sector:"Forgings"},
  ...
  {ticker:"BEML",       name:"BEML Ltd",                  sub:"Combat Vehicles · Rail",       shares:100, buy:1100, px:1908.5, day:1.82,pe:89.3,pb:5.4, roe:5.1,mc:159,  ob:14, seed:2005,sector:"Vehicles"},
  {ticker:"APOLLOMICRO",name:"Apollo Micro Systems",      sub:"Embedded Defence Electronics", shares:500, buy:165,  px:387.05, day:-1.65,pe:115.5,pb:10.2, roe:11.2,mc:144,  ob:8, seed:2006,sector:"Electronics"},
  {ticker:"MIDHANI",    name:"Mishra Dhatu Nigam",        sub:"Special Alloys · Titanium",    shares:250, buy:280,  px:428.6, day:2.86,pe:59.4,pb:5.2, roe:8.9,mc:80,  ob:6, seed:2007,sector:"Materials"},
  {ticker:"IDEAFORGE",  name:"Ideaforge Technology",      sub:"Drones · UAV Systems",         shares:300, buy:310,  px:795.1, day:-3.14,pe:883.4,pb:5.8, roe:-2.8,mc:40,  ob:3, seed:2008,sector:"Drones"},
  {ticker:"PREMEXPLN",  name:"Premier Explosives",        sub:"Explosives · Propellants",     shares:400, buy:320,  px:672.65, day:3.18,pe:78.8,pb:12.5, roe:16.5,mc:36,  ob:4, seed:2009,sector:"Explosives"},
  {ticker:"UNIMECH",    name:"Unimech Aerospace",         sub:"Aerospace Precision Parts",    shares:350, buy:560,  px:1511.3, day:-0.74,pe:106.7,pb:10.4, roe:9.0,mc:77,  ob:2, seed:2010,sector:"Aerospace"},
  {ticker:"PTCIND",     name:"PTC Industries",            sub:"Precision Castings · Aero",    shares:20,  buy:9500, px:20584.0, day:8.05,pe:245.6,pb:20.5, roe:7.2,mc:309,  ob:3, seed:2011,sector:"Aerospace"},
  {ticker:"DCXINDIA",   name:"DCX Systems",               sub:"Cable Harness · Electronics",  shares:800, buy:150,  px:173.32, day:-1.63,pe:null,pb:1.2, roe:-0.5,mc:19,  ob:7, seed:2012,sector:"Electronics"},
  {ticker:"DYNAMATECH", name:"Dynamatic Technologies",    sub:"Aerospace Structures · UAV",   shares:30,  buy:3800, px:11123.0, day:-0.58,pe:177.5,pb:9.5, roe:4.3,mc:76,  ob:4, seed:2013,sector:"Aerospace"},
  {ticker:"AVANTEL",    name:"Avantel Ltd",               sub:"Satellite Comms · Defence",    shares:600, buy:95,   px:157.51, day:-0.62,pe:366.3,pb:12.4, roe:5.2,mc:42,  ob:2, seed:2014,sector:"Electronics"},
  {ticker:"AXISCADES",  name:"Axiscades Technologies",    sub:"Aerospace Engineering R&D",    shares:250, buy:450,  px:1553.4, day:4.62,pe:92.6,pb:9.1, roe:10.4,mc:66,  ob:3, seed:2015,sector:"Aerospace"},
  {ticker:"CYIENTDLM",  name:"Cyient DLM",                sub:"PCB · Defence Electronics",    shares:200, buy:850,  px:737.45, day:5.86,pe:71.5,pb:5.8, roe:7.5,mc:59,  ob:1, seed:2016,sector:"Electronics"},
...
Macro context (as of 17 Aug 2026): India FY27 defence budget ₹7.85L Cr (+15.2% YoY), FY26 MoD outlay was ₹6.81L Cr; P-75I stealth submarine programme cleared by the Ministry of Finance (early Jun 2026) — only CCS sign-off remains before the ~₹70,000 Cr Navy order, with Mazagon Dock (which just delivered the 6th & final P-17A frigate) the front-runner; order momentum strong — BEL booked ₹2,100 Cr fresh orders, GRSE launched the first of 11 NG-OPVs, Zen Tech lowest bidder on AVNL weapon stations, US cleared $428M FMS to India, FY26 DAC approvals at an all-time high; India–Vietnam BrahMos export deal SIGNED 30 May 2026 (~₹60,000 Cr / $629M, Block-3), Indonesia pact in final stages, Philippines was the first buyer (2022); FY26 results: HAL record order book ₹2.54L Cr with ₹9,115 Cr PAT, BEL FY26 revenue ₹27,480 Cr / PAT ₹6,048 Cr / order book ₹73,882 Cr; NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (FY27 order target ₹55,000+ Cr); the ~₹30,000 Cr QRSAM award is now expected Q2 FY27, cascading to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers); BROKER SPLIT on valuation — Kotak cautious (SELL Mazagon FV ₹1,950 and Solar ₹10,300, REDUCE BEL, ADD HAL ₹4,810) vs Antique Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532), so stock selection now matters more than sector beta; Q1 FY27 season underway (BEL reports 27 Jul); Operation Epic Fury (US–Iran war) — CEASEFIRE EXPIRES, US escalates to economic warfare (as of 17 Aug): the interim US-Iran ceasefire formally expires today with no successor deal; Treasury Secretary Bessent said the US will impose 'unprecedented economic measures' while maintaining its naval blockade, and Trump is preparing new sanctions aimed at forcing Iran to 'surrender'; Tehran insists the blockade must lift before it fully reopens the Strait of Hormuz, and Iran-Oman talks remain unresolved; the conflict is widening (Israel struck Lebanon over the weekend, 11 killed incl. a senior Hezbollah commander; Houthis again hit Saudi's Jazan refinery); the IEA now warns of the widest global supply deficit in five years for 2026; Brent held above $88 after +5% last week (+~33% YoY), a persistent negative for India's import bill/rupee; the sector's own drivers (Budget-capex hopes, the domestic order pipeline) remain in control; Astra Microwave reported a weak Q1 FY27 (10 Aug) — PAT ₹12 Cr (-24% YoY), revenue -11.5% — but a record order book of ₹2,849 Cr; Apollo Micro won ₹213 Cr of new orders (5 Aug); HAL is reportedly fining GE over a ~$716m engine crisis constraining Tejas Mk-1A production; the ~₹30,000 Cr QRSAM award is expected Q2 FY27; Astra Microwave secured a transformational ₹2,205 Cr HAL order (31 Jul) for 122 AAAU + 121 interface frames for the indigenous Uttam AESA radar (larger than its entire prior order book; stock +14% to a record high; Q1 FY27 on 10 Aug); Mazagon Dock posted in-line Q1 FY27 (PAT ₹550 Cr +22% YoY, revenue +12%, EBITDA +48%, margin 15.2%; Antique BUY ₹3,275); on 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced) — air-defence, unmanned/ISR, localisation — lifting the sector, with post-DAC broker views B&K Buy BEL (₹513)/HAL & Hold BDL and ICICI picks BEL/HAL/Astra/Solar (Buy PTC ₹21,000); India's FY26 defence production hit a record ₹1.78L Cr; the Nifty India Defence index consolidated off its ~9,400 mid-Jun high as the war premium faded but structural demand (capex/policy-driven) is intact; Ukraine war in its 4th year with continued NATO/European rearmament; sector P/E ~52–54, still outperforming the broader market YTD; Global defence spend ~$2.7T.`;
}
...
function WhyDefenceView(){
  const THESIS=[
    ...
    {icon:"🕊️",color:A.teal, title:"US-Iran Ceasefire Expires; Washington Escalates to Economic Warfare, Brent ~$88",stat:"Ceasefire lapses · 17 Aug 2026",body:"The conflict has escalated on the economic front as the diplomatic track stays deadlocked. The interim US-Iran ceasefire is set to formally expire today (17 August) with no successor deal, and Washington is pivoting to economic warfare rather than fresh airstrikes: Treasury Secretary Scott Bessent said the US will impose 'unprecedented economic measures' while maintaining its naval blockade of Iranian ports, and President Trump is preparing new sanctions aimed at forcing Iran to 'surrender' (further announcements expected this week). Tehran continues to insist the blockade must be lifted before it will fully reopen the Strait of Hormuz, and Iran-Oman talks remain unresolved. The conflict is also widening: over the weekend Israel struck Lebanon (killing 11, including a senior Hezbollah commander), and Houthis again targeted Saudi Arabia's Jazan refinery. Crucially, the IEA now warns of the widest global supply deficit in five years for 2026. Brent has held above $88 after gaining more than 5% last week, though covert barrel movements through Hormuz and the absence of major new outages have capped further upside. For Indian defence, the entrenched conflict sustains a war premium, but the sector's own drivers (Budget-capex hopes, the domestic order pipeline) remain firmly in control; Brent near $88, up ~33% year-on-year, is a persistent negative for India's import bill, rupee and inflation."},
...
function GeoView({geoCards,geoAiStatus}){
  ...
  const GEO_STATIC=[
    ...
    {id:102,impact:"BULLISH",score:8,region:"India",color:A.green,date:"May 2026",hot:false,
     ...
     tickers:["HAL","BEL"]},
    {id:103,impact:"ESCALATING",score:8,region:"Middle East",color:A.red,date:"17 Aug 2026",hot:true,
     title:"US-Iran Ceasefire Expires; Washington Escalates to Economic Warfare, Brent ~$88",
     detail:"The conflict escalated on the economic front while diplomacy stays deadlocked. The interim US-Iran ceasefire formally expires today (17 Aug) with no successor deal, and Washington is pivoting to economic warfare over fresh airstrikes: Treasury Secretary Bessent said the US will impose 'unprecedented economic measures' while maintaining its naval blockade, and Trump is preparing new sanctions aimed at forcing Iran to 'surrender' (more expected this week). Tehran insists the blockade must lift before it fully reopens Hormuz; Iran-Oman talks remain unresolved. Widening: Israel struck Lebanon over the weekend (11 killed, incl. a senior Hezbollah commander); Houthis again hit Saudi's Jazan refinery. The IEA now warns of the widest global supply deficit in five years for 2026. Brent held above $88 after +5% last week, though covert Hormuz barrel flows and no major new outages capped upside. War premium persists; the sector's own drivers (Budget capex, order pipeline) remain in control. Brent ~$88 (+~33% YoY) is a persistent negative for India.",
