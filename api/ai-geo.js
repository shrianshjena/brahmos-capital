...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 27 July 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. US–Iran Halt Strikes, Diplomacy Revives, Brent Eases ~$90 (27 Jul 2026) — the US and Iran halted strikes over the weekend (US paused late Friday without formal announcement; Tehran stopped retaliating; Trump reportedly open to talks); Iran engaged Oman on restoring Hormuz traffic. Brent eased from ~$100 toward ~$90 as the truce held (still up ~40% from early-July lows). Houthis still attacking Saudi Aramco Red Sea facilities (Jizan/Yanbu). Easing tensions cool the near-term war premium. colorType teal, score 8, hot true.
