...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 19 August 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. Brent Climbs Toward $92 as Conflict Widens — UAE Cuts Financial Ties With Iran (19 Aug 2026) — with the ceasefire lapsed and no talks underway, the conflict has widened and Brent climbed toward $92 (4th straight up session). Sharpest new development: the UAE suspended ALL financial and economic transactions with Iran after accusing Tehran of launching ballistic missiles at its territory. Trump confirmed no ongoing negotiations while the naval blockade remains; he claims Hormuz is open but traffic stays very limited. Three China-linked supertankers turned back; a vessel was struck by a projectile; ~8 attacks on Hormuz-transiting ships this month. Gulf producers keep moving volumes covertly; US refinery activity highest since Sept 2019. War premium firm; sector's own drivers (Budget capex, orders) in control. colorType red, score 8, hot true.
