...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 6 August 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. Iran-Oman Reach Hormuz Shipping Deal, Oil Slides to ~$77 as Truce Nears (6 Aug 2026) — Trump called off a planned strike early this week ('perimeters of a deal' agreed); Iran and Oman reached an agreement on a temporary Hormuz shipping route (2-4 months, not a full reopening); US/Iran/Oman reported close to a 60-day interim deal to reopen without tolls. Crude fell 3 straight sessions to ~$77 (Brent), off late-July highs near $92; Saudi Aramco cut its Asian price, US inventories rebounded. Houthi Red Sea attacks continue. Read-through: Indian defence rallied hard even as the war premium drained — domestic orders/Budget capex now drive it. colorType teal, score 7, hot true.
