...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 29 July 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. US–Iran Talks Gain Steam, Oman Floats Hormuz Deal, Brent ~$88 (29 Jul 2026) — US paused strikes late Friday, Iran ceased retaliation; Trump says 'good talks' with Tehran and a 'good chance' of resolution (warns strikes could resume). Iran FM Araghchi met Saudi + Omani counterparts; Oman proposed a joint Hormuz mechanism (Iran collecting voluntary transit fees), gaining Gulf support. Brent hit ~$81 Tue (week-low) then rebounded ~4% to ~$88 Wed on a fresh Iranian attack on US troops + drones on Saudi facilities. colorType teal, score 8, hot true.
