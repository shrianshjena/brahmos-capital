...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 30 July 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. Talks Collapse, US Strikes Dozens of IRGC Sites, Brent Above $92 (30 Jul 2026) — this week's diplomatic thaw reversed: after Iran's mid-week attack on US forces, US CENTCOM launched a fresh major wave of strikes on dozens of IRGC sites (30 Jul); Trump pledged a strong response. The two sides failed to reach a deal — Tehran insists on keeping control of the Strait of Hormuz, sinking the Oman mechanism floated days earlier. Saudi Arabia joined US strikes on Tehran-linked militants in Iraq; Houthis keep threatening Red Sea shipping. Brent surged from ~$81 Tue back above $92 (+21% MTD). colorType red, score 9, hot true.
2. Q1 FY27 Results — BEL Profit +9%, Zen Falls 9% (27 Jul 2026) — BEL reported Q1 FY27 consolidated net profit ₹1,054 Cr (+8.7% YoY) on revenue ₹5,547 Cr (+25% YoY), reiterating FY27 EBITDA-margin guidance of 27%+; the ₹30,000 Cr QRSAM award is expected Q2 FY27. Zen Technologies fell ~9% intraday on a Q1 earnings miss — stretched valuations leaving no room for disappointment. colorType green, score 7, hot true.
