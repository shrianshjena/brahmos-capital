...
1. US–Iran War Escalates — 95 Strikes in 10 Days, US Troops Killed (as of 23 Jul 2026) — US struck 95 locations across 12 Iranian cities in ten days (another round 20 Jul); several US troops killed, Trump vowing retaliation; Iran hit a tanker in Hormuz 21 Jul; Yemen's Houthis declared a maritime embargo on Saudi Arabia (new front, Bab el-Mandeb at risk). Brent ~$90 from sub-$74 early-July lows. Mediators have floated a 10-day ceasefire that could revive the MoU. colorType red, score 9, hot true.
2. BEL's ₹30,000 Cr QRSAM Order Expected Within Weeks (22 Jul 2026) — MOFSL expects BEL to receive the ~₹30,000 Cr Quick Reaction Surface-to-Air Missile order within weeks (largest pending domestic award) after the DAC's ₹52,000 Cr July clearance; QRSAM-linked contracts cascade to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro Systems (on-board computers). MOFSL names BEL top defence pick; BEL backlog ~₹75,600+ Cr. Separately, brokers have split on valuation: Kotak SELL Mazagon (₹1,950)/Solar (₹10,300) and REDUCE BEL, vs Antique Buy across the board. colorType green, score 8, hot true.
