...
2. India Defence Rallies on Six Next-Gen Submarines Talks; Nifty 8th Straight Gain (12 Sep 2026) — on 12 Sep the Nifty logged its 8th consecutive gain with the Nifty India Defence index outperforming after the government began talks for six next-generation submarines (a P-75I follow-on programme), with BEL among the top index gainers. Reinforces the domestic order-pipeline thesis (submarines cascade to Mazagon Dock/GRSE for build and to BEL/electronics majors for combat systems) even as global macro (oil, a hawkish Fed) pressures sentiment. colorType green, score 7, hot false.
