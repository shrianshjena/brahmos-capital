...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 25 September 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. Peace Talks in New York Explore a Phased Hormuz Reopening; Brent Eases to ~$106 (25 Sep 2026) — for the first time in the arc a genuine diplomatic off-ramp is in view even as fighting continues. US and Iranian negotiators are holding talks in New York, reportedly exploring a PHASED deal to reopen the Strait of Hormuz, which moderated an oil rally that touched ~$108 intraday on 24 Sep. Brent eased 0.9% to ~$105.70 on 25 Sep (above $100 for a 2nd straight week but off the ~$110 prior-week peak). Tankers are resuming: four VLCCs (~2M barrels each) exited the strait Thursday. But bumpy: on 24 Sep an Iranian adviser threatened to widen the war to the Indian Ocean, Saudi intercepted Houthi missiles; BofA warned Brent could top $150 if disruptions persist. Follows the mid-month spike (crossed $100 on 9 Sep, peaked ~$108-110 mid-month, Fed hiked to 3.75-4% on 16 Sep). De-escalation would drain the war premium but leave the domestic thesis intact; lower oil = macro positive for India. colorType orange, score 7, hot true.
