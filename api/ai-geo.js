...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 26 July 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. US Pauses Strikes, Oil Spikes ~$97, Houthis Blockade Bab al-Mandeb (25 Jul 2026) — for the first time in two weeks the US did not announce fresh strikes on Iran; an Omani delegation visited Tehran on Hormuz traffic (first real diplomacy since the June MoU collapsed). But Yemen's Houthis effectively blockaded Bab al-Mandeb (~5M bbl/day Saudi oil) and attacked Saudi vessels — a second chokepoint alongside Hormuz. Brent spiked toward ~$100 then eased to ~$97; crude near $97 now a material negative for India's import bill/rupee. colorType orange, score 9, hot true.
2. BEL Q1 FY27 Results 27 Jul; ₹30,000 Cr QRSAM Now Expected Q2 FY27 (24 Jul 2026) — BEL reports Q1 FY27 on Monday 27 Jul (4 PM), with a FY27 order-intake target of ₹55,000+ Cr; the ~₹30,000 Cr QRSAM award (largest pending domestic award) is now expected in Q2 FY27 after the DAC's ₹52,000 Cr July clearance; QRSAM-linked contracts cascade to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro Systems (on-board computers). MOFSL names BEL top defence pick; BEL backlog ~₹75,600+ Cr. Separately, brokers have split on valuation: Kotak SELL Mazagon (₹1,950)/Solar (₹10,300) and REDUCE BEL, vs Antique Buy across the board. colorType green, score 8, hot true.
