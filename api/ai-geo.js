...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 3 September 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. War Reignites: US and Iran Trade Heavy Strikes, Brent Surges to ~$95 Then Steadies (3 Sep 2026) — the conflict flared back into open military exchange after ~a month of calm, the most serious escalation in weeks. Over the weekend US CENTCOM launched dozens of strikes on Iran (hundreds of targets) after accusing Iran of 'blatantly' attacking a Cyprus-flagged container ship (MV GFS Galaxy) transiting Hormuz; earlier trigger was a US strike on Iran's Larak Island. Iran retaliated with missiles/drones at US bases across Jordan, Kuwait, Bahrain, Iraq, UAE. WTI +~9% over three sessions; Brent eased 0.4% to ~$95.25 Thu (up ~20% on the month, ~42% YoY), US diesel at a four-year high feeding a global bond sell-off. Trump said strikes would be short-lived; Bessent framed economic pressure as making a large-scale kinetic restart unlikely. Strait largely shut (~8M bpd vs ~20M pre-war). Sector returns still anchored by domestic drivers (Budget capex, orders, indigenisation, Tejas). colorType red, score 9, hot true.
