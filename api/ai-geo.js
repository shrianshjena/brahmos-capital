...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 17 August 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. US-Iran Ceasefire Expires; Washington Escalates to Economic Warfare, Brent ~$88 (17 Aug 2026) — the interim US-Iran ceasefire formally expires today with no successor deal; Washington is pivoting to economic warfare over airstrikes: Treasury Sec Bessent said the US will impose 'unprecedented economic measures' while keeping its naval blockade, and Trump is preparing new sanctions to force Iran to 'surrender'. Tehran insists the blockade must lift before Hormuz fully reopens; Iran-Oman talks unresolved. Widening: Israel struck Lebanon over the weekend (11 killed incl. a Hezbollah commander); Houthis hit Saudi's Jazan refinery again. IEA warns of the widest global supply deficit in 5 years for 2026. Brent held above $88 (+5% last week). Sector's own drivers (Budget capex, orders) in control. colorType red, score 8, hot true.
