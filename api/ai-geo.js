...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 21 August 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. Iran's President Signals Willingness to End War; Brent at 2-Month High ~$94 (21 Aug 2026) — the most conciliatory signal from Tehran in weeks: President Pezeshkian said Iran wants the war with the US to end sooner rather than later ('it is better to end the war today' while 'in a position of power and dignity'), calling the June 17 MoU a victory for Iran. Markets read a potential inflection toward resolution, though signals conflict: Treasury Sec Bessent countered with a threat of the 'toughest-ever sanctions.' Brent closed ~$94 Friday (+5-6% for a 2nd straight week, highest since July). US military says it helped move 660M+ barrels through Hormuz since early May. An eventual de-escalation would drain the war premium, but the sector's durable domestic drivers (Budget capex, orders, indigenisation) stay intact. colorType orange, score 7, hot true.
