...
export default async function handler(req, res) {
  ...
  const prompt = `Today is ${today}. You are operating with full knowledge of events as of 25 August 2026.

MANDATORY CURRENT EVENTS you must include as cards (order them NEWEST first):
1. Rhetoric Re-Hardens: Iran Threatens Full Hormuz Halt as US Readies 'Economic D-Day' (25 Aug 2026) — Friday's conciliatory signal from Iran's president proved short-lived. Iran's newly appointed security chief Mohsen Rezaei threatened to halt ALL oil movement through Hormuz if neighbours help the US weaken Tehran's economy, insisting the strait stays closed until Washington meets its commitments. Iran published enforcement protocols (violating vessels face fines/detention/confiscation). Treasury Sec Bessent promised an 'economic D-Day' with fresh sanctions as talks stay at a stalemate. Brent held ~$94 (dipped to ~$93.77 Sunday). Structurally, more crude now leaves via a southern Oman-coast route, eroding Iran's leverage. War premium firmly in place; sector's own drivers (Budget capex, orders, indigenisation) in control. colorType red, score 8, hot true.
