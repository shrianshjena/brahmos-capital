...
• Operation Epic Fury (US–Iran war) — IMPASSE, oil grinds toward $93 (as of 20 Aug). The standoff keeps a firm risk premium in crude, with Brent grinding toward $93 (up >4% on the week, a 4th-5th straight up session) as Washington and Tehran remain at an impasse over ending the war and reopening the Strait of Hormuz. Tone softened at the margin: Trump said oil continues to flow through the strait and that he'd be open to resuming talks with Tehran 'at some point' — a small step back from this week's flat 'no negotiations' stance, though none are scheduled and the naval blockade stays in force. Economic pressure still building: the UAE suspended all financial/economic transactions with Iran after accusing it of launching ballistic missiles at its territory. Physical flows are the key swing factor: Gulf producers keep moving significant volumes via alternative routes/discreet shipments, US refinery runs are at their highest since Sept 2019, and EIA data showed a 4.4M-barrel crude build last week — all tempering the spike. The war premium persists; the sector's durable drivers (Budget-capex hopes, the domestic order pipeline, indigenisation policy) remain in control. Brent near $93 is a growing headwind for India's import bill/rupee/inflation.
