...
• Operation Epic Fury (US–Iran war) — now DE-ESCALATING: after the 11 Jun Hormuz shutdown, the US and Iran are reported to have agreed the final text of an MoU that would reopen the Strait of Hormuz immediately (no tolls, prewar shipping within ~30 days), extend the ceasefire 60 days, lift US sanctions and open nuclear talks. Trump says it could be signed over the weekend. Brent crude fell to ~$87/bbl (from ~$95); global equities rebounded. Wildcard: continued Israeli strikes in Lebanon could unsettle the deal.
• MARKET: after a ~3% defence selloff on 11 Jun (profit-booking), the sector rebounded sharply on 12 Jun (MTAR +13%, recovering its Bloom-Energy-driven drop; PARAS +11%; DATAPATTNS +8%). MTAR's Bloom Energy concentration (>55% of revenue) remains a structural risk but the one-day fear was overdone. India's structural drivers (order books, budget, exports) are intact and independent of the ceasefire.
