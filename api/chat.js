...
• Operation Epic Fury (US–Iran war) — CRUDE SPIKED PAST $100 TO A ~$110 PEAK, now easing to ~$104 (as of 18 Sep). The two weeks to 18 Sep saw the sharpest energy shock of the war. From ~$93 on 3 Sep: on 8 Sep US CENTCOM destroyed five IRGC oil tankers in the Strait of Hormuz (retaliation for an attempted strike on a US aircraft carrier), and the IRGC warned tankers to evacuate Kuwaiti/Bahraini waters. On 9 Sep Brent crossed $100 for the first time since July (~$100.19); by that close WTI settled +6.7% at $102.48 and Brent +6.3% at $107.63, as Iran fired missiles at US forces in Jordan and Houthi strikes injured 70+ at Saudi energy facilities (the US destroyed 8+ Iranian tankers over the period). On 11 Sep the Saudi East-West Crude Oil Pipeline was shut; with Hormuz + Bab al-Mandab disrupted, ~39% of global trade / 31% of shipments were affected. Brent peaked ~$108-110 around 15-16 Sep, then eased to ~$103.61 on the 17th (-2.1%) and ~$103-104 on the 18th as some risk was judged priced in, pulling US 10y yields back from the 5% level and letting Wall Street rally. The oil-driven inflation forced a major macro response: on 16 Sep the Federal Reserve HIKED rates 25bp to 3.75-4% (first hike since 2023, unanimous 12-0), explicitly citing spiralling oil, with the dot plot signalling another hike possible in December. Reinforces the war premium and the structural defence-spend case; the sector's returns remain anchored by domestic drivers (order pipeline, indigenisation, Tejas deliveries beginning). Brent ~$104 (+~54% YoY) is a serious headwind for India's import bill, rupee (~88/dollar) and inflation. India-defence had a volatile fortnight: on 8 Sep the govt gave initial approval for ~$11bn of proposed military purchases (BSE Defence index +2.1%, its most in a month, HAL/BEL leading, plus bullish Jefferies calls); on 11 Sep the Nifty logged its 8th straight gain with defence rallying after the govt began talks for six next-generation submarines (P-75I follow-on); on 15 Sep defence fell sharply (Nifty India Defence index -5.5% to ~9,190, Solar Industries -14% to ₹19,225) as it breached its 2-month moving average amid a broad selloff (Sensex -2,200 pts in September); it recovered up to 5% on 17 Sep on value buying, with Antique's 8 Sep note staying constructive (top picks Mazagon/HAL/BEL/Astra).
