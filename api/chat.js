...
• Operation Epic Fury (US–Iran war) — ceasefire BROKEN DOWN: on 11 Jun 2026 Iran declared the Strait of Hormuz closed to all vessels (warning any ship will be attacked), choking ~20% of global energy flows; Brent crude pushed above $95/bbl; Trump issued a fresh ultimatum to Iran. EIA expects Hormuz traffic below pre-conflict levels into early 2027.
• MARKET (11 Jun 2026): Indian defence stocks corrected ~3% (Nifty India Defence) on profit-booking after a strong run. MTAR Technologies fell ~10% — its largest client Bloom Energy (>55% of MTAR revenue) dropped 10% overnight in the US; this is a stock-specific concentration risk, not a sector signal. Sector fundamentals (order books, budget, exports) remain intact.
