...
• Operation Epic Fury (US–Iran war) — TWO CROSSCURRENTS as of 25 Jul. De-escalation: for the first time in two weeks the US did not announce fresh strikes on Iran, and an Omani delegation visited Tehran to discuss restoring Hormuz traffic (first real diplomacy since the June MoU collapsed). But the energy shock WIDENED: Yemen's Houthis effectively blockaded Bab al-Mandeb (~5M bbl/day of Saudi oil) and attacked Saudi vessels in the Red Sea — a second chokepoint alongside a still-disrupted Hormuz. Brent spiked toward ~$100 then eased 4% to ~$97 Friday; US pump prices ~$4.11/gal, US SPR at its lowest since 1983. Crude near $97 is now a MATERIAL NEGATIVE for India (85%+ import-dependent) — import bill, rupee, inflation. War premium supports defence sentiment but the macro headwind is real; the durable driver is the domestic order pipeline (QRSAM now expected Q2 FY27, DAC clearances, Q1 FY27 execution).
• MARKET: the Nifty India Defence index consolidated off its ~9,400 mid-June high, supported by the 3 Jul DAC clearances (₹52,000 Cr) and the mid-July return of the Gulf war premium. Q1 FY27 earnings season is now the focus (BEL reports 27 Jul, bagged a fresh ₹572 Cr order; HAL Tejas Mk-1A deliveries begin Aug-Sep). NEAR-TERM CATALYST: BEL reports Q1 FY27 on 27 Jul (4 PM); FY27 order-intake target ₹55,000+ Cr; the ~₹30,000 Cr QRSAM award is now expected in Q2 FY27 (largest pending award); QRSAM-linked contracts should cascade to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers). BROKER SPLIT on valuation: Kotak is cautious — SELL Mazagon (FV ₹1,950) and Solar (₹10,300), REDUCE BEL, ADD HAL (₹4,810) — while Antique stays Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532, GRSE ₹3,141, BEML ₹2,245, Cochin ₹1,693). It's a valuation debate, not a fundamental one; stock selection now matters more than sector beta. India's demand is capex/policy-driven — structural runway intact; execution now the key differentiator. Sector P/E ~52–54, still outperforming Nifty 50 YTD.
