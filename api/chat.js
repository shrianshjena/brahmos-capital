...
• Operation Epic Fury (US–Iran war) — the 18 Jun MoU has BROKEN DOWN. After early-July tanker strikes, the conflict re-ignited: US Central Command resumed airstrikes on Iran and reimposed a naval blockade on Iranian ports (~14 Jul), the US Treasury revoked its waiver on Iranian oil sales (effective 17 Jul), and Trump (at the NATO summit) declared the ceasefire 'over' and further talks a 'waste of time.' Iran struck commercial vessels in Hormuz and fired missiles/drones toward US assets in Bahrain and Kuwait. Brent has climbed back to ~$84/bbl from the sub-$74 early-July lows (still below the ~$120 April peak; ~8.5M bbl/day reportedly still transits Hormuz). Trump dropped his earlier 20% Hormuz transit-fee demand. For India (85%+ crude-import dependent), still net positive — lower import bill, firmer rupee. On 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced by brokers) — air-defence layering, unmanned/ISR, localisation via Buy-and-Make — lifting the sector; post-DAC broker views: B&K Buy BEL (₹513) & HAL and Hold BDL, ICICI picks BEL/HAL/Astra Microwave/Solar (Buy PTC ₹21,000). Residual risks: fragile implementation, Israel's rejection of the framework, narrow 60-day nuclear-talks window.
• MARKET: the Nifty India Defence index consolidated off its ~9,400 mid-June high, supported by the 3 Jul DAC clearances (₹52,000 Cr) and the mid-July return of the Gulf war premium. Q1 FY27 earnings season is now the focus (BEL reports 27 Jul, bagged a fresh ₹572 Cr order; HAL Tejas Mk-1A deliveries begin Aug-Sep). Broker targets (MOFSL, 7 Jul): HAL ₹5,500, BEL ₹510, BDL Neutral ₹1,250, Astra Buy ₹1,715, Zen Neutral ₹1,600 — several mid-caps now trade at/above target after the run. India's demand is capex/policy-driven — structural runway intact; execution now the key differentiator. Sector P/E ~52–54, still outperforming Nifty 50 YTD.
