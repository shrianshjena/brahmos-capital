...
• Operation Epic Fury (US–Iran war, a 108-day conflict since 28 Feb 2026) is ENDING — the MoU (signed by Trump, VP Vance and Iranian speaker Qalibaf) mandates the permanent termination of military operations on all fronts including Lebanon, lifts the US naval blockade and reopens the Strait of Hormuz toll-free. Formal signing ceremony set for Friday 19 Jun in Geneva (VP Vance leading the US team). Implementation underway: the first India-bound LNG carrier (Disha) transited Hormuz and reaches Dahej, Gujarat on 18 Jun; Brent has fallen below $80/bbl from the ~$95 peak, easing India's import bill and lifting the rupee to ~95.1. Key residual risk: Israel rejected the framework (Netanyahu/Katz/Ben Gvir) and won't withdraw from Lebanon; narrow 60-day nuclear-talks window. PM Modi welcomed the deal.
• MARKET: defence led a strong rally on 17 Jun — Nifty India Defence +3% to a fresh high ~9,400 on India's record ₹1.78L Cr FY26 production + Brent below $80 (Nifty 50 crossed 24,000). Paras +14%, MTAR +7.6%, Astra Micro +5.2%, Data Patterns +4.9%. Confirms structural demand is independent of the (now-ending) war.
