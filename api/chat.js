...
• Operation Epic Fury (US–Iran war) — DE-ESCALATING as of 27 Jul. The US and Iran halted strikes over the weekend (US paused attacks late Friday without a formal announcement; Tehran stopped retaliatory strikes; Trump reportedly open to renewed peace talks), and Iran has engaged Oman on restoring Strait of Hormuz traffic. Brent crude — which spiked toward ~$100 last week — eased back toward ~$90 Monday as the truce took hold (still up ~40% from early-July lows). Floors under prices: Houthis keep attacking Saudi Aramco Red Sea facilities (Jizan, Yanbu), and the Caspian Pipeline Consortium suspended Black Sea loadings (~80% of Kazakhstan's exports). Easing tensions may cool the near-term war premium; crude near $90 stays a mild negative for India's import bill. The durable driver is now the domestic order pipeline and Q1 FY27 execution.
