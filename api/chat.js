...
• Operation Epic Fury (US–Iran war) — the MoU (signed 18 Jun 2026 by Trump, Pakistan/Qatar-mediated; the formal Geneva signing ceremony was then postponed) ended the intense fighting and has held for three weeks as of early July, though it remains fragile. It extends the ceasefire 60 days for nuclear talks, reaffirms Iran won't build a nuclear weapon, and reopens the Strait of Hormuz (jointly managed by Iran and Oman). Reopening is only PARTIAL — traffic ~one-third of normal with a steep risk premium, and several tankers turned back on 8 Jul. Oil tumbled below pre-war levels after signing but has climbed back to Brent ~$78 as the incomplete reopening and critically low US stockpiles keep a floor. For India (85%+ crude-import dependent), still net positive — lower import bill, firmer rupee. On 3 Jul the DAC (chaired by Rajnath Singh) cleared ~₹52,000 Cr of procurement (further ~₹79,000 Cr referenced by brokers) — air-defence layering, unmanned/ISR, localisation via Buy-and-Make — lifting the sector; post-DAC broker views: B&K Buy BEL (₹513) & HAL and Hold BDL, ICICI picks BEL/HAL/Astra Microwave/Solar (Buy PTC ₹21,000). Residual risks: fragile implementation, Israel's rejection of the framework, narrow 60-day nuclear-talks window.
• MARKET: after peaking ~9,400 in mid-June, the Nifty India Defence index consolidated as the Gulf war premium faded (MTAR ~-16% off its high, Solar/MDL/Cochin also lower), then found support from the 3 Jul DAC clearances. India FY26 defence production hit a record ₹1.78L Cr. India's demand is capex/policy-driven — structural runway intact; execution now the key differentiator. Sector P/E ~52–54, still outperforming Nifty 50 YTD.
