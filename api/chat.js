...
• Operation Epic Fury (US–Iran war) — RE-ESCALATED as of 30 Jul. This week's diplomatic thaw reversed: after Iran's mid-week attack on US forces, US Central Command launched a fresh major wave of air strikes on 30 Jul targeting dozens of IRGC sites; Trump pledged a strong response. The two sides FAILED to reach a deal — Tehran insists on retaining control of the Strait of Hormuz, sinking the Oman-brokered mechanism floated days earlier. Conflict widened: Saudi Arabia joined US operations against Tehran-linked militants in Iraq; Yemen's Houthis keep threatening Red Sea shipping. Brent, which dipped toward ~$81 Tue, surged back above $92 (up ~21% on the month). Physical tightening: US crude posted its largest draw since mid-June; the SPR fell an 18th straight week to its lowest since 1983. Renewed war premium supports defence sentiment near-term, but Brent in the low-$90s is a growing negative for India's import bill/rupee/inflation. Durable driver: the domestic order pipeline and Q1 FY27 execution.
