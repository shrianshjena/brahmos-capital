...
• Operation Epic Fury (US–Iran war) — HORMUZ STANDOFF HARDENS as of 11 Aug. Trump told Axios the US is 'only semi-negotiating' with Iran (walking back last week's claim that talks were underway) and signaled he'd rely on the US naval blockade rather than fresh airstrikes to pressure Tehran ('watching Iran with its huge inflation... they have no money'); he lashed out at Iran's demand for war-damage compensation with a counter-demand. Tehran insists the US must lift the blockade before it fully reopens the Strait of Hormuz and has rejected direct US talks for now. Iran and Oman still haven't finalized a shipping-route deal; after weekend attacks on Saudi's Jazan refinery (Houthis) and an ADNOC tanker in Hormuz, Brent climbed a fourth straight session to nearly $88 (highest in ~2 weeks, +5% Monday) as the market prices out a near-term deal. The entrenched standoff sustains a modest war premium; the sector's own drivers (Budget-capex hopes, the domestic order pipeline) remain in control. Crude ~$88 is a renewed negative for India's import bill/rupee after the brief dip toward $77.
