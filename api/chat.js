...
• Operation Epic Fury (US–Iran war) — DIPLOMACY GAINING STEAM (volatile) as of 29 Jul. The US paused strikes late Friday and Iran ceased retaliation; Trump says Washington is holding 'good talks' with Tehran and sees a 'good chance' of resolution (warns strikes could resume if talks fail). Iran's FM Araghchi held talks with Saudi and Omani counterparts; Oman proposed a joint mechanism to manage the Strait of Hormuz (Iran collecting voluntary transit fees), reportedly gaining Gulf support (Iran rejected 50-50 shared control). Oil whipsawed: Brent hit ~$81 Tuesday (lowest in a week) then rebounded ~4% to ~$88 Wednesday after a fresh Iranian attack on US troops + Iraqi-militia drones on Saudi facilities (~$32 intra-month range). Caspian Pipeline (Kazakh oil) resumed. A durable de-escalation would cool the war premium; the sector's driver is now the domestic order pipeline and Q1 FY27 execution.
