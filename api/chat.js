...
• Operation Epic Fury (US–Iran war) — POSSIBLE INFLECTION, Iran's president signals war-end, Brent ~$94 (as of 21 Aug). The most conciliatory signal from Tehran in weeks landed Friday: Iranian President Pezeshkian indicated Iran wants the war with the US to end sooner rather than later, saying 'it is better to end the war today' while the country is 'in a position of power and dignity,' and describing the June 17 MoU as a victory for Iran. Markets read it as a potential inflection toward resolution, though signals conflict: Treasury Secretary Bessent countered that the US would impose its 'toughest-ever sanctions' and intensify economic pressure. Brent closed ~$94 Friday (little changed on the day but +5-6% for a second straight week, its highest since July). Physical flows are resilient beneath the headlines: the US military says it has helped move 660M+ barrels through the Strait of Hormuz since early May, though the global diesel market is exceptionally tight. An eventual de-escalation would drain the war premium from defence sentiment, but the sector's durable domestic drivers (Budget-capex expectations, the order pipeline, indigenisation policy) would remain intact. Brent ~$94 (+~39% YoY) stays a headwind for India's import bill/rupee, so a genuine move to end the conflict would be a macro positive for India.
