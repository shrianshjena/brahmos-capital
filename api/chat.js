...
• Operation Epic Fury (US–Iran war) — ESCALATED sharply. Since the 18 Jun MoU collapsed, Iranian authorities say the US has struck 95 locations across 12 cities in ten days, with another round completed 20 Jul. Several US troops have been killed; Trump vowed Iran 'will pay many times over.' Iran attacked a tanker in Hormuz on 21 Jul, and Yemen's Houthis declared a maritime embargo against Saudi Arabia — putting Bab el-Mandeb at risk alongside Hormuz (potential new front). Brent has climbed to ~$90/bbl from sub-$74 in early July; Rystad warns of further upside. De-escalation thread: regional mediators have floated a 10-day ceasefire that could revive the MoU, though ING notes large divisions remain. Rising crude is now a growing negative for India's import bill and the rupee.
• MARKET: the Nifty India Defence index consolidated off its ~9,400 mid-June high, supported by the 3 Jul DAC clearances (₹52,000 Cr) and the mid-July return of the Gulf war premium. Q1 FY27 earnings season is now the focus (BEL reports 27 Jul, bagged a fresh ₹572 Cr order; HAL Tejas Mk-1A deliveries begin Aug-Sep). NEAR-TERM CATALYST: MOFSL expects BEL to win the ~₹30,000 Cr QRSAM order within weeks (largest pending award); QRSAM-linked contracts should cascade to BDL (missiles), Astra Microwave (TR modules/EW) and Apollo Micro (on-board computers). BROKER SPLIT on valuation: Kotak is cautious — SELL Mazagon (FV ₹1,950) and Solar (₹10,300), REDUCE BEL, ADD HAL (₹4,810) — while Antique stays Buy across the board (HAL ₹5,706, Mazagon ₹3,275, Solar ₹18,633, BEL ₹532, GRSE ₹3,141, BEML ₹2,245, Cochin ₹1,693). It's a valuation debate, not a fundamental one; stock selection now matters more than sector beta. India's demand is capex/policy-driven — structural runway intact; execution now the key differentiator. Sector P/E ~52–54, still outperforming Nifty 50 YTD.
